...
export const DEFAULT_SPOTS: FishingSpot[] = [
  ...
  // --- 関西エリア ---
  {
    ...
    facilities: {
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "UMIGO（海Go）アプリ/Web事前予約制（利用料・入場管理）",
      isNightFishingAllowed: true,
    ...
    localRules: [
      "UMIGO（海Go）等による事前予約および入場手続き（電子チケット確認）必須",
    ...
    tips: "沖合の潮流が直撃する南向き護岸は、秋の夕マズメ〜夜間にタチウオの大群が接岸する関西屈指の激アツポイント。朝マズメはメタルジグやセットアッパー等のミノーでメジロ・ブリ・サゴシのナブラ撃ちが楽しめます。",
  },
  {
    id: "nanko-park",
    name: "大阪南港魚つり園護岸",
  ...
  // --- 東海・中部エリア ---
  {
    ...
    facilities: {
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "UMIGO（海Go）アプリ/Web事前予約制（遊漁料・清掃協力金）",
      isNightFishingAllowed: true,
    ...
    localRules: [
      "UMIGO（海Go）アプリでの事前予約およびチェックイン必須",
    ...
    tips: "底が透き通るほどの極上の水質で、春と秋のエギングはアオリイカのチェイスが見えるサイトフィッシングが楽しめます。外向き堤防周辺のブレイクではアカハタなどのロックフィッシュやカゴ釣りでのイサキ・タカベが有望です。",
  },
  {
    ...
    facilities: {
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "UMIGO（海Go）アプリ/Web事前予約制",
      isNightFishingAllowed: true,
    ...
    localRules: [
      "UMIGO（海Go）での事前予約およびデジタルチェックイン必須",
    ...
    tips: "夏〜秋の夜釣りは駿河湾のタチウオが大回遊し、電気ウキやテンヤ・ルアーで数釣りが狙える名所。富士山を望む絶景ロケーションで、日中はアジのサビキ釣りやヘチ・ダンゴでの良型チヌが有望です。",
  },
  {
    ...
    facilities: {
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "UMIGO（海Go）アプリ/Web事前予約制（美化協力金）",
      isNightFishingAllowed: true,
    ...
    tips: "入り江の奥まで水深があり風に強いため、冬場や荒天時でも竿が出しやすいのが最大の特徴。特に春・秋のアオリイカは西伊豆屈指の好実績で、ヤエン釣りやエギングファンが通い詰める名所です。",
  },
  {
    ...
    tips: "秋から冬にかけてはアオリイカに加えてヤリイカの回遊があり、夜間にエギやテーラー仕掛けで連発します。夏〜秋は青物（ソウダ・ショゴ）の回遊が激しく、ショアジギングやカゴ釣りで賑わいます。",
  },
  {
    ...
    tips: "田子港は足元から10m以上落ち込む急深ポイントで、春には3kgを超える巨大アオリイカが釣れる全国屈指のモンスターイカ聖地。夏から秋はカゴ釣りでシマアジやイサキ、ソウダガツオが強烈な引きを見せてくれます。",
  },
  {
