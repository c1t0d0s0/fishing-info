...
export const DEFAULT_SPOTS: FishingSpot[] = [
  ...
  },
  {
    ...
    name: "山口 周防大島 久賀港・安下庄波止",
    kana: "やまぐち・すおうおおしま・くかこう・あげのしょうはと",
    region: "chugoku",
    prefecture: "山口県",
    address: "山口県大島郡周防大島町久賀・安下庄",
    lat: 33.9142,
    lng: 132.2541,
    category: "port",
    description: "「瀬戸内のハワイ」と呼ばれる周防大島の名港群。水質と潮流に恵まれ、タチウオ・アオリイカ・アジ（尺アジ）・アコウ（キジハタ）・マダイ・チヌ・青物が一年中狙える山口県東部屈指の人気フィールド。",
    accessInfo: "山陽自動車道「玖珂IC」より大島大橋経由で約30分。JR山陽本線「大畠駅」よりバス約20分。",
    depthRange: "4m〜12m",
    ...
    localRules: ["漁協・係留船周辺へのキャスト禁止","スミ跡の洗い流し","ゴミの完全持ち帰り"],
    parkingDetails: {
      capacity: "久賀サンロード・安下庄港駐車場 約100台",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "トイレ・道の駅隣接。"
    },
