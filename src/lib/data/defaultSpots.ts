...
export const DEFAULT_SPOTS: FishingSpot[] = [
  ...
  },
  {
    ...
    parkingDetails: {
      capacity: "施設専用有料駐車場 約230台",
      fee: "3時間以内 250円 / 5時間未満 350円 / 5時間以上 500円（1日最大500円）",
      hours: "24時間入出庫可能（※深夜〜早朝の開場待ち駐車可能、日付跨ぎ時は料金加算あり）",
      notes: "施設利用者は割安で利用可能。土日祝やハイシーズンは早朝開場前に満車になることがあります。周辺道路での路上待機は禁止されています。",
    },
  ...
  },
  {
    ...
    parkingDetails: {
      capacity: "施設専用有料駐車場 約230台",
      fee: "普通車 1日 500円（3時間以内 250円 / 5時間未満 350円）",
      hours: "開園時間に合わせて利用可能（4〜10月 6:00〜19:00 / 11〜2月 7:00〜17:00 / 3月 6:00〜18:00）",
      notes: "大黒ふ頭先端の施設前駐車場。土日祝の混雑時は事前予約制となるため、釣行前に横浜フィッシングピアーズ公式サイトをご確認ください。",
    },
  ...
  },
  {
    ...
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県横浜市磯子区新磯子町39",
    lat: 35.4025,
    lng: 139.6432,
    category: "park",
    description: "根岸湾に面した全長約500mの歩道桟橋型海釣り施設。本牧・大黒と並ぶ横浜3大海づり施設の一つ。全面安全柵完備で足場が良く、クロダイ（チヌ）やメジナ（グレ）のフカセ釣り・ヘチ釣りの名所として名高い。アジ・イワシのサビキ釣りやシロギス狙いも快適でファミリー・初心者にも安心。",
    accessInfo: "JR根岸線「磯子駅」東口より市営バス85系統で「磯子海づり施設」下車すぐ。首都高湾岸線「磯子出入口」より約5分。",
    depthRange: "3m〜5m",
    bottomType: "砂泥・基礎捨石・敷石",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "大人500円 / 小中学生300円",
      isNightFishingAllowed: false,
      nightFishingText: "不可（営業時間外閉鎖）",
      openingHours: "8:00〜18:00 (3〜6月・9〜10月) / 8:00〜19:00 (7〜8月) / 8:00〜17:00 (11〜2月)",
    },
    targetFish: ["クロダイ", "メジナ", "アジ", "イワシ", "ウミタナゴ", "シーバス", "シロギス", "ハゼ", "カサゴ", "メバル", "サヨリ", "ボラ"],
    bestSeasons: {
      spring: ["クロダイ (乗っ込み)", "メジナ", "ウミタナゴ", "シロギス"],
      summer: ["アジ", "イワシ", "クロダイ", "ハゼ", "シーバス"],
      autumn: ["メジナ", "クロダイ", "アジ", "サヨリ", "イシモチ"],
      winter: ["寒メジナ", "ウミタナゴ", "カサゴ", "メバル", "アイナメ"],
    },
    recommendedRigs: ["ウキフカセ釣り (オキアミ・練りエサ)", "サビキ釣り (アジ・イワシ)", "チョイ投げ (アオイソメ)", "ヘチ・落とし込み (カニ・イガイ)", "胴突き探り釣り"],
    localRules: [
      "竿出しは1人2本まで（混雑時は1本制限あり）",
      "オーバースロー（上からの振りかぶり投げ釣り）禁止（安全のためアンダースロー限定）",
      "ルアー釣りは指定エリア・混雑時制限等の現地ルールに従うこと",
      "ライフジャケット（救命胴衣）着用推奨（無料レンタルあり）",
      "営業時間外の立ち入り禁止",
    ],
    parkingDetails: {
      capacity: "施設専用駐車場 約85台",
      fee: "3時間以内 250円 / 5時間以内 350円 / 5時間以上（1日最大） 500円",
      hours: "開場30分前〜閉場まで（季節により変動）",
      notes: "施設入口に隣接。週末やハイシーズンは午前中に満車になることがあります。",
    },
    tips: "水深が3〜5mと比較的浅く、根岸湾の奥部に位置するため冬場でも水温が安定しやすく、年間を通してメジナやクロダイの好釣果が上がります。足元の敷石・ケーソン周りにはカサゴやウミタナゴが居着き、南側の捨石周りや中央部フカセポイントが人気。売店・レンタル竿も充実しており手ぶら釣行にも対応しています。",
  },
  {
    id: "jogashima-port",
    name: "三浦半島 城ヶ島岸壁・磯",
  ...
  },
  {
    ...
    parkingDetails: {
      ...
      fee: "最初の1時間300円 / 以後30分毎100円（※キャンプ場宿泊利用時のみ1回500円）",
      hours: "7:30〜21:00（夜間施錠閉鎖・時間外出庫不可）",
      notes: "夜間は完全に施錠され出庫できなくなるため時間厳守。土日祝は飛行機見物やBBQ客で混雑します。",
    },
  ...
  },
  {
    ...
    facilities: {
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      openingHours: "公園・護岸24時間開放（駐車場も24時間利用可能）",
    },
    ...
    parkingDetails: {
      capacity: "高洲海浜公園駐車場 152台（身障者用2台含む）",
      fee: "入庫後30分無料 / 以後60分毎100円（最大料金: 昼間8:00〜22:00 最大600円、夜間22:00〜翌8:00 最大600円）",
      hours: "24時間年中無休",
      notes: "2022年4月より有料化され24時間利用可能になりました。夜間釣行時も駐車場が利用できます。30分以内に出庫する場合でも精算機での手続きが必要です。",
    },
  ...
  },
  {
    ...
    parkingDetails: {
      capacity: "ふれーゆ駐車場 約90台 / 近隣コインパーキング",
      fee: "一般利用: 最初の2時間まで1時間200円、以後30分毎100円（ふれーゆ施設利用者は割引あり）",
      hours: "4〜9月 7:30〜21:15 / 10〜3月 7:30〜20:15（夜間施錠閉鎖・時間外入出庫不可）",
      notes: "ふれーゆ駐車場は夜間施錠され出庫できなくなります。夜釣りや早朝釣行の場合は、手前の末広町周辺にある24時間コインパーキングをご利用ください。周辺路上駐車は厳禁。",
    },
    tips: "足元から水深があり、アジの魚影が濃い。コマセを針に直接擦り付ける「トリックサビキ」が圧倒的な釣果を叩き出します。夜間は常夜灯の明暗部にタチウオやアジが集まります。",
  },
  {
    id: "yokohama-akarenga-park",
    name: "横浜 赤レンガパーク (新港地区・赤レンガ倉庫前護岸)",
    kana: "あかれんがぱーく",
    region: "kanto",
    prefecture: "神奈川県",
    ...
    lng: 139.6432,
    category: "park",
    description: "横浜みなとみらい・新港地区を代表する歴史的観光スポット「横浜赤レンガ倉庫」海側に広がる海浜公園。全面安全柵が設置された石畳プロムナードで、足元サビキによるアジ・イワシ・サッパや、岸壁ヘチ釣りでのクロダイ・シーバスが狙えます。※観光客が多いため投げ釣り・ルアーキャストは禁止。足元直下のみ。",
    accessInfo: "みなとみらい線「馬車道駅」または「日本大通り駅」より徒歩約6分。JR・市営地下鉄「桜木町駅」より汽車道経由で徒歩約15分。首都高神奈川1号横羽線「みなとみらい出入口」より約5分。",
    depthRange: "3m〜7m",
    bottomType: "ヘドロ・砂泥・護岸ケーソン・敷石",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      openingHours: "24時間常時開放（赤レンガ倉庫商業施設は店舗により異なる）",
    },
    targetFish: ["アジ", "イワシ", "サッパ", "コノシロ", "サバ", "クロダイ", "シーバス", "メバル", "カサゴ", "ハゼ"],
    bestSeasons: {
      spring: ["メバル", "クロダイ", "シーバス"],
      summer: ["アジ", "イワシ", "サッパ", "サバ", "クロダイ"],
      autumn: ["アジ", "サバ", "コノシロ", "ハゼ", "シーバス"],
      winter: ["メバル", "カサゴ", "クロダイ"],
    },
    recommendedRigs: [
      "サビキ釣り仕掛け (初心者一番人気)",
    ...
    localRules: [
      "投げ釣り（オーバースロー・アンダースロー・チョイ投げ含むすべての投げる行為）全面禁止・足元の直下への仕掛け投入のみ可",
      "キャストを伴うルアーフィッシング禁止（岸壁際のテクトロ・ヘチ探りのみ可）",
      "転落防止柵（フェンス）へのロッドホルダー・竿の固定禁止",
      "コマセの柄杓などによるバラ撒き禁止（カゴに入れて使用すること）",
      "観光客・散策者が非常に多いため周囲の安全確認を徹底・キャスト動作厳禁",
      "釣り座のコマセ汚れはバケツの水で洗い流し、ゴミ・釣り糸は完全持ち帰り",
      "水上バス・遊覧船の発着場付近や係留船周りは釣り禁止",
    ],
    parkingDetails: {
      capacity: "赤レンガパーク第1・第2駐車場 計179台 / 近隣有料コインパーキング多数",
      fee: "最初の1時間500円 / 以後30分毎250円",
      hours: "24時間利用可能",
      notes: "土日祝やイベント開催時は赤レンガ駐車場が満車になりやすいため、ワールドポーターズ駐車場や近隣の大型コインパーキングの利用もご検討ください。",
    },
    tips: "足元直下の水深が4〜6mほどあり、アジやイワシ・サッパの回遊ルートになっています。観光客の往来が絶えない場所のため、仕掛けを投げる行為は厳禁です。足元のトリックサビキや、岸壁スリット・ヘチ際をカニやイガイで探るクロダイの落とし込み釣りが非常に有効です。",
  },
  {
    id: "yokohama-rinko-park",
    name: "横浜 臨港パーク (みなとみらい・パシフィコ横浜海側)",
    kana: "りんこうぱーく",
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県横浜市西区みなとみらい1丁目1-1",
    lat: 35.461,
    lng: 139.6374,
    category: "park",
    description: "みなとみらい21地区で最大の面積を誇る臨海公園（パシフィコ横浜の海側に隣接）。横浜港・横浜ベイブリッジを一望できる開放的な水際線プロムナードで、全面安全柵が整備されています。足元のサビキ釣りでアジ・イワシ、ヘチ釣りでのクロダイ・シーバス・根魚が人気。※投げ釣り（チョイ投げ・ルアーキャスト含む）は全面禁止、足元への落とし込み限定。",
    accessInfo: "みなとみらい線「みなとみらい駅」または「新高島駅」より徒歩約5分。JR・市営地下鉄「桜木町駅」より動く歩道経由で徒歩約15分。首都高神奈川1号横羽線「みなとみらい出入口」より約3分。",
    depthRange: "3m〜8m",
    bottomType: "砂泥・護岸ケーソン・基礎石・ヘドロ",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
    ...
    targetFish: ["アジ", "イワシ", "サバ", "サッパ", "コノシロ", "クロダイ", "シーバス", "メバル", "カサゴ", "ハゼ"],
    bestSeasons: {
      spring: ["メバル", "カサゴ", "クロダイ", "シーバス"],
      summer: ["アジ", "イワシ", "サッパ", "サバ", "クロダイ"],
      autumn: ["アジ", "サバ", "コノシロ", "ハゼ", "シーバス"],
    ...
    localRules: [
      "投げ釣り（下手投げ・アンダースロー・チョイ投げ含むすべてのキャスティング）全面禁止・足元真下のみ可",
      "ルアーのキャスティング（投げる行為）禁止（※足元際への落とし込み・テクトロのみ）",
      "ぷかり桟橋（シーバス・水上バス発着場）周辺および係留船付近は釣り禁止",
      "転落防止柵（フェンス）へのロッドホルダー・竿の固定禁止、竿の放置禁止",
      "コマセの柄杓でのバラ撒き禁止（サビキカゴでの使用に限定）",
      "警備員が定期巡回しています。ルール遵守と散策者・ジョギング利用者の安全に細心の注意を払うこと",
      "釣り場のコマセ汚れは必ず水で洗い流し、ゴミ・仕掛けは完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "臨港パーク駐車場（地下） 99台 / パシフィコ横浜地下駐車場 1188台",
      fee: "臨港パーク駐車場: 30分250円（平日当日最大1,500円）",
      hours: "8:00〜21:00（※パシフィコ横浜みなとみらい公共駐車場は24時間営業）",
      notes: "夜釣りや早朝釣行の場合は24時間入出庫可能な「みなとみらい公共駐車場（パシフィコ横浜地下）」をご利用ください。",
    },
    tips: "護岸足元は深さがあり、潮通しも良好。サビキ釣りは少し長め（3.6〜4.5m）の磯竿などを使うと、護岸の際から少し離れた水深のある層へ自然に仕掛けを落とせます。日中はジョギングや観光客が多いため、早朝や夕マズメ〜夜間の釣行が落ち着いて楽しめます。",
  },
  {
    id: "nojima-park",
    name: "野島公園",
    ...
    lng: 139.6334,
    category: "park",
    description: "横浜市金沢区の平潟湾に浮かぶ「野島」にある緑豊かな臨海公園。水路沿いや海沿いに安全柵付きの遊歩道が整備され、足場が良く家族連れや初心者に最適。夏〜秋のハゼ釣りの名所として名高く、シーバス・クロダイ・メバルの実績も豊富。",
    accessInfo: "金沢シーサイドライン「野島公園駅」より徒歩約5分。京急本線「金沢八景駅」より徒歩約15分。横浜横須賀道路「朝比奈IC」より車で約15分。",
    depthRange: "1.5m〜4m",
    bottomType: "砂泥・干潟・藻場・敷石",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "護岸部24時間利用可能",
      openingHours: "護岸部24時間利用可能",
    },
    targetFish: ["ハゼ", "シーバス", "クロダイ", "キビレ", "メバル", "カサゴ", "シロギス", "カレイ", "アジ", "メゴチ"],
    bestSeasons: {
      spring: ["メバル", "シーバス (バチ抜け)", "クロダイ", "カレイ"],
      summer: ["ハゼ (デキハゼ〜数釣り)", "クロダイ (トップウォーター・落とし込み)", "キビレ", "シロギス"],
      autumn: ["ハゼ (落ちハゼ・良型)", "シーバス", "クロダイ", "カマス", "アジ"],
      winter: ["カレイ", "メバル", "カサゴ", "深場の落ちハゼ"],
    },
    recommendedRigs: ["チョイ投げ仕掛け (青イソメ)", "のべ竿ウキ釣り・ミャク釣り (ハゼ)", "ルアー (小型プラグ/ジグ単/トップ)", "ヘチ・前打ち仕掛け", "電気ウキ仕掛け"],
    localRules: [
      "歩行者・公園利用者への十分な安全配慮（後方確認の徹底）",
      "本格的な投げ竿での大遠投禁止（チョイ投げ推奨）",
      "バーベキュー・キャンプ場指定エリア外での火気使用禁止",
      "ゴミ・仕掛け・コマセ汚れの完全清掃・持ち帰り",
    ],
    parkingDetails: {
      capacity: "野島公園第1駐車場（約104台）・第2駐車場（約52台）",
      fee: "最初の1時間200円、以後30分毎100円",
      hours: "第1駐車場: 24時間利用可能 / 第2駐車場: 利用時間制限あり",
      notes: "潮干狩りシーズン（春〜初夏）や好天の休日は満車になることがあるため、野島公園駅（徒歩5分）など公共交通機関の利用も便利です。",
    },
    tips: "平潟湾と外海を繋ぐ水路部は潮の流れが効き、初夏〜晩秋のハゼ釣りは延べ竿やチョイ投げで数釣りが楽しめます。水深が浅いため、潮位が高い満潮前後の時間帯がベスト。夜間は街灯周りの明暗部にシーバスやメバル、キビレ・チヌが集まり、ナイトゲームも楽しめます。",
  },
  {
    ...
    parkingDetails: {
      capacity: "稲毛ヨットハーバー有料駐車場 約277台",
      fee: "普通車 1回 500円",
      hours: "7:30〜22:00（※7月・8月は 6:30〜22:00、時間外入出庫不可）",
      notes: "夜間施錠のため時間外の入出庫・夜間留め置きは不可。開門前の早朝釣行時は近隣の24時間営業コインパーキングをご利用ください。",
    },
  ...
  },
  {
    id: "kisarazu-port",
    name: "木更津港・鳥居崎海浜公園",
    kana: "きさらづこう・とりいざきかいひんこうえん",
    region: "kanto",
    prefecture: "千葉県",
    address: "千葉県木更津市富士見3-4",
    lat: 35.3789,
    lng: 139.9192,
    category: "port",
    description: "日本一高い歩道橋「中の島大橋」のたもとに広がる木更津港の代表的釣り場。鳥居崎海浜公園側の護岸は足場が良く、駐車場・トイレ完備でファミリーからルアー・ヘチ釣り師まで賑わいます。",
    accessInfo: "JR内房線「木更津駅」西口より徒歩約15分。東京湾アクアライン連絡道「木更津金田IC」より約15分、館山自動車道「木更津南IC」より約10分。",
    depthRange: "3m〜8m",
    bottomType: "砂泥・ヘドロ・基礎捨石",
    facilities: {
      hasParking: true,
    ...
    targetFish: ["ハゼ", "シーバス", "クロダイ", "シロギス", "アナゴ", "イイダコ", "アジ", "サッパ", "メバル", "カサゴ", "カレイ", "ボラ"],
    bestSeasons: {
      spring: ["シーバス（バチ抜け）", "クロダイ", "メバル", "シロギス"],
      summer: ["ハゼ", "アナゴ（夜釣り）", "クロダイ", "シーバス", "アジ", "イイダコ"],
      autumn: ["落ちハゼ", "イイダコ", "シーバス", "サッパ", "シロギス"],
      winter: ["カレイ", "カサゴ", "メバル", "寒ボラ"],
    },
    recommendedRigs: ["チョイ投げ (ハゼ・キス・カレイ)", "ヘチ・落とし込み (クロダイ)", "シーバスルアー (シンペン/ミノー)", "ぶっこみ釣り (アナゴ・イシモチ)"],
    localRules: [
      "港湾作業船・遊覧船の発着場所へのキャスト・立ち入り禁止",
      "鳥居崎海浜公園内の遊歩道利用者に十分配慮しアンダースロー推奨",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "鳥居崎海浜公園駐車場（無料・約200台）",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "中の島公園側・鳥居崎公園側の双方に無料駐車場あり。",
    },
    tips: "夏から秋のハゼ釣りは延べ竿やチョイ投げで数釣りが狙える名所。夜のぶっこみ釣りでは太い江戸前アナゴが期待でき、中の島大橋周辺の明暗部や潮ヨレはランカーシーバスの実績ポイントです。",
  },
  {
    id: "kisarazu-uchiko-park",
    name: "木更津 内港公園",
    kana: "きさらづないこうこうえん",
    region: "kanto",
    prefecture: "千葉県",
    address: "千葉県木更津市内港1番地先",
    lat: 35.3855,
    lng: 139.9140,
    category: "park",
    description: "木更津港の内港に整備された親水公園。安全柵が設置された遊歩道護岸があり、芝生広場・駐車場・トイレ完備で小さな子ども連れでも安心してサビキやハゼ釣りが楽しめます。",
    accessInfo: "JR木更津駅西口より徒歩約15分。アクア連絡道「木更津金田IC」より車で約12分。",
    depthRange: "2m〜6m",
    bottomType: "泥・砂泥",
    facilities: {
      hasParking: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      openingHours: "公園内24時間開放",
    },
    targetFish: ["ハゼ", "シーバス", "クロダイ", "サヨリ", "アジ", "サッパ", "イシモチ", "メバル"],
    bestSeasons: {
      spring: ["シーバス", "メバル", "クロダイ"],
      summer: ["ハゼ", "サッパ", "クロダイ", "イシモチ"],
      autumn: ["サヨリ", "落ちハゼ", "シーバス", "アジ"],
      winter: ["カレイ", "メバル", "シーバス"],
    },
    recommendedRigs: ["ウキ釣り (サヨリ仕掛け)", "チョイ投げ仕掛け", "トリックサビキ", "ライトソルトルアー"],
    localRules: [
      "公園利用者の安全確保のため後方確認を徹底",
      "撒き餌で汚れた岸壁は海水で洗い流すこと",
      "直火・BBQ禁止",
    ],
    parkingDetails: {
      capacity: "内港公園駐車場（無料・約50台）",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "満車時は周辺の木更津港共用駐車場を利用。",
    },
    tips: "波静かな内湾のため荒天時でも竿が出しやすいのが魅力。秋にはサヨリの回遊があり、専用の連珠ウキ仕掛けで表層を狙うと好釣果が得られます。",
  },
  {
    id: "obitsu-river-mouth",
    name: "木更津 小櫃川河口（盤洲干潟）",
    kana: "きさらづおびつがわかこう",
    region: "kanto",
    prefecture: "千葉県",
    address: "千葉県木更津市中島・久津間",
    lat: 35.4120,
    lng: 139.9050,
    category: "river_mouth",
    description: "東京湾最大級の自然干潟「盤洲干潟」に注ぐ一級河川の河口域。日本屈指のシーバス・クロダイ（キビレ）のウェーディング＆陸っぱり聖地として全国のアングラーに知られます。",
    accessInfo: "アクアライン連絡道「木更津金田IC」より約5分。JR内房線「巌根駅」より車で約10分。",
    depthRange: "0.5m〜4m（潮位により大きく変動）",
    bottomType: "広大な干潟砂泥・カキ瀬",
    facilities: {
      hasParking: true,
      hasToilet: false,
      hasSafetyFence: false,
    ...
    targetFish: ["シーバス", "クロダイ", "キビレ", "マゴチ", "ヒラメ", "ハゼ"],
    bestSeasons: {
      spring: ["シーバス（稚鮎・バチパターン）", "クロダイ", "キビレ"],
      summer: ["トップウォーターシーバス", "チニング（クロダイ/キビレ）", "マゴチ", "ハゼ"],
      autumn: ["ランカーシーバス（落ちアユ・コノシロパターン）", "ヒラメ", "マゴチ"],
      winter: ["シーバス", "クロダイ"],
    },
    recommendedRigs: ["シーバスルアー (ミノー/シンペン/トップ)", "フリーリグ・チニングジグヘッド (ワーム)", "バイブレーション / スピンテール"],
    localRules: [
      "潮の干満差が非常に大きいため、タイドグラフを確認し退路水没に厳重警戒すること",
      "ウェーディング時はエイガード・フラッシュライト・ライジャケ完全着用必須",
      "海苔網・養殖施設周辺への立ち入り・キャスト厳禁",
    ],
    parkingDetails: {
      capacity: "牛込海岸・金田海岸周辺駐車スペース（約30台）",
      fee: "無料（潮干狩りシーズン等一部有料の場合あり）",
      hours: "24時間",
      notes: "農道や近隣民家の迷惑にならない場所に駐車。",
    },
    dangerNotes: [
      "アカエイの魚影が極めて濃いためエイガード着用・すり足歩行必須",
      "上げ潮時の急激な水位上昇による戻れなくなる事故に厳重注意",
    ],
    tips: "夏場のトップウォータープラグを使ったチニング（ポッパーやペンシルベイト）が超エキサイティング。秋はコノシロや落ちアユを追って80cm超のランカーシーバスが連発します。",
  },
  {
    id: "futtsu-minato-park",
    name: "富津みなと公園・富津港",
    kana: "ふっつみなとこうえん",
    region: "kanto",
    prefecture: "千葉県",
    ...
    lng: 139.8336,
    category: "park",
    description: "富津岬の北側に位置する広大な親水海浜公園。車を近くに停められる足場の良い護岸が長く続き、トイレや展望施設も完備。ファミリーサビキからルアー、投げ釣りまで対応する内房屈指の一大釣り拠点。",
    accessInfo: "館山自動車道「木更津南IC」より富津岬方面へ約15分。JR内房線「青堀駅」より日東バス「富津公園」行きで約15分。",
    depthRange: "3m〜9m",
    bottomType: "砂泥・砂・手前捨て石",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      openingHours: "公園内24時間利用可能",
    },
    targetFish: ["アジ", "サバ", "サヨリ", "シロギス", "クロダイ", "シーバス", "イナダ", "タチウオ", "イシモチ", "アナゴ", "カレイ", "マゴチ"],
    bestSeasons: {
      spring: ["シロギス", "クロダイ", "シーバス", "カレイ"],
      summer: ["アジ", "サバ", "イシモチ", "アナゴ", "マゴチ", "シロギス"],
      autumn: ["サヨリ", "タチウオ", "イナダ", "アジ", "シーバス", "クロダイ"],
      winter: ["カレイ", "カサゴ", "アイナメ", "寒クロダイ"],
    },
    recommendedRigs: ["サビキ釣り", "チョイ投げ・遠投投げ釣り", "ショアジギング (20〜30g)", "電気ウキ釣り (タチウオ・セイゴ)", "サヨリ専用カゴ仕掛け"],
    localRules: [
      "港湾荷役施設・立ち入り禁止フェンス内への侵入厳禁",
      "公園緑地内への車両乗り入れ禁止（駐車場を利用）",
      "コマセ汚れは必ず洗い流すこと",
    ],
    parkingDetails: {
      capacity: "富津みなと公園駐車場（無料・約300台）",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "広大な無料駐車場あり。護岸近くの駐車スペースも充実。",
    },
    tips: "外側の護岸は秋になるとイナダなどの青物回遊やタチウオ、サヨリの群れが入ります。内側の船道周りは投げ釣りで良型シロギスやカレイ、夜釣りでアナゴやイシモチが手堅く釣れます。",
  },
  {
    id: "futtsu-cape",
    name: "富津岬・富津海岸",
    ...
    lng: 139.7895,
    category: "surf",
    description: "東京湾の浦賀水道へ向かって約5km突き出た砂嘴（さし）の岬。東京湾で最も潮流が走るエリアの一つで、広大なサーフと突堤からヒラメ・マゴチ・シーバス・青物・シロギスを狙える内房随一の大場所。",
    accessInfo: "館山自動車道「木更津南IC」より約20分。JR内房線「青堀駅」よりバス「富津公園」終点下車すぐ。",
    depthRange: "1m〜6m（サーフ急深部・水道側）",
    bottomType: "砂・小砂利・一部カキ瀬",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
    ...
    targetFish: ["シーバス", "ヒラメ", "マゴチ", "シロギス", "クロダイ", "イシモチ", "イナダ", "ショゴ", "カレイ"],
    bestSeasons: {
      spring: ["シロギス", "シーバス", "クロダイ", "ヒラメ"],
      summer: ["マゴチ（照りゴチ）", "シロギス", "イシモチ", "ショゴ（カンパチ幼魚）"],
      autumn: ["ランカーシーバス", "ヒラメ", "イナダ", "マゴチ", "シロギス"],
      winter: ["ヒラメ（寒ビラメ）", "カレイ", "シーバス"],
    },
    recommendedRigs: ["サーフルアー (シンキングペンシル/ワーム/メタルジグ)", "投げ釣り (キス・カレイ遠投仕掛け)", "チニング", "泳がせ釣り"],
    localRules: [
      "夏場の海水浴場エリア・マリンスポーツ（カイトサーフィン等）エリア周辺でのキャスト注意",
      "岬先端付近の激流部でのウェーディング・無理な立ち込み厳禁",
      "ゴミの持ち帰り徹底",
    ],
    parkingDetails: {
      capacity: "富津公園・富津岬先端駐車場（無料・約200台）",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "明治百年記念展望塔の足元に大駐車場あり。",
    },
    dangerNotes: ["岬先端部は浦賀水道の激流が渦巻くため落水厳禁・足元注意"],
    tips: "初夏から秋にかけてのマゴチ・ヒラメ狙いが熱く、ジグヘッド＋シャッドテールワームでボトムをリフト＆フォールするのが定番。秋から初冬のコノシロパターンでは大型シーバスの回遊が狙えます。",
  },
  {
    id: "oonuki-port",
    name: "富津 大貫港・新舞子海岸",
    ...
    lng: 139.8550,
    category: "port",
    description: "遠浅の美しい砂浜に隣接する穏やかな好漁港。白灯台堤防と南堤防から竿が出せ、砂地を好むシロギスやハゼ、クロダイ、アオリイカ、メゴチが豊富で初心者の投げ釣りにも最適。",
    accessInfo: "JR内房線「大貫駅」より徒歩約15分。富津館山道路「富津中央IC」より約10分。",
    depthRange: "2m〜6m",
    bottomType: "綺麗な砂地・一部テトラ帯",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
    ...
    targetFish: ["シロギス", "ハゼ", "クロダイ", "アオリイカ", "メゴチ", "アジ", "カマス", "イシモチ", "マゴチ", "カレイ"],
    bestSeasons: {
      spring: ["シロギス", "アオリイカ（親イカ）", "クロダイ"],
      summer: ["シロギス（数釣り）", "ハゼ", "メゴチ", "イシモチ", "マゴチ"],
      autumn: ["アオリイカ（新子エギング）", "落ちギス", "カマス", "アジ", "クロダイ"],
      winter: ["カレイ", "ウミタナゴ", "カサゴ"],
    },
    recommendedRigs: ["チョイ投げ・ライトキャスト (シロギス/ハゼ)", "エギング (2.5〜3.5号)", "ウキフカセ・ダンゴ釣り (クロダイ)", "ライトジギング・サビキ"],
    localRules: [
      "漁船の航路・船着場周辺へのキャスト厳禁",
      "海水浴シーズン中の海水浴場側への投げ釣り禁止",
      "テトラ帯への無理なエントリーは控えること",
    ],
    parkingDetails: {
      capacity: "大貫港・大貫中央海水浴場駐車場（約80台）",
      fee: "無料（海水浴期間中は一部有料の場合あり）",
      hours: "24時間",
      notes: "港内および海水浴場隣接の駐車スペースを利用。",
    },
    tips: "港内および隣接サーフは良質な砂地が広がっており、初夏から秋にかけてシロギスの数釣りが楽しめます。秋のエギングでは堤防外側や先端付近でアオリイカの新子が連発する人気ポイント。",
  },
  {
    id: "umikaze-park",
    name: "横須賀 うみかぜ公園",
    ...
    lng: 139.6827,
    category: "park",
    description: "目の前に無人島「猿島」を望む横須賀屈指の超人気海釣り親水公園。広大な親水護岸には全面安全柵が整備され、24時間無料で釣り可能。タチウオ・青物・アジ・サバからカレイ・大型クロダイまで釣れる東京湾屈指の一級地。",
    accessInfo: "京急本線「県立大学駅」より徒歩約15分。横浜横須賀道路「横須賀IC」より本町山中有料道路経由で約10分。",
    depthRange: "5m〜12m",
    bottomType: "砂泥・敷石・基礎ケーソン",
    facilities: {
      hasParking: true,
    ...
    targetFish: ["タチウオ", "イナダ", "ショゴ", "サバ", "アジ", "シロギス", "カレイ", "クロダイ", "カサゴ", "ウミタナゴ", "シーバス", "メバル", "コウイカ"],
    bestSeasons: {
      spring: ["カレイ", "シロギス", "クロダイ", "ウミタナゴ"],
      summer: ["タチウオ（夏タチ開幕）", "サバ", "アジ", "ショゴ", "シロギス"],
      autumn: ["タチウオ（最盛期）", "イナダ・ワラサ", "サバ", "アジ", "カレイ", "コウイカ"],
      winter: ["大型マコガレイ", "カサゴ", "メバル", "ウミタナゴ"],
    },
    recommendedRigs: ["タチウオテンヤ・ジグヘッドワーム", "電気ウキ釣り (キビナゴ・サンマ切り身)", "ショアジギング (メタルジグ30〜40g)", "カゴ釣り・遠投サビキ", "投げ釣り (カレイ・キス)"],
    localRules: [
      "公園背後の芝生・遊歩道利用者への安全配慮（後方確認の徹底）",
      "タチウオ・青物シーズンの混雑時はオマツリ防止のため仕掛けの流しすぎ注意",
      "ゴミ・仕掛け・コマセ汚れの完全清掃・持ち帰り",
    ],
    parkingDetails: {
      capacity: "うみかぜ公園駐車場（約182台）",
      fee: "最初の1時間320円、以後30分毎160円（24時間最大640円※変更の場合あり）",
      hours: "24時間入出庫可能",
      notes: "大型ショッピングモール（ノジマモール・LIVIN）に隣接し買い物・買い出しも極めて便利。",
    },
    tips: "夏〜晩秋のタチウオは夕マズメから深夜・早朝にかけて大回遊し、ウキ釣りやテンヤで数釣りが狙えます。日中はショアジギングでの青物（イナダ・サバ）や、投げ釣りでのカレイ（春・初冬の乗っ込み期は40cm超実績多数）が名物です。",
  },
  {
    id: "umibe-tsuri-park",
    name: "横須賀市 海辺つり公園",
    ...
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県横須賀市平成町3-1-4",
    lat: 35.2670,
    lng: 139.6908,
    category: "park",
    description: "横須賀市が管理する入場無料の本格海釣り専用公園（開園時間 5:00〜22:00）。約500mにわたる安全柵付きボードウォーク護岸に釣り人用救命浮環・水飲み洗い場・トイレ・売店が完備され、家族連れからベテランまで絶大な支持を集めます。",
    accessInfo: "京急本線「堀ノ内駅」より徒歩約10分。横浜横須賀道路「横須賀IC」より約12分。",
    depthRange: "6m〜14m",
    bottomType: "砂泥・敷石",
    facilities: {
      hasParking: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: false,
      nightFishingText: "開園時間 5:00〜22:00（夜間閉鎖）",
      openingHours: "5:00〜22:00",
    },
    targetFish: ["タチウオ", "アジ", "サバ", "イナダ", "ソウダガツオ", "シロギス", "クロダイ", "ウミタナゴ", "カサゴ", "メバル", "カレイ", "カワハギ"],
    bestSeasons: {
      spring: ["シロギス", "カレイ", "クロダイ", "ウミタナゴ"],
      summer: ["アジ", "サバ", "タチウオ", "ソウダガツオ", "ワカシ"],
      autumn: ["タチウオ", "イナダ", "アジ", "サバ", "カワハギ", "カレイ"],
      winter: ["カレイ", "カサゴ", "メバル", "ウミタナゴ"],
    },
    recommendedRigs: ["サビキ釣り・トリックサビキ", "タチウオ仕掛け (テンヤ/ウキ釣り)", "ショアジギング", "胴突き仕掛け (カワハギ・カサゴ)", "チョイ投げ"],
    localRules: [
      "竿出しは1人2本まで",
      "オーバースロー（上投げ）禁止（安全のためアンダースロー限定）",
      "ルアー・エギの投げ釣り禁止エリアや時間帯規制・混雑時ルールを遵守",
      "開園時間（5:00〜22:00）外の立ち入り禁止",
    ],
    parkingDetails: {
      capacity: "海辺つり公園駐車場（有料・約95台）",
      fee: "最初の1時間320円、以後30分毎160円（入庫後24時間最大640円）",
      hours: "5:00〜22:00",
      notes: "週末や青物・タチウオシーズンは早朝開園前から満車になることがあります。",
    },
    tips: "東京湾の航路筋に面しているため潮通しが抜群。朝夕マズメはサビキでアジ・サバが鈴なりになり、秋にはショアジギングやカゴ釣りで青物（イナダ・ソウダガツオ）、夕暮れからはタチウオの爆釣劇が楽しめます。",
  },
  {
    id: "kurihama-port",
    name: "久里浜港・平作川河口護岸",
    ...
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県横須賀市久里浜8-17",
    lat: 35.2160,
    lng: 139.7160,
    category: "port",
    description: "東京湾フェリー（久里浜〜金谷）の発着拠点となる大型港。平作川が注ぎ込む汽水域と浦賀水道の外洋水が交錯し、クロダイ・シーバス・アジ・シロギス・カレイ・タチウオからアオリイカまで狙える人気釣り場。",
    accessInfo: "京急久里浜線「京急久里浜駅」またはJR「久里浜駅」より京急バス「東京湾フェリー」行きで終点下車すぐ。横浜横須賀道路「佐原IC」より約10分。",
    depthRange: "4m〜12m",
    bottomType: "砂泥・捨て石・一部岩礁",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
    ...
    targetFish: ["アジ", "クロダイ", "シロギス", "カレイ", "タチウオ", "アオリイカ", "ヒラメ", "マゴチ", "シーバス", "ハゼ", "メバル", "カサゴ"],
    bestSeasons: {
      spring: ["乗っ込みクロダイ", "シロギス", "アオリイカ", "シーバス"],
      summer: ["アジ", "ハゼ", "マゴチ", "シロギス", "クロダイ"],
      autumn: ["アオリイカ（エギング）", "タチウオ", "アジ", "落ちギス", "シーバス"],
      winter: ["カレイ（名所）", "メバル", "カサゴ", "寒クロダイ"],
    },
    recommendedRigs: ["ウキフカセ釣り (クロダイ)", "投げ釣り (カレイ・シロギス)", "エギング", "サビキ釣り", "ルアー / 泳がせ釣り"],
    localRules: [
      "東京湾フェリーの発着航路・接岸岸壁への立ち入り・キャスト厳禁",
      "漁港荷役エリア・漁船の係留ロープへの配慮",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "フェリー乗り場周辺・ペリー公園周辺駐車場（有料・約200台）",
      fee: "1回 500〜1,000円（時間制パーキングあり）",
      hours: "24時間",
      notes: "フェリーターミナル隣接や有料コインパーキングが利用可能。",
    },
    tips: "東京湾屈指のカレイの越冬・乗っ込み実績場として名高く、冬場は遠投投げ釣りファンで賑わいます。また平作川河口のテトラや堤防周りはウキフカセでのクロダイ狙いや、秋の大型アオリイカ・タチウオ狙いで実績多数。",
  },
  {
    id: "hashirimizu-port",
    name: "横須賀 走水港・観音崎周辺",
    ...
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県横須賀市走水2-13",
    lat: 35.2600,
    lng: 139.7330,
    category: "port",
    description: "東京湾で最も狭い浦賀水道の激流に面し、全国ブランド「走水の金アジ（大アジ）」で名高い漁港・海岸。潮流が生み出す豊富なプランクトンにより魚の引き・食味が抜群で、アオリイカやタチウオ・良型根魚の好ポイント。",
    accessInfo: "京急本線「馬堀海岸駅」より京急バス「観音崎」行きで「走水神社」または「走水港」下車すぐ。横浜横須賀道路「馬堀海岸IC」より約5分。",
    depthRange: "3m〜15m",
    bottomType: "砂地・岩礁・海藻帯",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
    ...
    targetFish: ["アジ（大アジ）", "タチウオ", "アオリイカ", "カレイ", "クロダイ", "メバル", "カサゴ", "シロギス", "マゴチ", "イナダ"],
    bestSeasons: {
      spring: ["アオリイカ（春イカ）", "メバル", "クロダイ", "シロギス"],
      summer: ["走水の大アジ", "タチウオ", "マゴチ", "シロギス"],
      autumn: ["アオリイカ", "タチウオ", "大アジ", "イナダ", "カワハギ"],
      winter: ["大型カレイ", "メバル", "カサゴ", "寒クロダイ"],
    },
    recommendedRigs: ["カゴ釣り / ぶっこみサビキ", "エギング (3.0〜3.5号)", "胴突き探り釣り (根魚・カワハギ)", "投げ釣り (シロギス・カレイ)"],
    localRules: [
      "走水港内の漁業協同組合施設・船揚場・漁船周辺での釣り厳禁",
      "釣り可能エリアのルールを厳守しゴミは必ず持ち帰ること",
      "観音崎周辺の磯場は潮位変動に注意し救命胴衣必須",
    ],
    parkingDetails: {
      capacity: "走水水源地駐車場・観音崎公園駐車場（有料・約300台）",
      fee: "普通車 1回 500〜800円（時期・時間帯により変動）",
      hours: "24時間（一部夜間閉鎖あり）",
      notes: "近隣の有料駐車場をご利用ください。",
    },
    tips: "水道の速い潮流に乗って回遊する走水のアジは幅広で脂が乗って絶品。重めのオモリを使ったぶっこみサビキやカゴ釣りが有効です。岩礁と砂地が混じる地形のためアオリイカや尺メバルの実績も極めて高いスポットです。",
  },
  {
    id: "enoshima-port",
    name: "江の島・湘南港 大堤防・裏磯",
    ...
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県藤沢市江の島1-12",
    lat: 35.2975,
    lng: 139.4845,
    category: "port",
    description: "湘南を代表する観光名所・江の島の大型港湾＆地磯。ウッドデッキが美しい湘南港大堤防（白灯台・開放時間あり）と、外洋に面した超一級磯「裏磯」があり、青物・アジ・アオリイカ・カワハギ・クロダイ・メジナが狙えます。",
    accessInfo: "小田急江ノ島線「片瀬江ノ島駅」より徒歩約20分、江ノ電「江ノ島駅」より徒歩約25分。国道134号線「江の島入口」より橋を渡ってすぐ。",
    depthRange: "4m〜14m",
    bottomType: "岩礁・敷石・砂礫・基礎ケーソン",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      openingHours: "湘南港大堤防上層デッキは昼間開放（夜間閉鎖）、磯場・岸壁周辺は24時間利用可能",
    },
    targetFish: ["イナダ", "ショゴ", "ソウダガツオ", "アジ", "サバ", "カマス", "アオリイカ", "カワハギ", "クロダイ", "メジナ", "シーバス", "シロギス"],
    bestSeasons: {
      spring: ["乗っ込みクロダイ", "大型アオリイカ（春イカ）", "メジナ", "シロギス"],
      summer: ["ショゴ（カンパチ幼魚）", "ソウダガツオ", "ワカシ", "アジ", "サバ", "カマス"],
      autumn: ["イナダ", "ソウダガツオ", "アオリイカ（秋エギング）", "カワハギ", "アジ"],
      winter: ["寒グレ（メジナ）", "ウミタナゴ", "カサゴ", "クロダイ"],
    },
    recommendedRigs: ["ショアジギング (メタルジグ30〜40g)", "カゴ釣り / 遠投サビキ", "エギング (3.0〜3.5号)", "胴突き仕掛け (カワハギ)", "ウキフカセ"],
    localRules: [
      "湘南港大堤防デッキの利用可能時間を厳守すること",
      "観光客・散策者の多いエリアのためキャスト時は周囲の安全確認を徹底",
      "裏磯エントリー時はスパイクシューズ・救命胴衣必須（波浪・高波時立入禁止）",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "江の島なぎさ駐車場・県営駐車場等（計約1,000台）",
      fee: "普通車 最初の1時間400円、以後30分毎200円（当日最大料金あり）",
      hours: "駐車場により異なる（24時間入出庫可能駐車場あり）",
      notes: "休日は島内道路および駐車場が大変混雑するため早朝のアクセスを推奨。",
    },
    dangerNotes: ["裏磯エリアは外洋のうねりによる波被り・水没に厳重注意。スパイクシューズとライフジャケットを必ず着用してください。"],
    tips: "夏〜秋の裏磯はショアジギングやカゴ釣りで青物（ソウダ・イナダ・ショゴ）の回遊が熱く、朝マズメのナブラ打ちは圧巻。大堤防内側や白灯台周辺はサビキやカワハギ・アオリイカ狙いで足場良く楽しめます。",
  },
  {
    id: "katase-port",
    name: "藤沢 片瀬漁港・境川河口",
    kana: "かたせぎょこう・さかいがわかこう",
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県藤沢市片瀬海岸2-20-25",
    lat: 35.3080,
    lng: 139.4835,
    category: "port",
    description: "新江ノ島水族館のすぐ隣に位置する都市型漁港と境川河口。西プロムナード堤防は足場が良く安全柵も設置。境川河口はシーバスやクロダイ、ハゼ、メッキの名ポイントで、隣接サーフからはシロギスやヒラメも狙えます。",
    accessInfo: "小田急江ノ島線「片瀬江ノ島駅」より徒歩約5分。江ノ電「江ノ島駅」より徒歩約10分。国道134号線沿い。",
    depthRange: "2m〜6m",
    bottomType: "砂泥・砂地・河口汽水",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
    ...
    targetFish: ["シーバス", "クロダイ", "キビレ", "ハゼ", "シロギス", "ヒラメ", "マゴチ", "メッキ", "アジ", "サッパ", "コノシロ"],
    bestSeasons: {
      spring: ["シーバス（稚鮎パターン）", "クロダイ", "シロギス"],
      summer: ["ハゼ（数釣り）", "マゴチ", "シロギス", "クロダイ（チニング）", "メッキ"],
      autumn: ["落ちハゼ", "ランカーシーバス", "ヒラメ", "シロギス", "メッキ"],
      winter: ["シーバス", "ヒラメ", "カレイ"],
    },
    recommendedRigs: ["チョイ投げ (ハゼ・キス)", "シーバスルアー (ミノー/シンペン/バイブ)", "ライトソルトルアー (メッキ・アジ)", "フリーリグチニング"],
    localRules: [
      "漁船・遊漁船の発着場・荷役作業エリアへの立入・キャスト禁止",
      "プロムナード遊歩道散策者への安全配慮（アンダースロー推奨）",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "片瀬海岸地下駐車場・片瀬漁港駐車場（約200台）",
      fee: "普通車 最初の1時間400円、以後30分毎200円",
      hours: "駐車場により異なる",
      notes: "駅近のため電車釣行も極めて快適です。",
    },
    tips: "境川河口は春の稚鮎遡上や秋の落ちアユ・コノシロ回遊に合わせてシーバスの一級ポイントになります。夏場はプロムナード周辺でハゼの数釣りや、マイクロジグ・小型ミノーでのメッキゲームが人気。",
  },
  {
    id: "kugenuma-surf",
    name: "藤沢 鵠沼海岸・辻堂海岸サーフ",
    kana: "くげぬまかいがん・つじどうかいがん",
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県藤沢市鵠沼海岸4丁目",
    lat: 35.3160,
    lng: 139.4600,
    category: "surf",
    description: "相模湾に面した開放感抜群の広大なロングビーチ。遠投投げ釣りでのシロギス数釣りや、フラットフィッシュ（ヒラメ・マゴチ）、シーバス、イシモチ、ショアジギングの青物狙いが盛んな湘南を代表するサーフ。",
    accessInfo: "小田急江ノ島線「鵠沼海岸駅」より徒歩約10分。辻堂海浜公園へはJR「辻堂駅」南口よりバス。新湘南バイパス「茅ヶ崎海岸IC」より約15分。",
    depthRange: "1m〜5m（遠浅サーフ）",
    bottomType: "綺麗な細砂",
    facilities: {
      hasParking: true,
      hasToilet: true,
    ...
    targetFish: ["シロギス", "ヒラメ", "マゴチ", "シーバス", "イシモチ", "イナダ", "ショゴ", "ソウダガツオ", "メッキ"],
    bestSeasons: {
      spring: ["シロギス", "ヒラメ", "シーバス"],
      summer: ["シロギス（束釣り狙い）", "マゴチ（照りゴチ）", "イシモチ", "ショゴ"],
      autumn: ["落ちギス", "ヒラメ（最盛期）", "イナダ", "ソウダガツオ", "シーバス"],
      winter: ["寒ビラメ", "シーバス"],
    },
    recommendedRigs: ["サーフ投げ釣り (遠投5〜7色仕掛け)", "サーフルアー (シンキングペンシル/ワーム/メタルジグ)", "ライトショアジギング"],
    localRules: [
      "サーファー・海水浴客・マリンスポーツ利用者との事故防止（周囲50m以上の距離を確保すること）",
      "夏期の海水浴場開設エリア・遊泳規制時間帯での釣り禁止",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "辻堂海浜公園駐車場（約800台）・県立海岸駐車場",
      fee: "普通車 1時間430円（当日最大料金設定あり）",
      hours: "5:00〜21:00（季節により変動あり）",
      notes: "駐車場が広くトイレやシャワー施設も充実。",
    },
    tips: "初夏〜盛夏のシロギスは波打ち際（1〜2色）まで寄るためチョイ投げでも釣果が出ます。離岸流（カレント）やヨブ（海底の凹凸）を見極めてワームやシンペンを通すと座布団ヒラメや大型マゴチがヒットします。",
  },
  {
    id: "hayama-port",
    name: "葉山港・芝崎海岸 (はやま港海の駅)",
    kana: "はやまこう・しばざきかいがん",
    region: "kanto",
    prefecture: "神奈川県",
    ...
    lng: 139.5750,
    category: "port",
    description: "葉山マリーナに隣接する風光明媚な港湾とナチュラルな地磯群（芝崎海岸）。赤灯台堤防は足場が良く、アオリイカのエギング聖地として名高いほか、クロダイ・メジナのフカセ釣り、カワハギ、アジ、根魚が狙えます。",
    accessInfo: "JR横須賀線「逗子駅」または京急「逗子・葉山駅」より京急バス「葉山（海岸回り）」行きで「鐙摺（あぶずり）」下車すぐ。横浜横須賀道路「逗子IC」より逗葉新道経由で約15分。",
    depthRange: "3m〜10m",
    bottomType: "岩礁・スリット・砂礫・海藻帯（ホンダワラ等）",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      openingHours: "港湾管理エリアの一部は夜間施錠あり、周辺磯場は24時間利用可能",
    },
    targetFish: ["アオリイカ", "クロダイ", "メジナ", "カワハギ", "アジ", "カサゴ", "メバル", "シロギス", "イナダ", "ショゴ", "ウミタナゴ"],
    bestSeasons: {
      spring: ["親アオリイカ（2kg超実績）", "乗っ込みクロダイ", "メジナ", "メバル"],
      summer: ["ショゴ", "アジ", "カワハギ", "カサゴ", "シロギス"],
      autumn: ["アオリイカ（数釣り）", "カワハギ", "イナダ", "クロダイ", "アジ"],
      winter: ["寒グレ（メジナ）", "メバル", "カサゴ", "クロダイ"],
    },
    recommendedRigs: ["エギング (3.0〜3.5号)", "ウキフカセ釣り", "胴突き仕掛け (カワハギ・根魚)", "チョイ投げ", "ライトワインド"],
    localRules: [
      "ヨット・プレジャーボート係留エリアおよびマリーナ私有地への立入・キャスト禁止",
      "芝崎海岸（ナチュラルリザーブ）の動植物保全ルールを守りゴミは必ず持ち帰ること",
      "コマセで汚れた釣り座は必ず海水で洗い流すこと",
    ],
    parkingDetails: {
      capacity: "葉山港駐車場（約150台）",
      fee: "最初の1時間310円、以後30分毎150円（平日最大1,030円 / 休日最大2,060円）",
      hours: "5:00〜22:00",
      notes: "港湾内に清潔なトイレ・管理事務所あり。",
    },
    tips: "春（4〜6月）の藻場周りは2kgを超えるモンスターアオリイカの実績が極めて高く、秋（9〜11月）は新子の数釣りが楽しめます。カワハギも良型が多く、アサリ餌の胴突き仕掛けで堤防基礎やスリット周りを探るのが有効です。",
  },
  {
    id: "shinnase-port",
    name: "葉山 真名瀬港・森戸海岸",
    ...
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県三浦郡葉山町一色・真名瀬",
    lat: 35.2675,
    lng: 139.5720,
    category: "port",
    description: "沖に浮かぶ名島（菜島）の赤鳥居と裕次郎灯台を正面に望む絶景漁港。穏やかな港内堤防と隣接する森戸海岸・一色海岸サーフがあり、シロギスやアオリイカ、カワハギ、クロダイ、メゴチ、アジが狙えます。",
    accessInfo: "JR逗子駅・京急逗子・葉山駅より京急バス「葉山（海岸回り）」行きで「真名瀬」下車すぐ。逗葉新道より約15分。",
    depthRange: "2m〜7m",
    bottomType: "良質砂地・海藻帯・点在する根",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
    ...
    targetFish: ["シロギス", "アオリイカ", "カワハギ", "クロダイ", "メゴチ", "アジ", "カサゴ", "メバル", "イシモチ", "ヒラメ"],
    bestSeasons: {
      spring: ["シロギス", "アオリイカ", "乗っ込みクロダイ", "メバル"],
      summer: ["シロギス（数釣り）", "メゴチ", "アジ", "カワハギ", "イシモチ"],
      autumn: ["落ちギス", "アオリイカ（エギング）", "カワハギ", "クロダイ"],
      winter: ["カレイ", "カサゴ", "メジナ"],
    },
    recommendedRigs: ["チョイ投げ・ライトキャスト (シロギス)", "エギング (2.5〜3.5号)", "胴突き仕掛け (カワハギ)", "ウキフカセ"],
    localRules: [
      "真名瀬漁港の漁業作業場・荷揚場・漁船係留エリアでの釣り禁止",
      "夏期の森戸海岸・一色海岸海水浴場エリアへのキャスト禁止",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "真名瀬駐車場（約50台）",
      fee: "時間制（季節変動あり・1時間300〜500円程度）",
      hours: "24時間利用可能",
      notes: "海水浴シーズンや休日は満車になりやすいため早めの到着を推奨。",
    },
    tips: "砂地に根や海藻が点在する絶好のボトム環境で、初夏〜秋のシロギスは魚影が極めて濃い名所。堤防先端から名島方面へのキャストでは良型カワハギやアオリイカがヒットします。",
  },
  {
    id: "manazuru-port",
    name: "真鶴港・魚座前岸壁 (まなづる海の駅)",
    kana: "まなづるこう・さかなざまえがんぺき",
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県足柄下郡真鶴町真鶴1947",
    lat: 35.15146,
    lng: 139.14226,
    category: "port",
    description: "真鶴半島の懐に抱かれた天然の良港。観光施設「真鶴魚座」前の岸壁は車を近くに停められ足場が平坦で極めて良好。水深があり、アジ、カマス、アオリイカ、クロダイ、ムツ、シロギスが手軽に狙える西湘の人気スポット。",
    accessInfo: "JR東海道本線「真鶴駅」より徒歩約20分または真鶴町コミュニティバスで約5分。真鶴道路「福浦IC」または西湘バイパス「石橋IC」より約15分。",
    depthRange: "5m〜12m",
    bottomType: "砂泥・砂礫・基礎ケーソン・捨石",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
    ...
    targetFish: ["アジ", "カマス", "アオリイカ", "クロダイ", "ムツ（クロムツ幼魚）", "シロギス", "メジナ", "カワハギ", "カサゴ", "ソウダガツオ"],
    bestSeasons: {
      spring: ["乗っ込みクロダイ", "アオリイカ", "シロギス", "メジナ"],
      summer: ["アジ", "カマス", "小ムツ", "ソウダガツオ", "カワハギ"],
      autumn: ["カマス（爆釣期）", "アオリイカ", "アジ", "カワハギ", "クロダイ"],
      winter: ["クロムツ", "カサゴ", "寒クロダイ", "カマス"],
    },
    recommendedRigs: ["カマス専用サビキ・小型ミノー/ジグ", "アジング・サビキ釣り", "エギング (3.0号)", "チョイ投げ仕掛け", "ウキダンゴ釣り (クロダイ)"],
    localRules: [
      "真鶴魚座・市場関係車両の通行および漁港荷役作業の妨げにならないよう駐車厳守",
      "漁船・係留ロープ周りへのキャスト厳禁",
      "コマセ・イカスミ汚れの完全洗浄とゴミの持ち帰り徹底",
    ],
    parkingDetails: {
      capacity: "真鶴港内公営駐車場（約100台）",
      fee: "無料〜時間制（施設利用・時期により案内あり）",
      hours: "24時間利用可能",
      notes: "港内に公衆トイレ・飲食店あり。",
    },
    tips: "秋から冬にかけての夕マズメ〜夜間はカマスや小ムツの大群が港内に入り、小型ジグや専用サビキでクーラー満タンの爆釣が味わえます。エギングでのアオリイカやヘチ・ダンゴでのクロダイも周年狙えます。",
  },
  {
    id: "manazuru-mitsuishi",
    name: "真鶴岬・三ツ石（真鶴半島地磯群）",
    kana: "まなづるみさき・みついし",
    region: "kanto",
    prefecture: "神奈川県",
    address: "神奈川県足柄下郡真鶴町真鶴1175",
    lat: 35.1380,
    lng: 139.1575,
    category: "rock",
    description: "真鶴半島の先端に突き出た三ツ石（笠島）をはじめ、釜の口・鉄棒・カワウソなどの名礁が連なる関東屈指の超一級地磯。相模湾の潮流が直接ぶつかり、大型メジナ（寒グレ40cm超）、イシダイ、アオリイカ、大型青物が狙えます。",
    accessInfo: "JR真鶴駅より箱根登山バス「ケープ真鶴」行き終点下車、遊歩道石段を下り徒歩約15分。真鶴道路より約15分。",
    depthRange: "5m〜18m+",
    bottomType: "溶岩岩礁・スリット・海藻帯・急深ブレイク",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
    ...
    targetFish: ["メジナ（口太・尾長）", "クロダイ", "イシダイ", "イシガキダイ", "アオリイカ", "イナダ・ワラサ", "カンパチ（ショゴ）", "ソウダガツオ", "ヒラスズキ", "アカハタ", "カワハギ"],
    bestSeasons: {
      spring: ["大型親アオリイカ（3kg実績）", "大型クロダイ", "メジナ", "ヒラスズキ"],
      summer: ["イシダイ", "イシガキダイ", "ソウダガツオ", "ショゴ", "アカハタ"],
      autumn: ["青物（ワラサ・イナダ）", "アオリイカ", "カワハギ", "イシダイ"],
      winter: ["寒グレ（40cm〜50cm級メジナ）", "ヒラスズキ", "ウミタナゴ"],
    },
    recommendedRigs: ["ウキフカセ釣り (遠投G2〜B)", "底物仕掛け (ウニ・サザエ餌のイシダイ)", "ショアジギング (メタルジグ40〜60g)", "エギング (3.5〜4.0号)"],
    localRules: [
      "スパイクシューズ・フローティングベスト（ライジャケ）の完全着用厳守",
      "三ツ石への干潮時渡礁は潮位表を厳重確認し、満潮による水没・帰還不能に絶対注意",
      "フカセ釣りのコマセ汚れは必ず海水で完全に洗い流して退去すること",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "ケープ真鶴駐車場（無料・約200台）",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "ケープ真鶴にトイレ・自販機・レストランあり。駐車場から磯場までは長い階段の上り下りがあります。",
    },
    dangerNotes: [
      "大波・うねりによる磯の洗い波に厳重警戒。海況不良時は絶対に磯へ降りないこと。",
      "三ツ石本体へ渡るゴロタ道は潮が満ちると水没して孤立します。潮位を把握し早めの撤退を徹底してください。",
    ],
    tips: "冬の寒グレシーズンは50cmに迫る大型口太・尾長メジナが乱舞するメジナ師の聖地。エギングでも3kg超のモンスターアオリイカが狙え、深場と浅場が交錯するスリット沿いを狙うのが鉄則です。",
  },
  {
  ...
  // --- 関西エリア ---
  {
    id: "kobe-rokko-marine-park",
    name: "神戸市 六甲マリンパーク",
    kana: "こうべしろっこうまりんぱーく うみご umigo 海go",
    region: "kansai",
    prefecture: "兵庫県",
    ...
    lng: 135.2750,
    category: "park",
    description: "六甲アイランド最南端に広がる絶景親水公園。南側護岸が釣り場として有料開放され、UMIGO（海Go）等の事前予約・安全管理システムを導入。大阪湾の速い本流が直接当たるため潮通しが極めて良く、秋のタチウオ・青物（ブリ・メジロ・ハマチ・サゴシ）やアジ・チヌの一級釣り場。",
    accessInfo: "六甲ライナー「マリンパーク駅」より徒歩約10分。阪神高速5号湾岸線「六甲アイランド北IC」より車で約5分。",
    depthRange: "7m〜14m",
    ...
    facilities: {
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "UMIGO（海Go・ウミゴ）アプリ/Web事前予約制（利用料・入場管理）",
      isNightFishingAllowed: true,
      openingHours: "事前予約枠に応じた時間帯利用（夜釣り枠あり）",
    },
    targetFish: ["タチウオ", "ブリ・メジロ・ハマチ", "サゴシ", "アジ", "サバ", "サヨリ", "クロダイ（チヌ）", "シーバス（ハネ）", "マダコ", "コウイカ", "ガシラ（カサゴ）"],
    bestSeasons: {
      spring: ["チヌ（フカセ/ヘチ）", "ハネ・シーバス", "ガシラ"],
      summer: ["大サバ", "マダコ", "アジ", "イワシ", "ツバス"],
      autumn: ["タチウオ（最盛期）", "メジロ・ハマチ", "サゴシ", "サヨリ", "アジ"],
      winter: ["寒チヌ", "ガシラ", "タチウオ（初冬）"],
    },
    recommendedRigs: ["ショアジギング (メタルジグ30〜40g)", "タチウオテンヤ / ワインド", "カゴ釣り / 遠投サビキ", "エビ撒き釣り / フカセ釣り (チヌ・ハネ)"],
    localRules: [
      "UMIGO（海Go・ウミゴ）等による事前予約および入場手続き（電子チケット確認）必須",
      "ライフジャケット（救命胴衣）の完全着用必須",
      "指定された釣り可能護岸エリア外での釣り禁止",
      "竿出し本数制限（1人2本まで）および混雑時のオーバースロー注意",
      "ゴミの完全持ち帰り、コマセ汚れは必ず海水で洗い流すこと",
    ],
    parkingDetails: {
      capacity: "六甲マリンパーク東・西駐車場（有料・約200台）",
      fee: "最初の1時間200円、以後1時間毎100円（入庫後24時間最大500〜800円程度）",
      hours: "24時間利用可能",
      notes: "釣り場護岸に隣接した大型駐車場が利用可能。トイレ・自販機あり。",
    },
    tips: "沖合の潮流が直撃する南向き護岸は、秋の夕マズメ〜夜間にタチウオの大群が接岸する関西屈指の激アツポイント。朝マズメはメタルジグやセットアッパー等のミノーでメジロ・ブリ・サゴシのナブラ撃ちが楽しめます。UMIGO（海Go）事前予約対応。",
  },
  {
    id: "nanko-park",
    name: "大阪南港魚つり園護岸",
  ...
  {
    id: "hyogo-awaji-tsubasa-port",
    name: "淡路市 淡路交流の翼港",
    kana: "あわじこうりゅうのつばさこう つばさこう",
    region: "kansai",
    prefecture: "兵庫県",
    address: "兵庫県淡路市楠本2267-10",
    lat: 34.5542,
    lng: 135.0150,
    category: "park",
    description: "淡路島北東部・大阪湾に面した人工島「淡路交流の翼港」に整備された関西屈指の本格海釣り公園。沖合に向かって突き出た立地のため潮通しが抜群で水深も10m以上あり、メーター級のブリ・メジロ等の大型青物、タチウオ、アオリイカ、マダイ、コブダイの超一級ポイント。手すり・安全柵完備、売店・トイレ・釣具洗い場が揃いビギナーからベテランまで人気。",
    accessInfo: "神戸淡路鳴門自動車道「淡路IC」より国道28号経由で約10分、または「東浦IC」より約10分。",
    depthRange: "8m〜18m (急深・本流潮流)",
    bottomType: "敷石・砂礫・基礎ケーソン・急深ブレイク",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "清掃協力金 500円/人（1日）",
      isNightFishingAllowed: false,
      nightFishingText: "夜間閉鎖（営業時間 平日8:00〜20:00 / 土日祝6:00〜20:00）",
      openingHours: "平日 8:00〜20:00 / 土日祝 6:00〜20:00",
    },
    targetFish: ["ブリ・メジロ・ハマチ", "タチウオ", "アオリイカ", "マダイ", "コブダイ (カンダイ)", "アジ", "サバ", "グレ (メジナ)", "クロダイ (チヌ)", "サヨリ", "ウマヅラハギ", "ガシラ"],
    bestSeasons: {
      spring: ["大型コブダイ", "親アオリイカ", "マダイ", "グレ"],
      summer: ["ハマチ", "タチウオ", "アジ", "大サバ", "サヨリ"],
      autumn: ["ブリ・メジロ (青物最盛期)", "タチウオ", "アオリイカ", "ウマヅラハギ"],
      winter: ["コブダイ", "良型ガシラ", "メバル", "寒グレ"],
    },
    recommendedRigs: ["ショアジギング / プラッギング (60〜100g)", "ノマセ釣り (エレベーター仕掛け)", "タチウオテンヤ / ワインド", "カゴ釣り (マダイ・青物)", "コブダイ専用胴突き仕掛け (エビ・カニ餌)"],
    localRules: [
      "利用時間厳守（夜間・時間外の敷地内立ち入り・居残り釣りは不法侵入となるため厳禁）",
      "竿出しは1人2本まで（混雑時は1本制限等のスタッフ指示に従うこと）",
      "海への転落防止手すりを乗り越えての釣り禁止",
      "火気使用（BBQ・コンロ・焚き火）厳禁",
      "清掃協力金（500円/人）および車両整理協力費（500円/台）の支払いを遵守",
    ],
    parkingDetails: {
      capacity: "翼港専用有料駐車場 約80台",
      fee: "車両整理協力費 500円/台（1日）",
      hours: "営業時間（平日8:00〜20:00 / 土日祝6:00〜20:00）に合わせて開門",
      notes: "青物ハイシーズンの週末は開門前から待機列ができるほどの超人気。満車時は入場制限が行われる場合があります。",
    },
    tips: "沖向きは大阪湾の本流が激流となって通過するため、潮が緩むタイミング（満潮・干潮の潮止まり前後）が最大の時合。秋のノマセ釣りやショアジギングでは連日ブリ・メジロが上がります。足元には大型コブダイ（80cm超実績多数）が居着いており、カニやエビ餌でのパワーファイトも名物です。",
  },
  {
    id: "hyogo-sumoto-nakahama-park",
    name: "洲本市 中浜公園",
    kana: "なかはまこうえん",
    region: "kansai",
    prefecture: "兵庫県",
    address: "兵庫県洲本市塩屋1丁目1-13",
    lat: 34.3415,
    lng: 134.8944,
    category: "park",
    description: "淡路島東岸・洲本港内に位置し、洲本川河口に隣接する親水公園。護岸全域に転落防止安全柵（手すり）が設置され足場が極めて平坦。公衆トイレや無料駐車場が隣接し、コンビニ・スーパーも徒歩圏内で家族連れや初心者に絶大な人気。アジ・イワシのサビキ釣りからチョイ投げのシロギス・ハゼ、チヌ、タチウオ、シーバスまで狙える。",
    accessInfo: "神戸淡路鳴門自動車道「洲本IC」より車で約15分。洲本高速バスターミナルより徒歩約10分。",
    depthRange: "3m〜7m",
    bottomType: "砂泥・敷石・汽水砂州",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "24時間利用可能",
      openingHours: "24時間利用可能",
    },
    targetFish: ["アジ", "イワシ", "サバ", "クロダイ (チヌ)", "シーバス (スズキ)", "シロギス", "ハゼ", "タチウオ", "メバル", "ガシラ", "アオリイカ", "カレイ"],
    bestSeasons: {
      spring: ["クロダイ (乗っ込み)", "メバル", "シロギス", "シーバス"],
      summer: ["アジ", "イワシ", "サバ", "ハゼ", "キス"],
      autumn: ["タチウオ", "アジ", "ハゼ (落ちハゼ)", "アオリイカ", "シーバス"],
      winter: ["カレイ", "メバル", "ガシラ"],
    },
    recommendedRigs: ["サビキ釣り仕掛け (アジ・イワシ)", "チョイ投げ仕掛け (キス・ハゼ・カレイ)", "ウキフカセ / 紀州釣り (チヌ)", "ルアー (シーバス/アジング/ライトワインド)", "タチウオテンヤ / 電気ウキ"],
    localRules: [
      "歩行者・公園散策者への安全配慮（キャスティング時の後方確認徹底）",
      "手すりへの仕掛け固定・竿の放置禁止",
      "係留船や港湾作業エリア周辺へのキャスト禁止",
      "釣り場のコマセ汚れ・イカスミは必ず海水できれいに洗い流すこと",
      "ゴミ・仕掛けの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "公園横無料駐車スペース（約5〜6台） / 近隣コインパーキング・市営駐車場あり",
      fee: "無料（公園専用スペース）",
      hours: "24時間利用可能",
      notes: "公園直結の無料駐車場は台数が少ないため、満車時は近隣の有料駐車場（洲本バスセンター前駐車場等）をご利用ください。",
    },
    tips: "洲本川からの汽水が流入するためベイトフィッシュの魚影が濃く、初夏から秋のサビキ釣りは初心者・子ども連れでも簡単に釣果に恵まれます。夏〜秋の夜釣りではタチウオが港内奥まで回遊。川沿いのブレイクや街灯の明暗部ではシーバスやクロダイの魚影も濃く、ルアーやフカセ釣りで年中楽しめます。",
  },
  {
    id: "hyogo-minamiawaji-janohire",
    name: "南あわじ市 淡路じゃのひれフィッシングパーク (あわじ じゃのひれ 海の駅)",
    kana: "あわじじゃのひれふぃっしんぐぱーく じゃのひれ",
    region: "kansai",
    prefecture: "兵庫県",
    ...
    lng: 134.7270,
    category: "park",
    description: "淡路島南端・福良湾の静穏な入り江に位置する西日本最大級の海上釣り堀・大型フィッシングパーク（じゃのひれアウトドアリゾート内）。揺れの少ない大型筏イカダで足場抜群・安全柵完備。マダイ、ブリ・ハマチ、ヒラマサ、カンパチ、シマアジの高級魚が大量放流され、レンタルタックルやエサ販売・魚の締めサービスも万全で手ぶら釣行・初心者・ファミリーに最高峰の快適性。",
    accessInfo: "神戸淡路鳴門自動車道「西淡三原IC」または「淡路島南IC」より車で約20分。福良港より車で約10分。",
    depthRange: "6m〜9m (海上イカダ生簀)",
    bottomType: "海上イカダ網生簀・湾内砂泥",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "一般コース 大人約12,000円 / ファミリーコース・マダイ釣りコース等各種あり",
      isNightFishingAllowed: false,
      nightFishingText: "不可（日中営業 7:00〜14:00頃 ※季節変動あり）",
      openingHours: "7:00〜14:00（コース・季節により変動、要予約・受付）",
    },
    targetFish: ["マダイ", "ハマチ・メジロ・ブリ", "ヒラマサ", "カンパチ", "シマアジ", "イシダイ", "クエ", "サクラマス (冬春期限定)", "トラフグ (冬季限定)", "スズキ"],
    bestSeasons: {
      spring: ["マダイ", "シマアジ", "サクラマス", "ヒラマサ"],
      summer: ["カンパチ", "ハマチ", "マダイ", "シマアジ", "イシダイ"],
      autumn: ["メジロ・ブリ", "カンパチ", "マダイ", "シマアジ"],
      winter: ["寒ブリ", "トラフグ", "マダイ", "クエ"],
    },
    recommendedRigs: ["海上釣り堀専用ウキ釣り仕掛け (青物・マダイ)", "ミャク釣り / ズボ釣り仕掛け (生簀際・底狙い)", "練りエサ (ダンゴ) / 生名エサ (キビナゴ・活きアジ・エビ)"],
    localRules: [
      "サビキ釣り仕掛け・ルアー釣り・投げ釣り仕掛けの使用禁止（指定一本針仕掛け限定）",
      "まきエサ（コマセ）の使用禁止",
      "ライフジャケット着用必須（無料レンタルあり）",
      "竿出しは1人1本限定（予備竿の持ち込みは可）",
      "安全のためスタッフの指示および安全レギュレーションを厳守すること",
    ],
    parkingDetails: {
      capacity: "じゃのひれアウトドアリゾート大駐車場 約200台",
      fee: "無料",
      hours: "施設利用時間に合わせて利用可能",
      notes: "大型無料駐車場完備。オートキャンプ場、コテージ、BBQ場、イルカふれあい施設（ドルフィンファーム）が併設。",
    },
    tips: "放流直後は青物やマダイの活性が一気に上がる最大のチャンス。朝イチはマダイ狙いの黄色系ダンゴエサやササミ、放流合図後は活きアジやカツオのハツ等で青物を狙うのがセオリーです。釣れた魚はスタッフが血抜き・下処理してくれるサービスもあり、高級魚のお土産を確実に持ち帰れると大好評です。",
  },
  {
    id: "wakayama-marina",
    name: "和歌山マリーナシティ大波止 (わかやまマリーナシティ海の駅)",
    kana: "わかやままりーなしてぃ",
    region: "kansai",
    prefecture: "和歌山県",
  ...
  // --- 東海・中部エリア ---
  {
    id: "shimodashi-shirahama-port",
    name: "下田市 白浜漁港（板見港）",
    kana: "しもだししらはまぎょこう うみご umigo 海go",
    region: "tokai",
    prefecture: "静岡県",
    address: "静岡県下田市白浜",
    lat: 34.6980,
    lng: 138.9765,
    category: "port",
    description: "白浜大浜海水浴場の北側、板戸地区に位置する透明度抜群の美港。UMIGO（海Go）による事前予約・釣り場開放が実施されており、ルールを守って快適にエントリー可能。外洋の黒潮が差し込むため、アオリイカ、アジ、カマス、メジナ、イサキ、タカベ、アカハタが狙える東伊豆南部の好釣り場。",
    accessInfo: "伊豆急行線「伊豆急下田駅」より東海バス「板戸一色」行きで約15分。国道135号線沿い。",
    depthRange: "4m〜10m",
    bottomType: "溶岩岩礁・白砂・基礎捨石",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "UMIGO（海Go・ウミゴ）アプリ/Web事前予約制（遊漁料・清掃協力金）",
      isNightFishingAllowed: true,
      openingHours: "UMIGO事前予約枠に応じた利用時間",
    },
    targetFish: ["アオリイカ", "アジ", "カマス", "メジナ", "クロダイ", "イサキ", "タカベ", "アカハタ", "カサゴ", "シロギス", "ショゴ"],
    bestSeasons: {
      spring: ["親アオリイカ（キロアップ）", "メジナ", "クロダイ", "シロギス"],
      summer: ["タカベ", "イサキ", "アジ", "ショゴ", "アカハタ"],
      autumn: ["アオリイカ（秋エギング）", "カマス", "アジ", "アカハタ"],
      winter: ["寒グレ（メジナ）", "カサゴ", "クロムツ"],
    },
    recommendedRigs: ["エギング (3.0〜3.5号)", "ウキフカセ釣り", "ジグ単アジング / ライトゲーム", "サビキ釣り / カゴ釣り", "ロックフィッシュ仕掛け (テキサス/ジグヘッド)"],
    localRules: [
      "UMIGO（海Go・ウミゴ）アプリでの事前予約およびチェックイン必須",
      "指定された釣り可能エリア内でのみ釣行可能（漁船係留・作業エリア厳禁）",
      "ライフジャケット着用必須",
      "イカスミ・コマセ汚れは必ずバケツで海水を汲んで洗い流すこと",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "板戸・白浜港周辺指定駐車スペース（約30台）",
      fee: "UMIGO予約に含まれるか指定駐車場利用（海水浴期一部有料）",
      hours: "24時間利用可能",
      notes: "予約時に案内される駐車ルールを厳守してください。",
    },
    tips: "底が透き通るほどの極上の水質で、春と秋のエギングはアオリイカのチェイスが見えるサイトフィッシングが楽しめます。外向き堤防周辺のブレイクではアカハタなどのロックフィッシュやカゴ釣りでのイサキ・タカベが有望です。UMIGO（海Go）事前予約対応。",
  },
  {
    id: "shizuokashi-yui-port",
    name: "静岡市 由比漁港",
    kana: "しずおかしゆいぎょこう うみご umigo 海go",
    region: "tokai",
    prefecture: "静岡県",
    address: "静岡県静岡市清水区由比今宿字浜1127",
    lat: 35.1018,
    lng: 138.5553,
    category: "port",
    description: "駿河湾の特産「桜えび」の水揚げで全国的に有名な由比漁港。UMIGO（海Go）アプリでの事前予約制釣り場が導入されており、漁協と共存したクリーンな釣りが可能。急深な駿河湾に面し、タチウオ・アジ・クロダイ・カマス・アオリイカ・ヒラメ・シーバスが狙えます。",
    accessInfo: "JR東海道本線「由比駅」より徒歩約10分。東名高速「富士IC」または「清水IC」より国道1号バイパス経由で約20分。",
    depthRange: "5m〜12m",
    bottomType: "砂泥・砂礫・基礎ケーソン",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "UMIGO（海Go・ウミゴ）アプリ/Web事前予約制",
      isNightFishingAllowed: true,
      openingHours: "UMIGO予約枠に基づく（桜えび漁出漁・水揚げ時間帯等の一部制限あり）",
    },
    targetFish: ["タチウオ", "アジ", "クロダイ", "カマス", "アオリイカ", "ヒラメ", "シーバス", "サバ", "イシモチ", "コウイカ"],
    bestSeasons: {
      spring: ["乗っ込みクロダイ", "シーバス", "アオリイカ", "ヒラメ"],
      summer: ["タチウオ（夏タチ）", "アジ", "サバ", "イシモチ", "クロダイ"],
      autumn: ["タチウオ（最盛期）", "カマス", "アオリイカ", "アジ", "ヒラメ"],
      winter: ["カマス", "タチウオ", "クロダイ", "ヒラメ"],
    },
    recommendedRigs: ["タチウオテンヤ / ワインド / 電気ウキ", "アジング / サビキ釣り", "ダンゴ釣り / フカセ釣り (クロダイ)", "エギング", "ルアー (メタルバイブ/ミノー)"],
    localRules: [
      "UMIGO（海Go・ウミゴ）での事前予約およびデジタルチェックイン必須",
      "桜えび競り場・市場荷揚場・漁船係留ロープ付近への立入・キャスト絶対禁止",
      "ライフジャケット着用徹底",
      "ダンゴ・コマセ・イカスミ汚れの完全洗い流しとゴミの持ち帰り",
    ],
    parkingDetails: {
      capacity: "由比漁港内指定駐車場（約80台）",
      fee: "UMIGO予約案内参照（無料〜指定駐車区画あり）",
      hours: "24時間利用可能",
      notes: "港内に公衆トイレ・桜えび料理店・直売所あり。",
    },
    tips: "夏〜秋の夜釣りは駿河湾のタチウオが大回遊し、電気ウキやテンヤ・ルアーで数釣りが狙える名所。富士山を望む絶景ロケーションで、日中はアジのサビキ釣りやヘチ・ダンゴでの良型チヌが有望です。UMIGO（海Go）事前予約対応。",
  },
  {
    id: "shizuoka-fuji-river-mouth",
    name: "静岡 富士 富士川河口・富士川緑地",
    kana: "ふじかわかこう ふじかわりょくち",
    region: "tokai",
    prefecture: "静岡県",
    address: "静岡県富士市五貫島",
    lat: 35.1195,
    lng: 138.6370,
    category: "surf",
    description: "日本三大急流の一つ「富士川」が駿河湾へと注ぎ込む県内屈指の大規模リバーマウス＆サーフポイント。広大な富士川緑地に隣接し無料駐車場やトイレを完備。急深な駿河湾の波打ち際と淡水・汽水が混じり合う好漁場で、ランカーシーバス、ヒラメ、マゴチ、クロダイ、タチウオ、青物（ショアジギング）の大型実績が極めて高い名所。",
    accessInfo: "JR東海道本線「富士川駅」より車で約8分。東名高速「富士川スマートIC」より約10分、国道1号富士由比バイパス「富士川橋」東詰すぐ。",
    depthRange: "2m〜10m (急深サーフ・流心ブレイク)",
    bottomType: "砂利・砂礫・玉石・流木沈み根",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（急流・高波に厳重注意）",
      openingHours: "24時間利用可能",
    },
    targetFish: ["シーバス (ランカーサイズ)", "ヒラメ", "マゴチ", "クロダイ", "タチウオ", "ブリ（ワラサ・イナダ）", "ショゴ (カンパチ幼魚)", "シロギス", "アユ (落ちアユ期)", "オオニベ"],
    bestSeasons: {
      spring: ["シーバス (稚鮎パターン)", "ヒラメ", "クロダイ", "シロギス"],
      summer: ["マゴチ", "青物 (ショアジギング)", "タチウオ", "クロダイ"],
      autumn: ["ランカーシーバス (落ち鮎パターン・最盛期)", "ヒラメ", "青物", "タチウオ"],
      winter: ["座布団ヒラメ", "大型シーバス", "タチウオ"],
    },
    recommendedRigs: ["ミノー・シンキングペンシル (12〜14cm)", "メタルジグ (30〜40g)", "ジグヘッドワーム (ヒラメ・マゴチ)", "バイブレーション / 鉄板バイブ", "ぶっこみ釣り (クロダイ)"],
    localRules: [
      "毎年10月11日〜11月15日はアユ産卵保護のためJR東海道本線鉄橋上流端から河口まで全魚種採捕禁止（禁漁区）",
      "富士川橋下流端から四ヶ郷堰堤上流20mの区域は通年採捕禁止",
      "波足が長く急深なサーフのためウェーディング時の無理な立ち込み厳禁・ライフジャケット完全着用",
      "河川敷・緑地内の未舗装路や砂利スタックに注意、指定駐車エリアを利用すること",
      "ゴミ・ルアーパッケージ・ラインの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "富士川緑地公園駐車場（複数箇所・計約300台以上）",
      fee: "無料",
      hours: "24時間利用可能（一部夜間ゲート閉鎖エリアあり）",
      notes: "河川敷に広大な駐車場・トイレが整備されています。雨後の急な増水時や台風接近時は河川敷への進入を避けてください。",
    },
    tips: "春の稚鮎遡上期と秋の落ち鮎シーズン（※10/11〜11/15の禁漁期間前後に注意）はランカーシーバスの聖地。流心と沿岸流がぶつかる潮目を14cmクラスのミノーやシンペンでドリフトさせると強烈なバイトが出ます。サーフ側では波打ち際の駆け上がり狙いでヒラメやマゴチの実績が抜群です。",
  },
  {
    id: "shizuoka-omaezaki-marine-park",
    name: "静岡 御前崎 マリンパーク御前崎",
    kana: "まりんぱーくおまえざき",
    region: "tokai",
    prefecture: "静岡県",
    address: "静岡県御前崎市港6104-9",
    lat: 34.6058,
    lng: 138.2275,
    category: "park",
    description: "遠州灘と駿河湾の結節点に位置する御前崎港内の広大な海浜公園。約460台収容の無料大駐車場や水洗トイレ、緑地広場が整備され、外海の影響を受けにくい穏やかな港内護岸で安全に釣りを楽しめます。黒潮の恩恵により魚影が極めて濃く、ファミリーのサビキ釣りからタチウオ・アオリイカ・青物・クロダイまで狙える静岡屈指の人気スポット。",
    accessInfo: "東名高速「菊川IC」または「相良牧之原IC」より車で約35分。JR東海道本線「菊川駅」より静鉄ジャストラインバス「御前崎海洋センター」行き利用。",
    depthRange: "4m〜10m",
    bottomType: "砂泥・敷石・基礎ケーソン",
    facilities: {
      hasParking: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（港湾ルール遵守）",
      openingHours: "24時間利用可能",
    },
    targetFish: ["アジ", "イワシ", "サバ", "タチウオ", "アオリイカ", "クロダイ", "シロギス", "ヒラメ", "ブリ（ワカシ・イナダ）", "カンパチ（ショゴ）", "カサゴ", "メバル", "カワハギ"],
    bestSeasons: {
      spring: ["シロギス", "アオリイカ", "クロダイ", "メバル"],
      summer: ["アジ", "イワシ", "タチウオ", "ショゴ", "キス"],
      autumn: ["アオリイカ", "タチウオ", "アジ", "イナダ", "カワハギ"],
      winter: ["カサゴ", "メバル", "クロダイ", "ヒラメ"],
    },
    recommendedRigs: ["サビキ釣り仕掛け (アジ・イワシ)", "タチウオテンヤ / 電気ウキ仕掛け", "エギング (3号〜3.5号)", "チョイ投げ仕掛け (シロギス)", "ウキフカセ / ダンゴ釣り (クロダイ)"],
    localRules: [
      "人工海水浴場（海水浴シーズン中の砂浜エリア）への立ち入り・釣り禁止",
      "港湾荷役作業エリアや立ち入り禁止フェンス内への侵入厳禁",
      "停泊中の漁船・作業船・係留ロープへの仕掛けキャスト禁止",
      "夜間の騒音や迷惑行為の禁止",
      "ゴミ・コマセ汚れ・釣り糸の完全清掃・持ち帰り",
    ],
    parkingDetails: {
      capacity: "マリンパーク御前崎駐車場 約460台",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "広大な無料駐車場と清潔な公衆トイレが隣接。海水浴・イベントシーズンは混雑することがあります。",
    },
    tips: "公園前の護岸は足場がフラットで広く、安全柵が整備されているため小さな子ども連れでも快適。初夏から秋はサビキ釣りでアジやサバ、イワシの入れ食いが楽しめます。秋〜初冬の夕マズメ以降はタチウオが湾内へ回遊し、ウキ釣りやテンヤ、ワインドで賑わいます。外向き堤防周辺ではエギングのアオリイカや青物も実績大です。",
  },
  {
    id: "nishiizu-arari-port",
    name: "西伊豆町 安良里漁港",
    kana: "にしいずちょうあらりぎょこう うみご umigo 海go",
    region: "tokai",
    prefecture: "静岡県",
    ...
    lng: 138.7705,
    category: "port",
    description: "すり鉢状の奥深い天然の入り江に囲まれ、波静かで「天然の良港」と称される西伊豆の名港。UMIGO（海Go）の事前予約制釣り場として管理運営。水深があり魚影が濃厚で、アオリイカ、アジ、クロダイ、メジナ、オオモンハタ、アカハタ、カワハギ、マダイが狙えます。",
    accessInfo: "伊豆縦貫道「月ケ瀬IC」より国道136号線経由で約45分。伊豆箱根鉄道「修善寺駅」より東海バス「松崎」行きで約1時間15分、「安良里」下車すぐ。",
    depthRange: "6m〜18m",
    bottomType: "砂泥・砂礫・岩礁・急深ブレイク",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "UMIGO（海Go・ウミゴ）アプリ/Web事前予約制（美化協力金）",
      isNightFishingAllowed: true,
      openingHours: "UMIGO事前予約枠に応じた利用",
    },
    targetFish: ["アオリイカ", "アジ", "クロダイ", "メジナ", "アカハタ", "オオモンハタ", "カワハギ", "マダイ", "タカベ", "カマス", "ソウダガツオ"],
    bestSeasons: {
      spring: ["大型アオリイカ（春イカ）", "乗っ込みクロダイ", "マダイ", "メジナ"],
      summer: ["タカベ", "アカハタ", "オオモンハタ", "アジ", "ソウダガツオ"],
      autumn: ["アオリイカ（エギング爆釣期）", "カワハギ", "カマス", "オオモンハタ", "アジ"],
      winter: ["寒グレ（メジナ）", "良型アジ（夜釣り）", "カサゴ", "クロダイ"],
    },
    recommendedRigs: ["エギング (3.0〜3.5号)", "ヤエン釣り (活きアジ泳がせ)", "ロックフィッシュ仕掛け (ワーム/ジグヘッド)", "ウキフカセ釣り", "サビキ釣り / カゴ釣り"],
    localRules: [
      "UMIGO（海Go・ウミゴ）事前予約およびチェックイン必須",
      "漁船・造船所設備・作業エリア周辺へのキャスト禁止",
      "ライフジャケット着用必須",
      "イカスミやコマセで汚れた釣り座は必ず海水で洗い流すこと",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "安良里港内指定駐車スペース（約40台）",
      fee: "UMIGO予約案内参照",
      hours: "24時間利用可能",
      notes: "港内に公衆トイレ・周辺に釣具店あり。",
    },
    tips: "入り江の奥まで水深があり風に強いため、冬場や荒天時でも竿が出しやすいのが最大の特徴。特に春・秋のアオリイカは西伊豆屈指の好実績で、ヤエン釣りやエギングファンが通い詰める名所です。UMIGO（海Go）事前予約対応。",
  },
  {
    id: "nishiizu-nishina-port",
    name: "西伊豆町 仁科漁港",
    kana: "にしいずちょうにしなぎょこう うみご umigo 海go",
    region: "tokai",
    prefecture: "静岡県",
    address: "静岡県賀茂郡西伊豆町仁科980-6",
    lat: 34.7675,
    lng: 138.7710,
    category: "port",
    description: "イカの水揚げで名高い西伊豆最大の大型漁港。名勝「堂ヶ島」に近く、UMIGO（海Go）の予約制釣り場として開放。沖堤防や港内岸壁は潮通し・水深に恵まれ、アオリイカ、ヤリイカ、アジ、クロダイ、イサキ、ソウダガツオ、ショゴ、アカハタ、ヒラメが狙えます。",
    accessInfo: "伊豆縦貫道「月ケ瀬IC」より国道136号経由で約50分。修善寺駅より東海バス「松崎」行きで「仁科車庫前」下車徒歩約5分。",
    depthRange: "5m〜15m",
    bottomType: "砂泥・砂礫・基礎捨石・岩礁",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      feeText: "UMIGO（海Go・ウミゴ）アプリ/Web事前予約制",
      isNightFishingAllowed: true,
      openingHours: "UMIGO予約枠に基づく",
    },
    targetFish: ["アオリイカ", "ヤリイカ", "アジ", "クロダイ", "イサキ", "ソウダガツオ", "ショゴ", "アカハタ", "オオモンハタ", "ヒラメ", "メジナ"],
    bestSeasons: {
      spring: ["大型親アオリイカ", "乗っ込みクロダイ", "ヒラメ", "メジナ"],
      summer: ["ソウダガツオ", "ショゴ", "イサキ", "アジ", "アカハタ"],
      autumn: ["アオリイカ（数釣り）", "ヤリイカ（晩秋）", "オオモンハタ", "イナダ"],
      winter: ["ヤリイカ", "寒グレ（メジナ）", "良型アジ", "ヒラメ"],
    },
    recommendedRigs: ["エギング (3.0〜3.5号)", "ヤリイカテーラー / エギング", "ショアジギング (30〜40g)", "カゴ釣り", "ロックフィッシュジグヘッド"],
    localRules: [
      "UMIGO（海Go・ウミゴ）事前予約・チェックイン必須",
      "イカ直売所・漁協荷揚場・漁船係留ロープ周辺での釣り厳禁",
      "ライフジャケット着用徹底",
      "コマセ・イカスミ汚れの完全洗浄、ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "仁科漁港内指定駐車場（約80台）",
      fee: "UMIGO予約案内参照",
      hours: "24時間利用可能",
      notes: "港内に食堂（沖あがり食堂等）・公衆トイレあり。",
    },
    tips: "秋から冬にかけてはアオリイカに加えてヤリイカの回遊があり、夜間にエギやテーラー仕掛けで連発します。夏〜秋は青物（ソウダ・ショゴ）の回遊が激しく、ショアジギングやカゴ釣りで賑わいます。UMIGO（海Go）事前予約対応。",
  },
  {
    id: "nishiizu-tago-port",
    name: "西伊豆町 田子漁港",
    kana: "にしいずちょうたごぎょこう うみご umigo 海go",
    region: "tokai",
    prefecture: "静岡県",
    ...
    lng: 138.7565,
    category: "port",
    description: "沖に浮かぶ尊之島や雄島が天然の防波堤となり、外洋の荒波を遮る西伊豆屈指の絶景良港。UMIGO（海Go）による予約制釣り場として整備。港内から急深で黒潮が通り、アオリイカ（3kg超モンスター実績多数）、ソウダガツオ、シマアジ、イサキ、マダイ、タカベ、アカハタが狙えます。",
    accessInfo: "伊豆縦貫道「月ケ瀬IC」より国道136号経由で約45分。修善寺駅より東海バスで約1時間15分、「田子」下車すぐ。",
    depthRange: "6m〜20m+",
    bottomType: "岩礁・砂泥・急深ブレイク・基礎ケーソン",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      feeText: "UMIGO（海Go・ウミゴ）アプリ/Web事前予約制",
      isNightFishingAllowed: true,
      openingHours: "UMIGO予約枠に基づく利用時間",
    },
    targetFish: ["アオリイカ", "ソウダガツオ", "シマアジ", "イサキ", "マダイ", "タカベ", "アジ", "アカハタ", "オオモンハタ", "クロダイ", "メジナ"],
    bestSeasons: {
      spring: ["モンスター親アオリイカ（2〜3kg超）", "マダイ", "メジナ", "クロダイ"],
      summer: ["タカベ（乱舞）", "ソウダガツオ", "イサキ", "シマアジ", "アカハタ"],
      autumn: ["アオリイカ（最盛期）", "シマアジ", "ソウダガツオ", "オオモンハタ"],
      winter: ["寒グレ（大型メジナ）", "良型アジ", "カサゴ"],
    },
    recommendedRigs: ["エギング (3.5〜4.0号)", "ヤエン仕掛け (アジ泳がせ)", "遠投カゴ釣り (シマアジ・イサキ・マダイ)", "ロックフィッシュ仕掛け (テキサス/フリーリグ)", "ウキフカセ釣り"],
    localRules: [
      "UMIGO（海Go・ウミゴ）アプリ事前予約・電子チェックイン必須",
      "指定釣り可能エリアのルール遵守（漁協作業場・漁船係留エリア立入禁止）",
      "ライフジャケット着用徹底",
      "イカスミ・コマセ汚れの完全洗い流し、ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "田子港内指定駐車場（約50台）",
      fee: "UMIGO予約案内参照",
      hours: "24時間利用可能",
      notes: "港内にトイレあり。静かな漁村集落のため夜間の騒音や迷惑駐車に厳重配慮。",
    },
    tips: "田子港は足元から10m以上落ち込む急深ポイントで、春には3kgを超える巨大アオリイカが釣れる全国屈指のモンスターイカ聖地。夏から秋はカゴ釣りでシマアジやイサキ、ソウダガツオが強烈な引きを見せてくれます。UMIGO（海Go）事前予約対応。",
  },
  {
    id: "atami-port-fishing-facility",
    name: "熱海港海釣り施設",
    kana: "あたみこううみづりしせつ",
    region: "tokai",
    prefecture: "静岡県",
    address: "静岡県熱海市和田浜南町1694-32",
    lat: 35.0885,
    lng: 139.0805,
    category: "park",
    description: "熱海港沖に突き出た全長260mの防波堤を利用した公設海釣り公園。安全柵完備・貸竿・仕掛けエサ販売・トイレ・指導員常駐で、初心者やファミリーから本格カゴ釣り・ルアーマンまで快適に相模湾の豊かな魚影を楽しめます。",
    accessInfo: "JR東海道新幹線・東海道本線「熱海駅」より伊豆東海バス「熱海後楽園」行きで終点下車すぐ。西湘バイパス石橋ICより国道135号経由で約30分。",
    depthRange: "6m〜15m",
    bottomType: "砂泥・基礎ケーソン・捨石",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      hasTackleShopNearby: true,
      isFeeRequired: true,
      feeText: "大人 500円 / 小中学生 300円（見学のみ 200円）",
      isNightFishingAllowed: false,
      nightFishingText: "開園時間 6:00〜日没（季節変動あり）",
      openingHours: "4月〜10月 6:00〜日没 / 11月〜3月 7:00〜日没",
    },
    targetFish: ["アジ", "ソウダガツオ", "イナダ", "タカベ", "タチウオ", "アオリイカ", "クロダイ", "メジナ", "カワハギ", "シロギス", "ヒラメ", "カサゴ"],
    bestSeasons: {
      spring: ["乗っ込みクロダイ", "アオリイカ", "シロギス", "メジナ"],
      summer: ["タカベ", "ソウダガツオ", "アジ", "イナダ（ワカシ）", "カワハギ"],
      autumn: ["ソウダガツオ", "イナダ", "タチウオ", "アオリイカ", "カワハギ", "アジ"],
      winter: ["寒グレ（メジナ）", "カサゴ", "カワハギ", "ウミタナゴ"],
    },
    recommendedRigs: ["サビキ釣り (トリックサビキ/カゴサビキ)", "両軸・スピニング遠投カゴ釣り", "ショアジギング (30〜40g)", "エギング (3.0〜3.5号)", "胴突き仕掛け"],
    localRules: [
      "安全のためライフジャケット着用必須（無料レンタルあり）",
      "竿出しは1人2本まで",
      "混雑時のオーバースロー遠投制限および施設係員の指示に従うこと",
      "酒気帯びでの入場禁止",
    ],
    parkingDetails: {
      capacity: "熱海港臨海駐車場（有料・約100台）",
      fee: "普通車 最初の30分無料、以後30分毎110円（施設利用者は割引認証あり）",
      hours: "24時間利用可能",
      notes: "熱海後楽園ホテル・ロープウェイ乗り場のすぐ隣。",
    },
    tips: "夏から秋は外向き堤防でソウダガツオやイナダのナブラが頻発し、遠投カゴ釣りやショアジギングで豪快な引きを堪能できます。内向きは穏やかで足元サビキのアジ・タカベや良型カワハギが狙い目です。",
  },
  {
    id: "ajiro-port",
    name: "南熱海 網代港・網代湾",
    ...
    lng: 139.0850,
    category: "port",
    description: "南熱海に位置する伊豆屈指の天然の良港。急深な網代湾に面して潮通しが極めて良く、車横付け・近付け可能なポイントも多数。アジ・カマス・アオリイカ・ソウダガツオからアカハタ・オオモンハタ等の高級根魚まで狙える大人気スポット。",
    accessInfo: "JR伊東線「網代駅」より徒歩約10分。熱海市街より国道135号線を南へ約15分。",
    depthRange: "5m〜16m",
    bottomType: "砂泥・砂礫・岩礁・基礎捨石",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
    ...
    targetFish: ["アジ", "カマス", "アオリイカ", "ソウダガツオ", "イナダ", "タチウオ", "アカハタ", "オオモンハタ", "クロダイ", "カワハギ", "メジナ", "シロギス"],
    bestSeasons: {
      spring: ["親アオリイカ（キロアップ多数）", "乗っ込みクロダイ", "シロギス", "メジナ"],
      summer: ["アジ", "ソウダガツオ", "アカハタ", "オオモンハタ", "カマス"],
      autumn: ["アオリイカ（秋エギング）", "タチウオ", "イナダ", "カマス", "カワハギ"],
      winter: ["良型アジ（夜釣り）", "カマス", "寒クロダイ", "カサゴ"],
    },
    recommendedRigs: ["カゴ釣り / サビキ釣り", "エギング (3.0〜3.5号)", "ロックフィッシュジグヘッド＋ワーム", "ショアジギング (30g)", "タチウオテンヤ / 電気ウキ"],
    localRules: [
      "漁協施設・定置網水揚げ岸壁・漁船係留ロープ周辺での釣り厳禁",
      "作業トラックや関係車両の通行を絶対に妨げない駐車を徹底",
      "コマセ・イカスミ汚れの完全洗い流し、ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "網代港内駐車スペース・網代漁港駐車場（約80台）",
      fee: "一部無料 / 有料パーキングあり",
      hours: "24時間利用可能",
      notes: "港内に公衆トイレ・周辺に釣具店・コンビニあり。",
    },
    tips: "網代港は水深があるため年間を通じて魚影が濃く、特に春と秋のアオリイカエギングは伊豆を代表する超一級実績。近年はジグヘッドリグやテキサスリグで狙うアカハタ・オオモンハタのハタゲームも大人気です。",
  },
  {
    id: "hatsushima-port",
    name: "熱海 初島港・第一漁港",
    kana: "はつしまこう・だいいちぎょこう",
    region: "tokai",
    prefecture: "静岡県",
    address: "静岡県熱海市初島",
    lat: 35.0390,
    lng: 139.1710,
    category: "port",
    description: "熱海港より高速船「イルドバカンス号」で約30分、相模湾に浮かぶ首都圏から最も近い離島。黒潮の恩恵をダイレクトに受け、ショアから巨大メジナ（尾長グレ50cm超）、タカベ、イサキ、シマアジ、ショア青物、巨大アオリイカが狙える夢の離島フィールド。",
    accessInfo: "熱海港定期船乗り場より富士急マリンリゾート高速船で約30分、初島港下船すぐ。",
    depthRange: "6m〜20m+",
    bottomType: "溶岩岩礁・砂礫・基礎ケーソン・急深カケアガリ",
    facilities: {
      hasParking: false,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      openingHours: "定期船運行時間に合わせて日帰り釣行可能（島内宿泊時は夜釣り可能）",
    },
    targetFish: ["メジナ（尾長・口太）", "タカベ", "イサキ", "シマアジ", "カンパチ（ショゴ）", "ヒラマサ", "イナダ・ワラサ", "アオリイカ", "アカハタ", "オオモンハタ", "ブダイ"],
    bestSeasons: {
      spring: ["大型尾長グレ", "親アオリイカ（3kg級）", "シマアジ", "イサキ"],
      summer: ["タカベ（乱舞）", "イサキ", "カンパチ", "アカハタ", "オオモンハタ"],
      autumn: ["ショア青物（ヒラマサ・ワラサ）", "シマアジ", "アオリイカ", "タカベ"],
      winter: ["寒グレ（50cm超大型メジナ）", "ブダイ", "アカハタ"],
    },
    recommendedRigs: ["ウキフカセ釣り (太仕掛け・尾長対応)", "遠投カゴ釣り (ハリス4〜6号)", "ロックショアジギング / プラッギング (60〜80g)", "エギング (3.5〜4.0号)"],
    localRules: [
      "定期旅客船の入出港作業中は指示に従い釣りを一時中断し退避すること",
      "島内には釣具店がないため仕掛け・エサ・コマセは熱海本土側で完全準備して持ち込むこと",
      "ライフジャケット・磯靴の着用必須",
      "島内の美化保全のためゴミ・コマセ汚れは必ず海水で洗い流しゴミは持ち帰ること",
    ],
    parkingDetails: {
      capacity: "熱海港駐車場を利用（初島へは車両航送不可）",
      fee: "熱海港側で有料精算",
      hours: "24時間",
      notes: "熱海港臨海駐車場等に駐車し、高速船で渡航します。",
    },
    dangerNotes: ["外洋の離島のため台風・低気圧通過時は巨大なうねりが堤防を越えます。波が高い時は絶対に近づかないでください。"],
    tips: "堤防先端や第一漁港の潮通しは抜群で、コマセを撒けば巨大尾長グレやタカベ、イサキが浮き上がります。メタルジグやポッパーをフルキャストすればワラサやカンパチが猛烈にアタックしてきます。",
  },
  {
    id: "shimizu-port",
    name: "静岡 清水港・巴川河口",
  ...
  {
    id: "hokkaido-wakkanai-port",
    name: "北海道 稚内港 (北防波堤ドーム・天北埠頭)",
    kana: "わっかないこう",
    region: "hokkaido",
    prefecture: "北海道",
    address: "北海道稚内市開運1丁目・中央1丁目",
    lat: 45.4150,
    lng: 141.6820,
    category: "port",
    description: "宗谷海峡・オホーツク海と日本海が交わる日本最北の重要港湾。国の重要文化財「北防波堤ドーム」を擁し、天北埠頭や北洋埠頭など広大な岸壁を有します。車横付けで釣りができるエリアも多く足場も平坦。北の海ならではの魚影の濃さを誇り、春・秋のホッケ、投げ釣りでのクロガシラカレイ・マガレイ・コマイ、夜釣りのクロソイ・ガヤ（エゾメバル）、チカ・ニシンのサビキ釣りが楽しめます。",
    accessInfo: "JR宗谷本線「稚内駅」より徒歩約5〜10分。道央自動車道「士別剣淵IC」より国道40号経由で約3時間。稚内空港より車で約20分。",
    depthRange: "5m〜12m",
    ...
    facilities: {
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（極寒期の防寒対策必須）",
      openingHours: "24時間利用可能（立入禁止エリア除く）",
    },
    targetFish: ["ホッケ", "クロガシラカレイ", "マガレイ", "コマイ", "クロソイ", "エゾメバル (ガヤ)", "チカ", "ニシン", "カジカ", "サバ", "マイワシ", "マメイカ"],
    bestSeasons: {
      spring: ["ホッケ (春ホッケ)", "クロガシラカレイ", "マガレイ", "チカ"],
      summer: ["マイワシ", "サバ", "マメイカ", "クロソイ"],
      autumn: ["秋ホッケ", "コマイ (氷下魚)", "クロガシラカレイ", "サケ (周辺河口規制外)"],
      winter: ["コマイ (寒コマイ)", "ニシン", "チカ", "クロソイ", "カジカ"],
    },
    recommendedRigs: ["投げ釣り仕掛け (胴突き2〜3本針 / イソメ)", "サビキ釣り仕掛け (スピードエサ付け / チカ・ニシン)", "ウキ釣り / カゴサビキ (ホッケ)", "ロックフィッシュ (ジグヘッドワーム / テキサス)", "小型エギ (マメイカ用1.5号)"],
    localRules: [
      "国際旅客ターミナル周辺やフェンス・ロープで囲われた立入禁止区域への進入厳禁",
      "港湾荷役・水揚げ作業エリアへの無断進入・作業妨害禁止",
      "北防波堤ドームの建造物・文化財への傷つけ行為厳禁",
      "冬期・夜間の岸壁凍結によるスリップ・落水事故に厳重警戒（スパイク靴・ライフジャケット着用必須）",
      "ゴミ・仕掛け・エサ汚れの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "北防波堤ドーム周辺駐車場・埠頭内駐車スペース（約150台以上・無料）",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "北防波堤ドーム公園横に無料駐車場および公衆トイレ完備。一部埠頭は車横付け可能ですが、作業船の停泊時は邪魔にならないよう配慮してください。",
    },
    tips: "春と晩秋は脂の乗ったホッケの回遊があり、ウキ釣りやカゴサビキ、メタルジグで数釣りが狙えます。底狙いの投げ釣りでは良型クロガシラカレイやコマイが年中有望。夜間は常夜灯周りでクロソイやガヤがワームのフォールに好反応を示します。最北端の港のため秋以降や夜間は強風と冷え込みが厳しく、防寒・防風対策を徹底してエントリーしましょう。",
  },
  {
    id: "sendai-port",
  ...
  {
    id: "ehime-niihama-marine-park",
    name: "愛媛 新居浜 マリンパーク新居浜 (にいはま海の駅)",
    kana: "まりんぱーくにいはま",
    region: "shikoku",
    prefecture: "愛媛県",
    ...
    lng: 133.3302,
    category: "park",
    description: "瀬戸内海（燧灘）に面した新居浜市の美しい海洋リゾート親水公園。マリーナや人工海浜に隣接し、開放された護岸エリアには手すり・転落防止安全柵、約178台の無料駐車場、水洗トイレが完備。足場が極めて良くファミリーフィッシングや初心者に最適で、アジ・イワシ・サヨリのサビキ釣りや、シロギス・カレイの投げ釣り、クロダイ（チヌ）・シーバス狙いが人気。",
    accessInfo: "JR予讃線「新居浜駅」より車・タクシーで約15分。松山自動車道「新居浜IC」より車で約20分。",
    depthRange: "3m〜8m",
    bottomType: "砂泥・敷石",
    facilities: {
      hasParking: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: false,
      nightFishingText: "施設営業時間内利用可能（夜間駐車場閉鎖）",
      openingHours: "8:30〜21:30（施設・駐車場開放時間）",
    },
    targetFish: ["アジ", "イワシ", "サヨリ", "クロダイ", "シーバス", "シロギス", "カレイ", "メバル", "カサゴ", "サッパ", "コウイカ"],
    bestSeasons: {
      spring: ["メバル", "クロダイ", "シロギス", "シーバス"],
      summer: ["アジ", "イワシ", "サヨリ", "クロダイ", "シロギス"],
      autumn: ["サヨリ", "アジ", "イワシ", "クロダイ", "コウイカ", "シーバス"],
      winter: ["カレイ", "メバル", "カサゴ"],
    },
    recommendedRigs: ["サビキ釣り仕掛け (アジ・イワシ)", "サヨリ専用カゴ・連動ウキ仕掛け", "チョイ投げ仕掛け (青イソメ)", "ウキフカセ釣り (チヌ)", "ルアー (ライトゲーム/シーバス)"],
    localRules: [
      "マリーナ桟橋・ヨット係留エリアおよび人工海水浴場（砂浜）への立ち入り・釣り禁止",
      "釣り場として開放されている指定の護岸エリアを利用すること",
      "転落防止柵（手すり）へのロッドホルダー固定や竿の放置禁止",
      "駐車場閉鎖時間（21:30）までに必ず出庫すること",
      "釣り場のコマセ汚れは必ず海水で洗い流し、ゴミ・仕掛けは完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "マリンパーク新居浜駐車場 約178台",
      fee: "無料",
      hours: "8:30〜21:30（夜間施錠閉鎖）",
      notes: "夜間（21:30〜翌朝8:30）はゲートが施錠閉鎖されるため時間外の入出庫はできません。",
    },
    tips: "手すり付きの護岸は足場が平坦で広く、小さな子ども連れでも安心してサビキ釣りやチョイ投げが楽しめます。初夏から秋にかけてはアジやイワシの回遊があり、秋には水面直下を泳ぐサヨリの数釣りが名物。春・秋は敷石周りでのチヌのフカセ釣り、冬場はチョイ投げでのマコガレイが狙えます。マリーナ内や海水浴エリア等、釣り禁止エリアの標識には十分ご注意ください。",
  },
  {
  ...
  {
    id: "ehime-uwajima-ohama",
    name: "愛媛 宇和島 大浜漁港",
    kana: "おおはまぎょこう",
    region: "shikoku",
    prefecture: "愛媛県",
    address: "愛媛県宇和島市津島町北灘丙",
    lat: 33.1426,
    lng: 132.4786,
    category: "port",
    description: "宇和海・北灘湾に面した津島町屈指の大規模漁港。南北に延びる大型波止は潮通しが極めて良く、宇和島名物の尺アジ・ギガアジのアジング、春の巨大親アオリイカ（2kg〜3kg超）、メジナ（グレ）、クロダイ（チヌ）、タチウオ、青物（ハマチ・カンパチ・ネイリ）が狙える超一級ポイント。港内は波静かで足場も良く、ファミリーフィッシングにも対応。",
    accessInfo: "松山自動車道（宇和島道路）「津島高田IC」より国道56号経由で約15分。JR予讃線「宇和島駅」より車で約35分。",
    depthRange: "6m〜15m",
    bottomType: "砂泥・敷石・基礎ケーソン・藻場",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "24時間利用可能",
      openingHours: "24時間利用可能（漁業作業エリア除く）",
    },
    targetFish: ["アジ（尺アジ・ギガアジ）", "アオリイカ（モイカ）", "メジナ（グレ）", "クロダイ（チヌ）", "タチウオ", "ハマチ", "カンパチ（ネイリ）", "マダイ", "カサゴ", "メバル", "キジハタ", "シロギス"],
    bestSeasons: {
      spring: ["親アオリイカ（2kg〜3kg超）", "マダイ", "メジナ", "クロダイ"],
      summer: ["アジ", "カンパチ（ネイリ）", "タチウオ", "キジハタ", "シロギス"],
      autumn: ["尺アジ", "アオリイカ（数釣り）", "ハマチ", "タチウオ", "カマス"],
      winter: ["ギガアジ", "寒メジナ", "カサゴ", "メバル"],
    },
    recommendedRigs: ["ジグ単アジング / フロート・キャロ", "エギング (3.5号〜4号) / ヤエン仕掛け", "ライトショアジギング (30〜40g)", "ウキフカセ釣り (オキアミ)", "サビキ釣り (遠投サビキ)"],
    localRules: [
      "漁協施設前や水揚げ・荷役作業エリアへの駐車および作業妨害の禁止",
      "係留船や養殖関連ロープへの仕掛けキャスト・引っかけ厳禁",
      "波止外向きは高さがあるためライフジャケット着用必須・長柄タモ網（5m以上）必携",
      "イカスミ跡やコマセ汚れは必ず海水できれいに洗い流すこと",
      "ゴミ・仕掛け・釣り糸の完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "大浜漁港内駐車スペース 約30台",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "漁業関係者の作業や車両通行の邪魔にならないよう、所定の空きスペースに配慮して駐車してください。",
    },
    tips: "南北に伸びる長大な波止の外側・先端部は潮通しが抜群で、青物の回遊や大型親アオリイカの一級ポイント。夜間は常夜灯周りにベイトが集まり、秋冬のアジングでは40cmに迫るギガアジの実績多数。港内は穏やかで足場も良く、ファミリーのサビキ釣りやチョイ投げでアジやキスが手軽に楽しめます。沖合の一文字堤防への渡船利用も人気です。",
  },
  {
    id: "kochi-tanezaki",
  ...
  },
  {
    ...
    "parkingDetails": {
      "capacity": "タイムズ京浜島つばさ公園 13台",
      "fee": "入庫後30分無料 / 通常30分200円（24時間最大1,100円）",
      "hours": "24時間営業",
      "notes": "公園駐車場はタイムズによりコインパーキング化され24時間利用可能です。台数が13台と少ないため、週末の日中は満車にご注意ください。"
    },
  ...
  },
  {
    ...
    "parkingDetails": {
      "capacity": "タイムズ東海ふ頭公園 39台",
      "fee": "30分 200円（駐車後24時間 最大800円）",
      "hours": "24時間営業",
      "notes": "かつてあった無料駐車場は廃止され、現在は隣接するタイムズ東海ふ頭公園（有料コインパーキング・24時間営業）を利用する形になっています。"
    },
  ...
  },
  {
    ...
    "targetFish": ["ハゼ", "シーバス", "クロダイ", "キビレ", "ボラ"],
    "bestSeasons": {
      "spring": ["シーバス（バチ抜け）", "クロダイ"],
      "summer": ["ハゼ（数釣り）", "キビレ", "シーバス", "クロダイ", "ボラ"],
      "autumn": ["落ちハゼ（良型）", "シーバス", "クロダイ"],
      "winter": ["寒ボラ", "シーバス"]
    },
    "recommendedRigs": [
      "ハゼミャク釣り / ウキ釣り（のべ竿2.7〜3.6m）",
      "チョイ投げ仕掛け（オモリ2〜5号）",
      "シーバスルアー（ミノー・シンペン・ワーム）",
      "チニング（フリーリグ / 落とし込み）"
    ],
    "localRules": [
      "しおじ磯の岩場は滑りやすいため足元注意",
    ...
    "tips": "初夏〜秋のハゼ釣りシーズンはのべ竿でのミャク釣りやウキ釣りが手返し抜群でファミリーに大人気。青イソメやホタテ貝柱を小さく付けてゴロタ石周りや干潟を探るのがコツ。夜間は運河沿いでシーバスやクロダイ・キビレが狙えます。"
  },
  {
  ...
  },
  {
    ...
    region: "hokuriku",
    prefecture: "新潟県",
    address: "新潟県佐渡市小木町1950",
    lat: 37.8163,
    lng: 138.2822,
    category: "port",
    description: "佐渡南部の海の玄関口（佐渡汽船フェリーターミナル）として知られる天然の良港。水深があり足場が良く、南佐渡を代表する人気釣り場。初夏〜秋のアジのサビキ釣りやアジング、秋のエギング（アオリイカ）、フカセ釣りのクロダイ・メジナ、キジハタ・カサゴの根魚、青物（イナダ・ワラサ）まで多彩に狙える。",
    accessInfo: "小木港フェリーターミナルすぐ。両津港より車で約1時間。",
    depthRange: "6m〜14m",
    bottomType: "砂泥・基礎ケーソン・敷石",
    facilities: {
      hasParking: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（フェリー・漁業作業エリア除く）",
      openingHours: "24時間利用可能",
    },
    targetFish: ["アジ", "アオリイカ", "クロダイ", "メジナ", "キジハタ", "カサゴ", "イナダ・ワラサ", "サバ", "イワシ", "ヒラメ"],
    bestSeasons: {
      spring: ["乗っ込みクロダイ", "メバル", "メジナ"],
      summer: ["アジ (サビキ/アジング)", "キジハタ", "クロダイ", "イワシ"],
      autumn: ["アオリイカ (エギング最盛期)", "アジ (良型)", "イナダ", "クロダイ"],
      winter: ["寒グレ (メジナ)", "カサゴ", "アイナメ"],
    },
    recommendedRigs: ["サビキ釣り / ジグ単アジング", "エギング (3号〜3.5号)", "ウキフカセ釣り (クロダイ・メジナ)", "ロックフィッシュ (テキサスリグ/フリーリグ)", "ライトショアジギング"],
    localRules: [
      "佐渡汽船フェリー発着エリアおよび長堤防（立入禁止フェンス内）への侵入厳禁",
      "漁船係留ロープや荷揚作業周辺へのキャスト禁止",
      "救命胴衣（ライフジャケット）着用必須",
      "イカスミやコマセ汚れは必ず海水で洗い流すこと",
      "ゴミ・仕掛けの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "小木港駐車場 約50台",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "フェリーターミナル周辺に公衆トイレ・売店・自動販売機あり。",
    },
    tips: "フェリーターミナル周辺の護岸や防波堤は足場が安定しており、ファミリーや遠征の初日エントリーにも最適。初秋からは港内全域がアオリイカの新子〜良型で溢れ、エギングの定番地。夜間は常夜灯周りで良型アジやキジハタが狙えます。立ち入り禁止の長堤防には入らず、開放されているエリアでマナーを守って釣行しましょう。",
  },
  {
    id: "sado-akadomari-port",
    name: "佐渡 赤泊港",
    kana: "さど あかどまりこう",
    region: "hokuriku",
    prefecture: "新潟県",
    ...
    lng: 138.4122,
    category: "port",
    description: "佐渡島南東岸に位置する大規模港湾。北〜西寄りの季節風に強く、荒天時でも竿を出しやすい南佐渡の頼れるフィールド。長い防波堤は足場が良く、アジの魚影が濃いことで有名。春〜秋のエギング（アオリイカ）、クロダイ、メジナ、ヒラメ、メバル・キジハタ、青物回遊まで狙える好ポイント。",
    accessInfo: "両津港より車で約40分。小木港より車で約25分。県道45号（佐渡一周線）沿い。",
    depthRange: "5m〜12m",
    bottomType: "砂泥・基礎石・テトラポッド",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能",
      openingHours: "24時間利用可能",
    },
    targetFish: ["アジ", "アオリイカ", "クロダイ", "メジナ", "ヒラメ", "キジハタ", "メバル", "イナダ", "シロギス", "サバ"],
    bestSeasons: {
      spring: ["クロダイ", "メバル", "シロギス"],
      summer: ["アジ", "キジハタ", "クロダイ"],
      autumn: ["アオリイカ", "尺アジ", "イナダ", "ヒラメ"],
      winter: ["メバル", "カサゴ", "寒クロダイ"],
    },
    recommendedRigs: ["ジグ単アジング / サビキ釣り", "エギング (2.5号〜3.5号)", "ウキフカセ釣り", "泳がせ釣り / ノマセ仕掛け (ヒラメ・青物)", "チョイ投げ"],
    localRules: [
      "漁協施設前や網干し場への無断立ち入り・駐車禁止",
      "テトラ帯に乗る際はスパイクシューズ・ライフジャケット完全着用",
      "立入禁止表示のある防波堤先端部などには進入しないこと",
      "ゴミ・釣り針・ラインの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "赤泊港内駐車スペース 約30台",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "旧フェリーターミナル周辺に駐車可能。公衆トイレあり。",
    },
    tips: "佐渡が冬型の気圧配置で北西風が強い日でも、風裏になりやすく波が穏やかなことが多い貴重な港。秋は港内一帯でアオリイカが釣れ、足元サビキでアジを釣って泳がせればヒラメや青物のヒットも期待できます。夜間は常夜灯下のアジングで尺アジ実績多数。",
  },
  {
    id: "sado-suizu-port",
    name: "佐渡 水津港",
    ...
    lng: 138.5730,
    category: "port",
    description: "佐渡東海岸（前浜地区）の岬近くに位置する、潮通し抜群の天然良港。沖合から急深な海崖が迫り海水が極めて澄んでおり、魚影の濃さは島内屈指。アジのデイゲーム・ナイトゲーム、春と秋の大型アオリイカ、ウキフカセ釣りでのマダイ・クロダイ、キジハタ・クロソイ、青物（イナダ・ワラサ）の一級地。",
    accessInfo: "両津港より車で県道45号経由で約20分。水津トンネル手前。",
    depthRange: "6m〜15m (潮通し良好・急深)",
    bottomType: "砂泥・岩礁・基礎捨石・沈み根",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
    ...
    targetFish: ["アジ (尺アジ)", "マダイ", "クロダイ", "アオリイカ", "キジハタ", "クロソイ", "メバル", "イナダ・ワラサ", "サヨリ"],
    bestSeasons: {
      spring: ["乗っ込みマダイ", "クロダイ", "メバル", "親アオリイカ"],
      summer: ["アジ", "キジハタ", "青物"],
      autumn: ["アオリイカ (エギング名所)", "尺アジ", "マダイ", "イナダ"],
      winter: ["クロソイ", "メバル", "寒マダイ"],
    },
    recommendedRigs: ["アジング (キャロ / ジグ単)", "エギング (3号〜3.5号)", "カゴ釣り / ウキフカセ (マダイ・チヌ)", "メタルジグ (30〜40g)", "テキサスリグ (根魚)"],
    localRules: [
      "漁船発着・水揚げ作業の最優先・作業エリアへの駐車厳禁",
      "係留船やロープ周辺へのキャスト厳禁",
      "外海向きの波止はライフジャケット着用徹底",
      "イカスミ・コマセは必ず海水できれいに洗い流すこと",
      "ゴミの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "水津港内駐車スペース 約20台",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "漁業関係者の邪魔にならない空きスペースに配慮して駐車してください。港内にトイレあり。",
    },
    tips: "岬先端に位置するため常に潮が動いており、日中でもアジの群れが回遊してデイアジングが楽しめます。秋のエギングでは潮目を狙うと胴長20cm超の良型アオリイカが連発。沖向きの深場へ遠投カゴ仕掛けを流せば、波止から良型マダイが出る佐渡ならではの醍醐味が味わえます。",
  },
  {
    id: "sado-ryotsu-port",
    name: "佐渡 両津港",
    ...
    region: "hokuriku",
    prefecture: "新潟県",
    address: "新潟県佐渡市両津湊353-1",
    lat: 38.0807,
    lng: 138.4369,
    category: "port",
    description: "佐渡島最大の表玄関港（新潟航路フェリー・ジェットフォイル発着地）。両津湾と加茂湖の開口部に位置し、巨大な防波堤と潮通しの良さから島内屈指の一級釣場。尺アジ・メガアジのアジング、春・秋のアオリイカ、クロダイ、シーバス、イナダ・ワラサ・サゴシの青物回遊、タチウオまで一年を通じて多彩な魚種が狙える大人気フィールド。",
    accessInfo: "両津港フェリーターミナルすぐ。新潟港よりカーフェリーで2時間30分、ジェットフォイルで1時間7分。",
    depthRange: "5m〜16m",
    bottomType: "砂泥・基礎ケーソン・敷石・テトラ",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（立入禁止エリア除く）",
      openingHours: "24時間利用可能",
    },
    targetFish: ["アジ (尺アジ・メガアジ)", "アオリイカ", "ブリ（ワラサ・イナダ）", "サゴシ", "タチウオ", "シーバス", "クロダイ", "メジナ", "マダイ", "カマス", "メバル"],
    bestSeasons: {
      spring: ["親アオリイカ", "クロダイ", "シーバス", "メバル"],
      summer: ["アジ", "サバ", "カマス", "タチウオ", "キス"],
      autumn: ["尺アジ (アジング最盛期)", "アオリイカ", "イナダ・ワラサ", "サゴシ", "タチウオ"],
      winter: ["メガアジ (40cm級)", "寒クロダイ", "寒ボラ"],
    },
    recommendedRigs: ["ジグ単アジング / キャロライナリグ", "エギング (3号〜3.5号)", "ショアジギング (30〜60g)", "タチウオテンヤ / ワインド", "ウキフカセ釣り"],
    localRules: [
      "佐渡汽船フェリー・ジェットフォイル接岸バースおよび立入禁止エリア（黄色線・フェンス内）への侵入絶対禁止",
      "加茂湖内への撒き餌（コマセ）散布禁止条例を遵守",
      "ライフジャケット着用必須",
      "港湾荷役作業・大型車通行の妨げにならないよう指定駐車場を利用すること",
      "ゴミ・仕掛けの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "両津港南埠頭駐車場（約200台以上） / 周辺市営駐車場",
      fee: "最初の30分無料、以降有料（施設利用時割引あり）",
      hours: "24時間入出庫可能",
      notes: "フェリーターミナル近隣に大型駐車場・水洗トイレ・釣具レンタル店（SADO OUTDOOR BASE等）・コンビニ・飲食店多数完備。",
    },
    tips: "フェリーを降りて徒歩数分でエントリーできる手軽さながら、魚影の濃さは本州の一級磯を凌ぐほど。秋〜初冬の夜間は港内の常夜灯周りにアジやカマス、タチウオが集まり、アジングで35cm超のメガアジが連発することも珍しくありません。外向きでは秋にイナダやサゴシのナブラが多発しショアジギングで賑わいます。",
  },
  {
    id: "sado-ishina-port",
    name: "佐渡 石名港",
    ...
    lng: 138.3733,
    category: "port",
    description: "佐渡島北部・外海府（そとかいふ）海岸の荒磯に抱かれた秘境感漂う名漁港（高千漁港石名地区）。日本海の荒波が直接当たる超一級の潮通しを誇り、港内堤防と周辺の地磯・ゴロタ浜が融合した贅沢なフィールド。ヒラマサ・ブリ等の大型青物、80cm級のマダイ、クロダイ、メジナ、大型アオリイカ、キジハタ・カサゴが狙える本気のアングラー垂涎の地。",
    accessInfo: "両津港より車で外海府方面へ約1時間。県道45号（佐渡一周線）沿い。",
    depthRange: "5m〜14m (急深ブレイク・外海直結)",
    bottomType: "岩礁・砂利・基礎捨石・沈み根・ゴロタ",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: false,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（外海の高波・急変に厳重注意）",
      openingHours: "24時間利用可能",
    },
    targetFish: ["ヒラマサ", "ブリ・ワラサ", "マダイ", "クロダイ", "メジナ (大型)", "アオリイカ", "キジハタ", "カサゴ", "アイナメ"],
    bestSeasons: {
      spring: ["乗っ込みマダイ", "大型クロダイ", "メジナ", "ヒラマサ"],
      summer: ["キジハタ", "ヒラマサ", "ショアジギング青物"],
      autumn: ["アオリイカ (大型)", "ヒラマサ", "ブリ・ワラサ", "マダイ"],
      winter: ["寒グレ", "寒マダイ", "アイナメ"],
    },
    recommendedRigs: ["ロックショアジギング / プラッギング (60〜100g)", "エギング (3.5号)", "遠投カゴ釣り (マダイ・ヒラマサ)", "ウキフカセ釣り", "ハードロックフィッシュ (テキサスリグ)"],
    localRules: [
      "日本海の波浪・高波に警戒（荒天時・ウネリ時の防波堤・地磯への立ち入り厳禁）",
      "スパイクシューズ・固型式ライフジャケット着用必須",
      "漁船の航路・係留ロープへのキャスト禁止",
      "漁港作業スペースへの迷惑駐車禁止",
      "ゴミ・ラインの完全持ち帰り",
    ],
    parkingDetails: {
      capacity: "石名港内駐車スペース 約15台",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "漁業者の作業車両の邪魔にならない空きスペースに駐車してください。簡易トイレあり。",
    },
    tips: "外海府特有の圧倒的な潮通しと急深な海底地形により、防波堤から本格的な磯魚・回遊魚が狙えます。秋は先端からダイビングペンシルやメタルジグを遠投するとヒラマサやワラサが突っ込み、地磯周りでは良型アオリイカやキジハタが高確率でヒット。北西の風浪に弱いため、波予報を事前にしっかり確認して釣行しましょう。",
  },
  {
    id: "niigata-sado-rock",
    name: "佐渡 尖閣湾・平根崎地磯",
    kana: "さど せんかくわん ひらねざきじいそ",
    region: "hokuriku",
    prefecture: "新潟県",
    address: "新潟県佐渡市北狄・小川",
    lat: 38.0841,
    lng: 138.2412,
    category: "rock",
    description: "佐渡島北西岸のダイナミックな海岸段丘・国の名勝「尖閣湾」周辺に位置する全国屈指の一級地磯。水深が足元から一気に落ち込み、ヒラマサ・マダイ・大型メジナ（尾長グレ）・クロダイ・アオリイカ・キジハタが狙える超弩級フィールド。",
  ...
  },
  {
    ...
    parkingDetails: {
      capacity: "道の駅・施設専用無料駐車場 約100台",
      fee: "無料",
      hours: "24時間利用可能",
      notes: "駐車場は24時間開放されており、前夜入りや早朝の入場整理券配布待ち（通常期5:00頃、冬季6:00頃）の車内待機が可能です。",
    },
  ...
  // --- 全国「海の駅」フィッシングスポット群 ---
  {
    ...
    lng: 140.93772,
    category: "port",
    description: "「むろらん海の駅」（施設名: 室蘭港エンルムマリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（8隻）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　新千歳空港～室蘭（高速道路利用で約1時間）札幌～室蘭（高速道路利用で約2時間）　函館～室蘭（一般道で約4時間）電車の場合：　JR室蘭駅下車　タクシーで約10分（約4km）JR東室蘭駅下車　タクシーで約20分（約11km）",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      hasToilet: true,
      hasSafetyFence: true,
      ...
      isFeeRequired: false,
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "夏期(5月～10月) 8：00～18：00　日曜・祝日は、7：00～18：00　冬期(11月～4月) 9：00～17：00",
      feeText: "日帰り：艇の長さにより異なる｡(例．20ft＝1,898円、25ft＝2,481円、30ft＝3,105円)宿　泊：艇の長さにより異なる｡(例．20ft＝3,796円、25ft＝4,962円、30ft＝6,210円)",
    },
    targetFish: ["アブラコ (アイナメ)", "クロソイ", "カジカ", "エゾメバル (ガヤ)", "チカ", "マイワシ", "サバ", "マメイカ"],
    bestSeasons: {"spring": ["アブラコ", "クロガシラカレイ", "チカ"], "summer": ["マイワシ", "サバ", "クロソイ"], "autumn": ["アブラコ", "サケ", "マメイカ", "サバ"], "winter": ["コマイ", "クロソイ", "カジカ"]},
    recommendedRigs: ["ロックフィッシュ (テキサス / ジグヘッド)", "投げ釣り仕掛け (胴突き2本針 / イソメ)", "サビキ釣り仕掛け (4〜6号)", "エギング (1.8〜2.5号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "むろらん海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "夏期(5月～10月) 8：00～18：00　日曜・祝日は、7：00～18：00　冬期(11月～4月) 9：00～17：00",
      notes: "トイレ・自販機等完備。TEL: 0143-27-4188",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アブラコ (アイナメ)やクロソイの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-monbetsu",
    name: "北海道 もんべつ海の駅 (紋別市海洋交流館)",
    kana: "もんべつうみのえき",
    region: "hokkaido",
    prefecture: "北海道",
    ...
    lng: 143.37454,
    category: "port",
    description: "「もんべつ海の駅」（施設名: 紋別市海洋交流館）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（１箇所）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：札幌から3時間50分（275km）、旭川から2時間15分（142km）、稚内から3時間50分（215km）電車の場合：JR遠軽駅下車～路線バスにて紋別市へ",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "4月1日から10月31日　09：00～18：00　11月1日から3月31日　09：00～17：00",
      feeText: "～15ft1ftにつき：年額324円、日額108円,16ft～20ft1ftにつき：年額410円、日額136円,21ft～25ft1ftにつき：年額475円、日額157円,26ft～30ft1フィートにつき：年額540円、日額179円,31ft〜35ft　1ftにつき：年額594円、日額197円,36ft～40ft1ftにつき：年額658円、日額219円,41ft～50ft1ftにつき：年額756円、日額251円,51～1ｆｔにつき：年額842円、日額280円",
    },
    targetFish: ["アブラコ (アイナメ)", "クロソイ", "カジカ", "エゾメバル (ガヤ)", "チカ", "マイワシ", "サバ", "マメイカ"],
    bestSeasons: {"spring": ["アブラコ", "クロガシラカレイ", "チカ"], "summer": ["マイワシ", "サバ", "クロソイ"], "autumn": ["アブラコ", "サケ", "マメイカ", "サバ"], "winter": ["コマイ", "クロソイ", "カジカ"]},
    recommendedRigs: ["ロックフィッシュ (テキサス / ジグヘッド)", "投げ釣り仕掛け (胴突き2本針 / イソメ)", "サビキ釣り仕掛け (4〜6号)", "エギング (1.8〜2.5号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "もんべつ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "4月1日から10月31日　09：00～18：00　11月1日から3月31日　09：00～17：00",
      notes: "トイレ・自販機等完備。TEL: 0158-24-8000",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アブラコ (アイナメ)やクロソイの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-akita",
    name: "秋田県 あきた海の駅 (秋田マリーナ)",
    kana: "あきたうみのえき",
    region: "tohoku",
    prefecture: "秋田県",
    ...
    lng: 140.03792,
    category: "port",
    description: "「あきた海の駅」（施設名: 秋田マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（5隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：秋田駅または空港から国道7号線「土崎臨海十字路」を経由して県道56号線の港湾通りから秋田天王線を北上し、飯島サンセットパークの交差点で曲がるとマリーナ入り口が見えてきます。電車の場合：JR秋田駅よりJR奥羽線、または男鹿線に乗り土崎駅よりタクシーで10分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "休日、祝日【4-9月】07:00-19:00、【10月】07:00-18:00、【11-3月】08:00-17:00平日【通年】08:00-17:00",
      feeText: "令和８年度より料金改定をしております。詳しくはお問合せください。",
    },
    targetFish: ["アイナメ", "クロソイ", "メバル", "シロギス", "アジ", "ヒラメ", "サバ", "ヤリイカ"],
    bestSeasons: {"spring": ["アイナメ", "メバル", "カレイ"], "summer": ["アジ", "シロギス", "サバ"], "autumn": ["アオリイカ", "ヒラメ", "青物 (イナダ)", "アイナメ"], "winter": ["クロソイ", "ドンコ", "ヤリイカ"]},
    recommendedRigs: ["ジグヘッドワーム (2〜7g)", "サビキ仕掛け (ピンクスキン 5号)", "チョイ投げ仕掛け (イソメ)", "ライトショアジギング (20〜30g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "あきた海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "休日、祝日【4-9月】07:00-19:00、【10月】07:00-18:00、【11-3月】08:00-17:00平日【通年】08:00-17:00",
      notes: "トイレ・自販機等完備。TEL: 018-847-1851",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アイナメやクロソイの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-shounanzushi",
    name: "神奈川県 しょうなん・逗子マリーナ海の駅 (リビエラ逗子マリーナ)",
    kana: "しょうなん逗子マリーナうみのえき",
    region: "kanto",
    prefecture: "神奈川県",
    ...
    lng: 139.55167,
    category: "port",
    description: "「しょうなん・逗子マリーナ海の駅」（施設名: リビエラ逗子マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（2隻）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　※最寄のICは『朝比奈IC』となります。1　第三京浜又は首都高速横羽線　⇒　横浜新道　⇒　横浜横須賀道路を横須賀方面へ向かい、朝比奈IC降りる　⇒　リビエラ逗子マリーナ2　首都高速・横浜IC降りる　⇒　保土ヶ谷バイパスを横須賀方面へ向かい、朝比奈IC降りる　⇒　リビエラ逗子マリーナ電車の場合：● JR横須賀線鎌倉駅より、京浜急行バス小坪経由逗子駅行きにて「小坪」下車、徒歩7分● ＪＲ横須賀線逗子駅または京浜急行新逗子駅北口より京浜急行バス小坪経由鎌倉駅行きにて「リビエラ逗子マリーナ前」下車、徒歩4分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "夏季 09:00～18:00　冬季 09:00～17:00",
      feeText: "日帰り：9:00～17:00の間の4時間まで1ftあたり440円（税込）※リビエラ逗子マリーナ内のカフェおよびレストランを5,000円以上ご利用の場合は4時間まで無料です。宿　泊：1ftあたり660円／泊（税込）",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    recommendedRigs: ["ジグ単アジング (0.8〜1.5g)", "エギング (2.5〜3.5号)", "胴突きカワハギ仕掛け (アサリ)", "サビキ釣り (小アジ専科 4〜6号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "しょうなん・逗子マリーナ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "夏季 09:00～18:00　冬季 09:00～17:00",
      notes: "トイレ・自販機等完備。TEL: 0467-24-1000",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-koajiro_seabonia",
    name: "神奈川県 こあじろ・シーボニアマリーナ海の駅 (リビエラシーボニアマリーナ)",
    kana: "こあじろシーボニアマリーナうみのえき",
    region: "kanto",
    prefecture: "神奈川県",
    ...
    lng: 139.61967,
    category: "port",
    description: "「こあじろ・シーボニアマリーナ海の駅」（施設名: リビエラシーボニアマリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（10隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：横浜横須賀道路「衣笠IC」→三浦縦貫道→高円坊入口右折→初声小学校入口左折→国道134号線電車の場合：京急三崎口駅下車→京急バス「シーボニア入口」下車5分　または三崎口駅からタクシーで15分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "夏期　09：00～18：00　　冬期　09：00～17：00",
      feeText: "日帰り：9：00～17：00の間の4時間まで　440円/ft クラブハウスレストラン5,000円以上のご利用で4時間まで無料宿　泊：1泊　660円/ft",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    recommendedRigs: ["ジグ単アジング (0.8〜1.5g)", "エギング (2.5〜3.5号)", "胴突きカワハギ仕掛け (アサリ)", "サビキ釣り (小アジ専科 4〜6号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "こあじろ・シーボニアマリーナ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "夏期　09：00～18：00　　冬期　09：00～17：00",
      notes: "トイレ・自販機等完備。TEL: 046-882-1212",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-uraga",
    name: "神奈川県 うらが海の駅 (サニーサイドマリーナ　ウラガ)",
    kana: "うらがうみのえき",
    region: "kanto",
    prefecture: "神奈川県",
    ...
    lng: 139.72503,
    category: "port",
    description: "「うらが海の駅」（施設名: サニーサイドマリーナ　ウラガ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（5隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　浦賀I.Cより5分、I.C.を降りて右折、浦賀駅前を通り抜けミニストップのある新町交差点を直進、次の信号を右折して道なり、公園を左折してすぐ電車の場合：　浦賀駅より徒歩17分。京急バス「かもめ団地」または「観音崎」行きに乗車、約2分　「新町」バス停下車、徒歩7分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "(9月-6月)08:30～17:30　(7月-8月)08:00～18:00",
      feeText: "日帰り:2時間以内2,100円 2時間以上は下記料金宿　泊：4,200円(20ft)～15,750円(50ft)",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    recommendedRigs: ["ジグ単アジング (0.8〜1.5g)", "エギング (2.5〜3.5号)", "胴突きカワハギ仕掛け (アサリ)", "サビキ釣り (小アジ専科 4〜6号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "うらが海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "(9月-6月)08:30～17:30　(7月-8月)08:00～18:00",
      notes: "トイレ・自販機等完備。TEL: 046-843-4123",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-miura_misaki",
    name: "神奈川県 みうら・みさき海の駅 (三崎フィッシャリーナ・ウォーフ「うらり」)",
    kana: "みうらみさきうみのえき",
    region: "kanto",
    prefecture: "神奈川県",
    ...
    lng: 139.62112,
    category: "port",
    description: "「みうら・みさき海の駅」（施設名: 三崎フィッシャリーナ・ウォーフ「うらり」）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（入港船の大きさで変動します。(バースの長さ155ｍです)）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　横浜横須賀道路→衣笠IC→三崎縦貫道路→国道134号→引橋交差点→県道26号→三崎港。横浜横須賀道路→佐原IC→県道27号→国道134号→引橋交差点→県道26号→三崎港。電車の場合：　京浜急行線「三崎口」駅、または「三浦海岸」駅よりバス利用で「三崎港」下車。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      feeText: "日帰り:1日1回2,500円、1日1回30分以内500円宿泊:無",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    recommendedRigs: ["ジグ単アジング (0.8〜1.5g)", "エギング (2.5〜3.5号)", "胴突きカワハギ仕掛け (アサリ)", "サビキ釣り (小アジ専科 4〜6号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "みうら・みさき海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00-17:00",
      notes: "トイレ・自販機等完備。TEL: 046-881-6721",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-numadu_enoura",
    name: "静岡県 ぬまづ・えのうら海の駅 (ヤマハマリーナ沼津)",
    kana: "ぬまづえのうらうみのえき",
    region: "tokai",
    prefecture: "静岡県",
    ...
    lng: 138.89472,
    category: "port",
    description: "「ぬまづ・えのうら海の駅」（施設名: ヤマハマリーナ沼津）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（_）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　東名高速道路沼津インターから30分。国道414号沿い。電車の場合：　ＪＲ沼津駅からタクシーで20分。またはバスで30分、停留所から3分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      feeText: "25ft以内12,600円、30ft以内16,800円、35ft以内21,000円,br>注)利用期間10月〜6月まで",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    recommendedRigs: ["ジグ単アジング (0.8〜1.5g)", "エギング (2.5〜3.5号)", "胴突きカワハギ仕掛け (アサリ)", "サビキ釣り (小アジ専科 4〜6号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "ぬまづ・えのうら海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "08:30～17:30",
      notes: "トイレ・自販機等完備。TEL: 055-939-0311",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-numadu_heda",
    name: "静岡県 ぬまづ・へだ海の駅 (戸田浮桟橋)",
    kana: "ぬまづへだうみのえき",
    region: "tokai",
    prefecture: "静岡県",
    ...
    lng: 138.77472,
    category: "port",
    description: "「ぬまづ・へだ海の駅」（施設名: 戸田浮桟橋）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（4隻）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：東名高速沼津ICより70分電車の場合：修善寺駅よりバスで60分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
    ...
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "ぬまづ・へだ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00～17:00",
      notes: "トイレ・自販機等完備。TEL: 0558-94-3115",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-hamanako_mura",
    name: "静岡県 はまなこ・むらくし海の駅 (ボートクラブカナル)",
    kana: "はまなこむらくしうみのえき",
    region: "tokai",
    prefecture: "静岡県",
    ...
    lng: 137.60242,
    category: "port",
    description: "「はまなこ・むらくし海の駅」（施設名: ボートクラブカナル）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（3隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の車の場合：　東名高速道路浜松西インターから取り付け道路を南下、はまゆう大橋を利用して12分。電車の場合：　JR浜松駅から弁天島駅。タクシーで7分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      feeText: "日帰り：7,000円　宿　泊：10,000円",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    recommendedRigs: ["ジグ単アジング (0.8〜1.5g)", "エギング (2.5〜3.5号)", "胴突きカワハギ仕掛け (アサリ)", "サビキ釣り (小アジ専科 4〜6号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "はまなこ・むらくし海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00-18:00",
      notes: "トイレ・自販機等完備。TEL: 053-489-2877",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-hamanako_kosai",
    name: "静岡県 はまなこ・こさい海の駅 (ヤマハマリーナ浜名湖)",
    kana: "はまなここさいうみのえき",
    region: "tokai",
    prefecture: "静岡県",
    ...
    lng: 137.51976,
    category: "port",
    description: "「はまなこ・こさい海の駅」（施設名: ヤマハマリーナ浜名湖）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（_）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　■東名三ケ日I.C.から約15分　■東名東京→三ケ日I.C.まで約2時間30分　 ■東名大阪→三ケ日I.C.まで約2時間30分　■東名名古屋→三ケ日I.C.まで約50分駐車場のご案内：　■約500台完備［無料］大型バス駐車可電車の場合：　JR新幹線でお越しのお客様　■JR浜松→鷲津まで約19分■JR豊橋→新所原まで約10分 ■JR鷲津駅・新所原から車で約10分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "【7-9月】9:00-17:30　【3-6・10月】9:00-17:00　【11-2月】9:00-16:30",
      feeText: "日帰り・ 宿泊：ホームページをご参照ください",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    recommendedRigs: ["ジグ単アジング (0.8〜1.5g)", "エギング (2.5〜3.5号)", "胴突きカワハギ仕掛け (アサリ)", "サビキ釣り (小アジ専科 4〜6号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "はまなこ・こさい海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "【7-9月】9:00-17:30　【3-6・10月】9:00-17:00　【11-2月】9:00-16:30",
      notes: "トイレ・自販機等完備。TEL: 053-578-1114",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-hamanako_arai",
    name: "静岡県 はまなこ・あらい海の駅 (新居マリーナ)",
    kana: "はまなこあらいうみのえき",
    region: "tokai",
    prefecture: "静岡県",
    ...
    lng: 137.56487,
    category: "port",
    description: "「はまなこ・あらい海の駅」（施設名: 新居マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（_）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　三ヶ日I.Cより約35分、浜松西I.Cより約30分電車の場合：　JR新幹線名古屋→豊橋駅30分 豊橋駅→東海道本線新居町駅18分　JR 新幹線名古屋→浜松駅2時間　浜松駅→東海道本線新居町駅15分　新居町駅→アライマリーナまで徒歩15分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "夏8:00～18:00　冬9:00～17:00",
      feeText: "日帰り：1,000円～",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    ...
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "はまなこ・あらい海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "夏8:00～18:00　冬9:00～17:00",
      notes: "トイレ・自販機等完備。TEL: 053-595-1588",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-hamanako_washidu",
    name: "静岡県 はまなこ・わしづ海の駅 (スズキマリーナ浜名湖)",
    kana: "はまなこわしづうみのえき",
    region: "tokai",
    prefecture: "静岡県",
    ...
    lng: 137.52539,
    category: "port",
    description: "「はまなこ・わしづ海の駅」（施設名: スズキマリーナ浜名湖）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（約10隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　東名高速三ケ日インターより約25分。電車の場合：　東海道本線　鷲津駅より車で5分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
    ...
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "はまなこ・わしづ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00～17:30",
      notes: "トイレ・自販機等完備。TEL: 053-578-2452",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-takahama",
    name: "愛知県 たかはま海の駅 (NTPマリーナ高浜)",
    kana: "たかはまうみのえき",
    region: "tokai",
    prefecture: "愛知県",
    ...
    lng: 136.9814,
    category: "port",
    description: "「たかはま海の駅」（施設名: NTPマリーナ高浜）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（120メートル級ビジター桟橋1本）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　知多半島道路：阿久比ICより高浜・碧南方面へ15分国道23号線：西中ICより419号線で15分電車の場合：　名鉄本線にて「知立駅」下車、名鉄三河線→三河高浜駅下車　徒歩10分JR東海道本線「刈谷駅」下車、名鉄三河線→三河高浜駅下車　徒歩10分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "夏季【4月GW初日-9月末日】9：00-18：00冬季【10月初日-4月下旬】9：00-17：00",
      feeText: "日帰り：1,000円～8,000円宿　泊：3,000円～12,000円",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    recommendedRigs: ["ジグ単アジング (0.8〜1.5g)", "エギング (2.5〜3.5号)", "胴突きカワハギ仕掛け (アサリ)", "サビキ釣り (小アジ専科 4〜6号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "たかはま海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "夏季【4月GW初日-9月末日】9：00-18：00冬季【10月初日-4月下旬】9：00-17：00",
      notes: "トイレ・自販機等完備。TEL: 0566-54-5300",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-rinku_tokoname",
    name: "愛知県 りんくう・とこなめ海の駅 (ＮＴＰマリーナりんくう)",
    kana: "りんくうとこなめうみのえき",
    region: "tokai",
    prefecture: "愛知県",
    ...
    lng: 136.83288,
    category: "port",
    description: "「りんくう・とこなめ海の駅」（施設名: ＮＴＰマリーナりんくう）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（18隻（50～60ft級））やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　名古屋中心部よりお越しの際は「知多半島道路大高IC」から中部国際空港方面「りんくうIC」を出て約3分の所にあります。名古屋中心部～りんくうICまで約40分のアクセス。空港からおクルマでお越しの場合は「セントレア東IC」から約5分で「りんくうIC」です。電車の場合：　名鉄線名古屋駅より中部国際空港行きの電車にお乗り頂き「りんくう常滑駅」で下車。名鉄りんくう常滑駅から徒歩約5分。 名古屋駅～りんくう常滑駅まで普通電車で約45分。空港から電車をご利用の場合は「名鉄線中部国際空港駅」から約2分「りんくう常滑駅」で下車。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "夏季（4月GW初日～9月末日）　09：00～18：00冬季（10月初日～4月下旬）　　 09：00～17：00",
      feeText: "日帰り：2,500　～　8,000円宿　泊：3,200　～ 15,000円",
    },
    targetFish: ["アジ", "メバル", "カサゴ", "クロダイ (チヌ)", "シーバス", "アオリイカ", "シロギス", "カワハギ"],
    bestSeasons: {"spring": ["メバル", "クロダイ (乗っ込み)", "親アオリイカ", "シロギス"], "summer": ["アジ", "シロギス", "サバ", "タコ"], "autumn": ["アオリイカ (新子)", "タチウオ", "カワハギ", "青物 (ショゴ/ワカシ)"], "winter": ["カサゴ", "メバル", "ヒイカ", "カレイ"]},
    recommendedRigs: ["ジグ単アジング (0.8〜1.5g)", "エギング (2.5〜3.5号)", "胴突きカワハギ仕掛け (アサリ)", "サビキ釣り (小アジ専科 4〜6号)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "りんくう・とこなめ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "夏季（4月GW初日～9月末日）　09：00～18：00冬季（10月初日～4月下旬）　　 09：00～17：00",
      notes: "トイレ・自販機等完備。TEL: 0569-35-7200",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやメバルの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-kashiwazaki",
    name: "新潟県 かしわざき海の駅 (新潟県柏崎マリーナ)",
    kana: "かしわざきうみのえき",
    region: "hokuriku",
    prefecture: "新潟県",
    ...
    lng: 138.52056,
    category: "port",
    description: "「かしわざき海の駅」（施設名: 新潟県柏崎マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（約30隻(事前連絡にて調整後、寄港許可)）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　北陸道「米山IC」から柏崎方面へ約5分電車の場合：　JR信越線「柏崎駅」下車　タクシーで約15分　JR信越線「鯨波駅」下車　徒歩約10分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "08:30～17:30（営業延長日有）",
      feeText: "日帰り：大型さん橋3,100円/24時間、小型さん橋1,600円24時間（共に2時間までは無料）宿　泊：同上",
    },
    targetFish: ["アジ", "キジハタ (アコウ)", "アオリイカ", "クロダイ", "カサゴ", "シロギス", "サゴシ", "メバル"],
    bestSeasons: {"spring": ["メバル", "クロダイ", "サゴシ", "ヤリイカ"], "summer": ["キジハタ", "アジ", "シロギス"], "autumn": ["アオリイカ (数釣り)", "サゴシ", "キジハタ", "アジ"], "winter": ["カサゴ", "メバル", "寒クロダイ"]},
    recommendedRigs: ["エギング (2.5〜3.5号)", "テキサスリグ (キジハタ用 10〜14g)", "サビキ釣り仕掛け", "ライトショアジギング (20〜40g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "かしわざき海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "08:30～17:30（営業延長日有）",
      notes: "トイレ・自販機等完備。TEL: 0257-21-1255",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやキジハタ (アコウ)の実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-mizuhashi",
    name: "富山県 みずはし海の駅 (水橋フィッシャリーナ)",
    kana: "みずはしうみのえき",
    region: "hokuriku",
    prefecture: "富山県",
    ...
    lng: 137.297,
    category: "port",
    description: "「みずはし海の駅」（施設名: 水橋フィッシャリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（10隻）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　富山市中心部から約30分　北陸自動車道　立山ICから約20分。電車の場合：　JR北陸本線　水橋駅が最寄駅",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "08:30～17:30",
      feeText: "1隻につき(24時間)2,750円　要事前確認",
    },
    targetFish: ["アジ", "キジハタ (アコウ)", "アオリイカ", "クロダイ", "カサゴ", "シロギス", "サゴシ", "メバル"],
    bestSeasons: {"spring": ["メバル", "クロダイ", "サゴシ", "ヤリイカ"], "summer": ["キジハタ", "アジ", "シロギス"], "autumn": ["アオリイカ (数釣り)", "サゴシ", "キジハタ", "アジ"], "winter": ["カサゴ", "メバル", "寒クロダイ"]},
    recommendedRigs: ["エギング (2.5〜3.5号)", "テキサスリグ (キジハタ用 10〜14g)", "サビキ釣り仕掛け", "ライトショアジギング (20〜40g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "みずはし海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "08:30～17:30",
      notes: "トイレ・自販機等完備。TEL: 076-482-3939",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやキジハタ (アコウ)の実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-shinminato",
    name: "富山県 しんみなと海の駅 (富山県新湊マリーナ　(海竜マリンパーク))",
    kana: "しんみなとうみのえき",
    region: "hokuriku",
    prefecture: "富山県",
    ...
    lng: 137.13556,
    category: "port",
    description: "「しんみなと海の駅」（施設名: 富山県新湊マリーナ　(海竜マリンパーク)）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（約20艇）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　北陸道小杉ICより車で30分。電車の場合：　富山駅より富山地方鉄道バス乗車。「新湊東口」行き（約30分）、「射北中学校前」下車。徒歩3分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "08:30～17:30",
      feeText: "日帰り：無料宿　泊：8m以上で 日額2,440円",
    },
    targetFish: ["アジ", "キジハタ (アコウ)", "アオリイカ", "クロダイ", "カサゴ", "シロギス", "サゴシ", "メバル"],
    bestSeasons: {"spring": ["メバル", "クロダイ", "サゴシ", "ヤリイカ"], "summer": ["キジハタ", "アジ", "シロギス"], "autumn": ["アオリイカ (数釣り)", "サゴシ", "キジハタ", "アジ"], "winter": ["カサゴ", "メバル", "寒クロダイ"]},
    recommendedRigs: ["エギング (2.5〜3.5号)", "テキサスリグ (キジハタ用 10〜14g)", "サビキ釣り仕掛け", "ライトショアジギング (20〜40g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "しんみなと海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "08:30～17:30",
      notes: "トイレ・自販機等完備。TEL: 0766-86-5440",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやキジハタ (アコウ)の実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-uminpia",
    name: "福井県 うみんぴあ大飯海の駅",
    ...
    lng: 135.63667,
    category: "port",
    description: "「うみんぴあ大飯海の駅」（施設名: 株式会社マリーナジャパン　うみんぴあ大飯マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（約6隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：舞鶴若狭道　小浜西ICから国道27号線を舞鶴方面に約10分。電車の場合：小浜線若狭本郷駅からタクシーで6分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "4-6,9,10月09：00-18：00　7,8月09：00-18：00(平日)08：00-19：00(土日祝)　11月-3月9：00-17：30",
      feeText: "日帰り：フィート数により異なります。宿　泊：フィート数により異なります。詳しくはご連絡下さい。",
    },
    targetFish: ["アジ", "キジハタ (アコウ)", "アオリイカ", "クロダイ", "カサゴ", "シロギス", "サゴシ", "メバル"],
    bestSeasons: {"spring": ["メバル", "クロダイ", "サゴシ", "ヤリイカ"], "summer": ["キジハタ", "アジ", "シロギス"], "autumn": ["アオリイカ (数釣り)", "サゴシ", "キジハタ", "アジ"], "winter": ["カサゴ", "メバル", "寒クロダイ"]},
    recommendedRigs: ["エギング (2.5〜3.5号)", "テキサスリグ (キジハタ用 10〜14g)", "サビキ釣り仕掛け", "ライトショアジギング (20〜40g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "うみんぴあ大飯海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "4-6,9,10月09：00-18：00　7,8月09：00-18：00(平日)08：00-19：00(土日祝)　11月-3月9：00-17：30",
      notes: "トイレ・自販機等完備。TEL: 0770-77-2410",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アジやキジハタ (アコウ)の実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-maizuru_central",
    name: "京都府 まいづるセントラル・マリーナ海の駅 (舞鶴セントラル・マリーナ)",
    kana: "まいづるセントラルマリーナうみのえき",
    region: "kansai",
    prefecture: "京都府",
    ...
    lng: 135.35158,
    category: "port",
    description: "「まいづるセントラル・マリーナ海の駅」（施設名: 舞鶴セントラル・マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（5隻）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：◎大阪・神戸：舞鶴自動車道舞鶴西IC→国道27号線（約20分）　◎舞鶴自動車道舞鶴東IC→国道27号線（約15分）　◎京都：国道9号線→国道27号線又は国道173号線→国道27号線電車の場合：◎JR東舞鶴駅からタクシーで15分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "09:00～18:00　シーズン中（5月～10月）の土日祝:08:00～20:00",
      feeText: "日帰り：無料　宿泊：25ft（1泊）2,100円、35ft（1泊）3,500円",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "まいづるセントラル・マリーナ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00～18:00　シーズン中（5月～10月）の土日祝:08:00～20:00",
      notes: "トイレ・自販機等完備。TEL: 0773-66-2880",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-taimiyazu",
    name: "京都府 たいみやづヨットハーバー海の駅 (田井宮津ヨットハーバー)",
    kana: "たいみやづヨットハーバーうみのえき",
    region: "kansai",
    prefecture: "京都府",
    ...
    lng: 135.2312,
    category: "port",
    description: "「たいみやづヨットハーバー海の駅」（施設名: 田井宮津ヨットハーバー）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（4艇）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：宮津天橋立ICから車で約15分。京都丹後鉄道　宮津駅よりタクシーで約15分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "4月～9月　08：00～18:00　10月～3月 08:00～17:00",
      feeText: "6時間まで1フィート100円。6時間以上24時間以内1フィート200円。",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "たいみやづヨットハーバー海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "4月～9月　08：00～18:00　10月～3月 08:00～17:00",
      notes: "トイレ・自販機等完備。TEL: 0772-22-6776",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-izumisanokankumarina",
    name: "大阪府 いずみさの関空マリーナ海の駅",
    kana: "いずみさの関空マリーナうみのえき",
    region: "kansai",
    prefecture: "大阪府",
    ...
    lng: 135.3125,
    category: "port",
    description: "「いずみさの関空マリーナ海の駅」（施設名: いずみさの関空マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（10隻（利用については、事前にお問い合わせが必要））やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
    ...
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "いずみさの関空マリーナ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00～17:00",
      notes: "トイレ・自販機等完備。TEL: 072-463-0112",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-taziri",
    name: "大阪府 たじり海の駅 (田尻漁業協同組合（委託管理：青木ヨット）)",
    kana: "たじりうみのえき",
    region: "kansai",
    prefecture: "大阪府",
    ...
    lng: 135.28333,
    category: "port",
    description: "「たじり海の駅」（施設名: 田尻漁業協同組合（委託管理：青木ヨット））。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（5隻（ヨット3隻、ボート2隻）（利用については事前にお問い合わせが必要））やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      ...
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "09:00～17:00",
      feeText: "2,000円/半日（施設利用時は500円バック）3,000円/1泊まで（施設利用時は500円バック）",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "たじり海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00～17:00",
      notes: "トイレ・自販機等完備。TEL: 072-465-8192",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-tannowayachtharbor",
    name: "大阪府 たんのわヨットハーバー海の駅 (淡輪ヨットハーバー)",
    kana: "たんのわヨットハーバーうみのえき",
    region: "kansai",
    prefecture: "大阪府",
    ...
    lng: 135.18218,
    category: "port",
    description: "「たんのわヨットハーバー海の駅」（施設名: 淡輪ヨットハーバー）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（10隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      ...
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "09:00～17:00",
      feeText: "艇の長さにより異なりますのでお問い合わせ下さい",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "たんのわヨットハーバー海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00～17:00",
      notes: "トイレ・自販機等完備。TEL: 072-494-2335",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-kiiyura",
    name: "和歌山県 きいゆら海の駅 (ナカヤマリーナ)",
    kana: "きいゆらうみのえき",
    region: "kansai",
    prefecture: "和歌山県",
    ...
    lng: 135.10583,
    category: "port",
    description: "「きいゆら海の駅」（施設名: ナカヤマリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（数隻(4隻程度)）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：御坊湯浅道路広川インターより車で15分電車の場合：JR紀伊由良駅より車で5分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      feeText: "日帰り：2時間以内1,620円、2時間を超える場合108円/ft(17:00まで)宿　泊：1泊　216円/ft(24時間まで)",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "きいゆら海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "08:00～17:00",
      notes: "トイレ・自販機等完備。TEL: 0738-65-1248",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-okayama",
    name: "岡山県 おかやま海の駅 (宮浦マリーナ)",
    kana: "おかやまうみのえき",
    region: "chugoku",
    prefecture: "岡山県",
    ...
    lng: 133.98938,
    category: "port",
    description: "「おかやま海の駅」（施設名: 宮浦マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（3隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：高速山陽自動車道『山陽インター』より約40分国道2号線バイパス倉田交差点を左折。　高速山陽自動車道『早島インター』より約40分国道2号線バイパス倉田交差点を右折。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "09:00～18:00（4月～9月） 09:00～17:00（10月～3月）",
      feeText: "日帰り：3,300円（30ft未満）4,400円（30ft以上40ft未満）5,500円(40〜45ft)宿　泊：1泊7,700円（30ft未満）11,000円（30ft以上40ft未満）16,500円(40〜45ft)2泊15,400円（30ft未満）22,000円（30ft以上40ft未満）33,000円(40〜45ft)",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "おかやま海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00～18:00（4月～9月） 09:00～17:00（10月～3月）",
      notes: "トイレ・自販機等完備。TEL: 086-267-3939",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-sakaigahama",
    name: "広島県 さかいがはま海の駅 (ベラビスタ　マリーナ)",
    kana: "さかいがはまうみのえき",
    region: "chugoku",
    prefecture: "広島県",
    ...
    lng: 133.28472,
    category: "port",
    description: "「さかいがはま海の駅」（施設名: ベラビスタ　マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（3隻程度(艇長による)）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：福山西ICから車で20分電車の場合：新幹線福山駅下車、車で30分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "【夏期】3/21～10/20　9:00～18:00　【冬期】10/21～3/20　9:00～17:30",
      feeText: "日帰り：営業時間内の出入港1ftあたり80円(税別)宿　泊：1ftあたり150円/日(税別)",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "さかいがはま海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "【夏期】3/21～10/20　9:00～18:00　【冬期】10/21～3/20　9:00～17:30",
      notes: "トイレ・自販機等完備。TEL: 084-987-3460",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-skymarine",
    name: "広島県 おおさきかみじま　すかいまりん　海の駅",
    kana: "おおさきかみじま　すかいまりん　うみのえき",
    region: "chugoku",
    prefecture: "広島県",
    ...
    lng: 132.9491,
    category: "port",
    description: "「おおさきかみじま　すかいまりん　海の駅」（施設名: AQUAROOM　SKYMARINE）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（5隻（30ftまで））やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "【めばる港から】めばる港の出入り口を右折し県道65号線を道なりに進み車で1分（約500m）徒歩7分。【垂水港から】垂水港の出入り口を左折し県道65号線を道なりに進み車で2分（約1.4km）徒歩19分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
    ...
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "おおさきかみじま　すかいまりん　海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00～18:00",
      notes: "トイレ・自販機等完備。TEL: 0846-67-3357",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-yoshijima",
    name: "広島県 よしじま海の駅 (ボートパーク広島)",
    kana: "よしじまうみのえき",
    region: "chugoku",
    prefecture: "広島県",
    ...
    lng: 132.44602,
    category: "port",
    description: "「よしじま海の駅」（施設名: ボートパーク広島）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（約5隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：◎平和通り、平和祈念公園交差点を南へ約4km。南吉島交差点を左折。◎広島高速3号線「吉島」出入口より約2分。電車の場合：JR広島駅→（広島バス利用）広島駅南バス乗り場3番より24号線バスに乗車→南吉島下車→徒歩約3分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "09：00～18：00",
      feeText: "日帰り：30フィート以下2000円/1日、31フィート以上3000円/1日宿　泊：30フィート以下2000円/1日、31フィート以上3000円/1日",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "よしじま海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09：00～18：00",
      notes: "トイレ・自販機等完備。TEL: 082-249-2855",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-hiroshima_kanon",
    name: "広島県 ひろしま・かんおん海の駅 (広島観音マリーナ)",
    kana: "ひろしまかんおんうみのえき",
    region: "chugoku",
    prefecture: "広島県",
    ...
    lng: 132.41472,
    category: "port",
    description: "「ひろしま・かんおん海の駅」（施設名: 広島観音マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（20隻（30ft換算））やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：○国道2号、広島空港交差点南下約3.5km　○山陽自動車道五日市IC、草津沼田道路経由約12.5km電車の場合：○JR広島駅よりタクシーで約30分　○JR西広島駅よりタクシーで約15分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "09:00-17:00（6月～8月の土日祝祭日は、08:00-18:00）",
      feeText: "日帰り：(例)1,800円/24hr　30ft～35ft宿 泊： 同上",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "ひろしま・かんおん海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00-17:00（6月～8月の土日祝祭日は、08:00-18:00）",
      notes: "トイレ・自販機等完備。TEL: 082-234-7710",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-shunan",
    name: "山口県 しゅうなん海の駅 (マリーナシーホース)",
    kana: "しゅうなんうみのえき",
    region: "chugoku",
    prefecture: "山口県",
    ...
    lng: 131.81308,
    category: "port",
    description: "「しゅうなん海の駅」（施設名: マリーナシーホース）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（4隻（30フィートまで係留可能））やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：山陽自動車道徳山東ICから15分電車の場合：JR徳山駅から車で15分　JR下松駅から車で15分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "（3月～6月・9月・10月）09：00～18：00（7月・8月）09：00～19：00（11月～2月）09：00～17：00",
      feeText: "日帰り：1フィートあたり100円/日（レストラン利用の場合は無料）宿　泊：1フィートあたり100円/日（レストラン利用の場合は無料）",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "しゅうなん海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "（3月～6月・9月・10月）09：00～18：00（7月・8月）09：00～19：00（11月～2月）09：00～17：00",
      notes: "トイレ・自販機等完備。TEL: 0834-26-0444",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-oki_nishinoshima",
    name: "島根県 おき・にしのしま海の駅 (隠岐シーサイドホテル鶴丸)",
    kana: "おきにしのしまうみのえき",
    region: "chugoku",
    prefecture: "島根県",
    ...
    lng: 133.01338,
    category: "port",
    description: "「おき・にしのしま海の駅」（施設名: 隠岐シーサイドホテル鶴丸）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（約3隻（30ft））やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：七類港（島根県松江市）もしくは、境港（鳥取県境港市）から旅客フェリー・高速船で別府港(隠岐：西ノ島町) 別府港から車で約10分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      feeText: "無料（隠岐シーサイドホテル鶴丸利用者：食事や宿泊など)。ホテル宿泊の場合は、1泊2食 10,000円（税別）〜お問い合わせ下さい。",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "おき・にしのしま海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "07:00-21:00",
      notes: "トイレ・自販機等完備。TEL: 08514-6-1111",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-shoudoshima_furusatomura",
    name: "香川県 しょうどしま・ふるさと村海の駅 (海の駅・道の駅小豆島ふるさと村)",
    kana: "しょうどしまふるさと村うみのえき",
    region: "shikoku",
    prefecture: "香川県",
    ...
    lng: 134.23694,
    category: "port",
    description: "「しょうどしま・ふるさと村海の駅」（施設名: 海の駅・道の駅小豆島ふるさと村）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（5艇程度(団体利用の際は応相談)）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：池田港から5分、草壁港から10分、土庄港から15分、大部港から25分、福田港から40分。道の駅「小豆島ふるさと村」に併設。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "08:30-17:30",
      feeText: "道の駅の売店・喫茶ご利用を条件に無料宿泊 1,100円",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "しょうどしま・ふるさと村海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "08:30-17:30",
      notes: "トイレ・自販機等完備。TEL: 0879-75-2266",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-sanuki_shido",
    name: "香川県 さぬき・しど海の駅 (志度マリーナ　運営会社：（香川マリン㈱）)",
    kana: "さぬきしどうみのえき",
    region: "shikoku",
    prefecture: "香川県",
    ...
    lng: 134.18772,
    category: "port",
    description: "「さぬき・しど海の駅」（施設名: 志度マリーナ　運営会社：（香川マリン㈱））。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（3隻以内）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：高速高松道の志度インターから北進で15分位。さぬき市役所や志度寺にも近い工業団地内です。電車の場合：JR志度駅・琴電志度駅共にタクシーで１０分以内の距離です。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "09:00-18:00 （冬季は17:00まで）",
      feeText: "日帰り： 1フィートあたり　100円（税別）宿　泊： 1フィートあたり　150円（税別）(2日間)",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "さぬき・しど海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00-18:00 （冬季は17:00まで）",
      notes: "トイレ・自販機等完備。TEL: 087-894-2321",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-takamatsuyashima",
    name: "香川県 たかまつ屋島海の駅 (屋島マリーナ　運営は(香川マリン株))",
    kana: "たかまつ屋島うみのえき",
    region: "shikoku",
    prefecture: "香川県",
    ...
    lng: 134.11728,
    category: "port",
    description: "「たかまつ屋島海の駅」（施設名: 屋島マリーナ　運営は(香川マリン株)）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（休日3隻以内・平日5隻以内　週末は混雑していてお受けできないことがあります。）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：高松自動車道「高松中央IC」「志度IC」から20分位。石材の町・牟礼町より庵治町へ向かう途中、丸山峠の麓にあり電車の場合：JR高徳線「屋島駅」よりタクシーで15分　コトデン「八栗駅」よりタクシーで10分位",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
    ...
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "たかまつ屋島海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00-18：00（冬季は17:00まで）",
      notes: "トイレ・自販機等完備。TEL: 087-871-2021",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-takamatsu_shinzai",
    name: "香川県 たかまつ・しんざい海の駅 (高松神在港マリーナ)",
    kana: "たかまつしんざいうみのえき",
    region: "shikoku",
    prefecture: "香川県",
    ...
    lng: 133.98907,
    category: "port",
    description: "「たかまつ・しんざい海の駅」（施設名: 高松神在港マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（2隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：瀬戸大橋料金所から20分程度電車の場合：高松駅より車で10分程。タクシーで約1,800円程度の料金です。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "09:00-18:00",
      feeText: "日帰り：25ftまで2,000円、26ftから30ftまで3,000円、31ft以上4,000円宿　泊：2日分(上欄の2倍)を頂きます。係留保管は１週間程度まで。",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "たかまつ・しんざい海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00-18:00",
      notes: "トイレ・自販機等完備。TEL: 087-882-7715",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-mitoyo_awashima",
    name: "香川県 みとよ・あわしま海の駅 (ル・ポール粟島)",
    kana: "みとよあわしまうみのえき",
    region: "shikoku",
    prefecture: "香川県",
    ...
    lng: 133.63253,
    category: "port",
    description: "「みとよ・あわしま海の駅」（施設名: ル・ポール粟島）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（3隻　最大60ft程度まで。水深1.8ｍ（干潮時））やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：三豊鳥坂ICから約20分、さぬき府中ICから約25分で須田港。須田港から船で約15分。電車の場合：JR予讃線・詫間駅からコミュニティバス詫間線・各部戸行に乗車して約20分。 　 「須田」で下車後、徒歩1分で須田港。須田港から船で15分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      feeText: "1,500円(税込)/日（午前0時を基準）※ル・ポール粟島でのご宿泊・お食事をご利用のお客さまは無料とさせていただきます。",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "みとよ・あわしま海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "08：30～17：00",
      notes: "トイレ・自販機等完備。TEL: ※必ず事前予約をお願いします。メールのみの受付となります。leport-awashima@honki-mode.co.jp",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-imabari_inokuchi",
    name: "愛媛県 いまばり・いのくち海の駅 (上浦港)",
    kana: "いまばりいのくちうみのえき",
    region: "shikoku",
    prefecture: "愛媛県",
    ...
    lng: 133.04278,
    category: "port",
    description: "「いまばり・いのくち海の駅」（施設名: 上浦港）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（1隻（係留可能船舶　77フィートまで））やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合： 大三島ＩＣから車で約５分電車の場合：ＪＲ今治駅からバスで約５５分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "予約受付時間08:30～17:00",
      feeText: "利用料500円/1日（午前0時を基準）＋係船料総トン数1トンにつき1回2.1円（24時間までごと）",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "いまばり・いのくち海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "予約受付時間08:30～17:00",
      notes: "トイレ・自販機等完備。TEL: 0897-87-3000",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-tosa_ryoma",
    name: "高知県 とさ・龍馬海の駅 (太平洋マリン)",
    kana: "とさ龍馬うみのえき",
    region: "shikoku",
    prefecture: "高知県",
    ...
    lng: 133.57395,
    category: "port",
    description: "「とさ・龍馬海の駅」（施設名: 太平洋マリン）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（3）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　高知ICから「五台山」方面へ車で15分電車の場合：　JR高知駅からタクシーで20分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "08:30～17:30(11月-3月)　08:30～18:30(4月-10月)",
      feeText: "日帰り：25ft-30ft　1,000円/半日、31ft-39ft　1,500円/半日、40ft-49ft　2,000円/半日、 50ft以上　2,500円/半日（応談）宿　泊：25ft-30ft　7,000円/1泊、31ft-39ft　8,000円/1泊、40ft-49ft　10,000円/1泊、 50ft以上　12,000円/1泊（応談）",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "とさ・龍馬海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "08:30～17:30(11月-3月)　08:30～18:30(4月-10月)",
      notes: "トイレ・自販機等完備。TEL: 050-3308-5606",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-susaki_yoshinomarina",
    name: "高知県 すさき・ヨシノマリーナ海の駅 (ＳＵＳＡＫＩヨシノマリーナ)",
    kana: "すさきヨシノマリーナうみのえき",
    region: "shikoku",
    prefecture: "高知県",
    ...
    lng: 133.30413,
    category: "port",
    description: "「すさき・ヨシノマリーナ海の駅」（施設名: ＳＵＳＡＫＩヨシノマリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（4隻（陸置き3隻、海上係留1隻）バース長さ:約19ｍ、水深:－1.5ｍ、35フィートまで）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：高知道須崎ICから車で5分、JR：土讃線須崎駅から車で7分 路線バス(約2時間に1本)：須崎市営バス「串ノ浦」バス停(歩170ｍ)",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      feeText: "海上係留(税別)25ft以下:2,500円/日26ft～30ft:3,000円/日31ft～35ft:3,500円/日※宿泊は応相談陸置き(税別)23ft以下:7,000円/回24ft～29ft:8,000円/回30ft～34ft:13,000円/回※1回（揚降込み）の利用で2泊3日まで",
    },
    targetFish: ["アオリイカ", "アジ", "タチウオ", "クロダイ (チヌ)", "キジハタ (アコウ)", "メバル", "カサゴ", "ハマチ・サゴシ"],
    bestSeasons: {"spring": ["親アオリイカ", "乗っ込みチヌ", "メバル", "コウイカ"], "summer": ["アジ", "キジハタ", "マダコ", "キス"], "autumn": ["アオリイカ", "タチウオ (テンヤ/ワインド)", "ハマチ", "カワハギ"], "winter": ["メバル", "カサゴ", "寒チヌ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "タチウオテンヤ (ワイヤー / キビナゴ)", "ライトゲーム (ジグヘッド1.5g)", "胴突き探り釣り (青イソメ/オキアミ)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "すさき・ヨシノマリーナ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "07:30～17:30",
      notes: "トイレ・自販機等完備。TEL: 0889-43-2828",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカやアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-fukuokamarinoa",
    name: "福岡県 ふくおか・マリノア海の駅 (西福岡マリーナ)",
    kana: "ふくおかマリノアうみのえき",
    region: "kyushu",
    prefecture: "福岡県",
    ...
    lng: 130.3255,
    category: "port",
    description: "「ふくおか・マリノア海の駅」（施設名: 西福岡マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（お問い合わせください。）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　福岡都市高速「天神インター」より約15分。電車の場合：　JR博多駅より車で約20分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "9:00-18:00（5月～8月）、9:00-17:00（9月～4月）、8:00-18:00（7月～8月の土日祭）",
      feeText: "日帰り：お問い合わせ下さい。",
    },
    targetFish: ["アオリイカ (ミズイカ)", "アジ", "オオモンハタ", "アカハタ", "クロダイ (チヌ)", "ヒラスズキ", "ヤズ・ネリゴ", "カワハギ"],
    bestSeasons: {"spring": ["親アオリイカ (キロアップ)", "チヌ", "アジ", "マダイ"], "summer": ["オオモンハタ", "アカハタ", "イサキ", "青物 (ネリゴ)"], "autumn": ["アオリイカ (数釣り)", "タチウオ", "ヤズ", "カワハギ"], "winter": ["メバル", "カサゴ", "アラカブ", "寒グレ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "ハタ用ジグヘッド＋シャッドテール (20〜30g)", "アジング仕掛け (0.8〜2.0g)", "ショアジギング (30〜60g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "ふくおか・マリノア海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "9:00-18:00（5月～8月）、9:00-17:00（9月～4月）、8:00-18:00（7月～8月の土日祭）",
      notes: "トイレ・自販機等完備。TEL: 092-885-2288",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカ (ミズイカ)やアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-munakata_ooshima",
    name: "福岡県 むなかたおおしま海の駅 (うみんぐ大島)",
    kana: "むなかたおおしまうみのえき",
    region: "kyushu",
    prefecture: "福岡県",
    ...
    lng: 130.43472,
    category: "port",
    description: "「むなかたおおしま海の駅」（施設名: うみんぐ大島）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（3〜4隻）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　国道3号線「王丸交差点」又は「光岡交差点」より神湊波止場（約20分）神湊波止場から宗像市営渡船で約20分電車の場合：　JR東郷駅から神湊波止場まで車で約15分　神湊波止場から宗像市営渡船で約20分",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "08時～17時(4月～10月)　08時～16時(11月～3月)",
      feeText: "日帰り：30フィート未満　2時間まで1,500円　2時間を超え24時間まで3,000円　24時間を超えるごとに3,000円　　30フィート以上　2時間まで2,000円　2時間を超え24時間まで4,000円　24時間を超えるごとに4,000円宿　泊：同上",
    },
    targetFish: ["アオリイカ (ミズイカ)", "アジ", "オオモンハタ", "アカハタ", "クロダイ (チヌ)", "ヒラスズキ", "ヤズ・ネリゴ", "カワハギ"],
    bestSeasons: {"spring": ["親アオリイカ (キロアップ)", "チヌ", "アジ", "マダイ"], "summer": ["オオモンハタ", "アカハタ", "イサキ", "青物 (ネリゴ)"], "autumn": ["アオリイカ (数釣り)", "タチウオ", "ヤズ", "カワハギ"], "winter": ["メバル", "カサゴ", "アラカブ", "寒グレ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "ハタ用ジグヘッド＋シャッドテール (20〜30g)", "アジング仕掛け (0.8〜2.0g)", "ショアジギング (30〜60g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "むなかたおおしま海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "08時～17時(4月～10月)　08時～16時(11月～3月)",
      notes: "トイレ・自販機等完備。TEL: 0940-72-2361",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカ (ミズイカ)やアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-shinmozi",
    name: "福岡県 しんもじ海の駅 (新門司マリーナ)",
    kana: "しんもじうみのえき",
    region: "kyushu",
    prefecture: "福岡県",
    ...
    lng: 131.00352,
    category: "port",
    description: "「しんもじ海の駅」（施設名: 新門司マリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（お問い合わせ下さい。）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：【福岡方面】高速「新門司インター」より約5分。【山口方面】高速「門司インター」より約15分。電車の場合：JR門司駅よりタクシー約20分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "09:00-17:00",
      feeText: "一泊　9ｍ未満：3,300円　9ｍ超～10ｍ：4,400円　10ｍ超～11ｍ：5,500円",
    },
    targetFish: ["アオリイカ (ミズイカ)", "アジ", "オオモンハタ", "アカハタ", "クロダイ (チヌ)", "ヒラスズキ", "ヤズ・ネリゴ", "カワハギ"],
    bestSeasons: {"spring": ["親アオリイカ (キロアップ)", "チヌ", "アジ", "マダイ"], "summer": ["オオモンハタ", "アカハタ", "イサキ", "青物 (ネリゴ)"], "autumn": ["アオリイカ (数釣り)", "タチウオ", "ヤズ", "カワハギ"], "winter": ["メバル", "カサゴ", "アラカブ", "寒グレ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "ハタ用ジグヘッド＋シャッドテール (20〜30g)", "アジング仕掛け (0.8〜2.0g)", "ショアジギング (30〜60g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "しんもじ海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00-17:00",
      notes: "トイレ・自販機等完備。TEL: 093-481-0099",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカ (ミズイカ)やアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-kunisaki_m",
    name: "大分県 くにさき・マリンピアむさし海の駅",
    kana: "くにさきマリンピアむさしうみのえき",
    region: "kyushu",
    prefecture: "大分県",
    ...
    lng: 131.73505,
    category: "port",
    description: "「くにさき・マリンピアむさし海の駅」（施設名: マリンピアむさし）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（20）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：大分空港より国道213号線を北上約3分。信号のある交差点を右折してすぐ。電車の場合：JR杵築駅から車で30分。大分空港より徒歩15分。（羽田→大分90分。大阪→大分50分。）",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
    ...
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "くにさき・マリンピアむさし海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00-17:00",
      notes: "トイレ・自販機等完備。TEL: 0978-69-0165",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカ (ミズイカ)やアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
  {
    id: "uminoeki-oomurawan",
    name: "長崎県 おおむらわん海の駅 (マリーナアルパマ)",
    kana: "おおむらわんうみのえき",
    region: "kyushu",
    prefecture: "長崎県",
    ...
    lng: 129.84358,
    category: "port",
    description: "「おおむらわん海の駅」（施設名: マリーナアルパマ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（7隻）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：高速｢多良見インター｣より（長崎バイパス経由）約20分。電車の場合：JR長崎駅より車で約30分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
    ...
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "おおむらわん海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "09:00-18:00",
      notes: "トイレ・自販機等完備。TEL: 095-882-1829",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカ (ミズイカ)やアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-nagasaki",
    name: "長崎県 ながさき海の駅 (長崎サンセットマリーナ)",
    kana: "ながさきうみのえき",
    region: "kyushu",
    prefecture: "長崎県",
    ...
    lng: 129.8186,
    category: "port",
    description: "「ながさき海の駅」（施設名: 長崎サンセットマリーナ）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（約10隻(50ftクラスまで)）やマリーナ施設が整い、レンタルボート（ボートフィッシング）や周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：高速｢福岡インター｣より約1時間40分。電車の場合：JR長崎駅より車で約15分。",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "【4月～9月】09:00-18:00【10月～3月】09:00-17:00",
      feeText: "35ftの場合：1日 (24H) 3,675円　1週間18,375円　1ヶ月66,150円詳細はホームページをご覧下さい。",
    },
    targetFish: ["アオリイカ (ミズイカ)", "アジ", "オオモンハタ", "アカハタ", "クロダイ (チヌ)", "ヒラスズキ", "ヤズ・ネリゴ", "カワハギ"],
    bestSeasons: {"spring": ["親アオリイカ (キロアップ)", "チヌ", "アジ", "マダイ"], "summer": ["オオモンハタ", "アカハタ", "イサキ", "青物 (ネリゴ)"], "autumn": ["アオリイカ (数釣り)", "タチウオ", "ヤズ", "カワハギ"], "winter": ["メバル", "カサゴ", "アラカブ", "寒グレ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "ハタ用ジグヘッド＋シャッドテール (20〜30g)", "アジング仕掛け (0.8〜2.0g)", "ショアジギング (30〜60g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "ながさき海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "【4月～9月】09:00-18:00【10月～3月】09:00-17:00",
      notes: "トイレ・自販機等完備。TEL: 095-865-3000",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカ (ミズイカ)やアジの実績が高く、レンタルボートを利用して沖合ポイントを攻めるのもおすすめです。",
  },
  {
    id: "uminoeki-setouchi",
    name: "鹿児島県 せとうち海の駅 (古仁屋漁港ターミナルビル)",
    kana: "せとうちうみのえき",
    region: "kyushu",
    prefecture: "鹿児島県",
    ...
    lng: 129.31,
    category: "port",
    description: "「せとうち海の駅」（施設名: 古仁屋漁港ターミナルビル）。国土交通省認定の海の駅ネットワークに登録されたマリンリゾート＆港湾拠点。ビジターバース（3〜6隻）やマリーナ施設が整い、周辺護岸・隣接堤防からアジ・アオリイカ・根魚等の多彩な四季の魚が狙える海の駅フィッシングスポットです。",
    accessInfo: "車の場合：　奄美空港から国道58号の終点まで直進すると右手に見えます。（アーチ橋を超えると“海の駅”に到着です）",
    depthRange: "3m〜12m (マリーナ・港内〜水路)",
    bottomType: "砂泥・敷石・基礎ケーソン・人工リーフ",
    facilities: {
      hasParking: true,
      ...
      isNightFishingAllowed: true,
      nightFishingText: "夜釣り可能（施設利用規則・係留船周辺への立ち入り制限等ルール厳守）",
      openingHours: "06:30～19:00（管理事務所は8:30～19:00",
      feeText: "日帰り：無料　宿　泊：無料",
    },
    targetFish: ["アオリイカ (ミズイカ)", "アジ", "オオモンハタ", "アカハタ", "クロダイ (チヌ)", "ヒラスズキ", "ヤズ・ネリゴ", "カワハギ"],
    bestSeasons: {"spring": ["親アオリイカ (キロアップ)", "チヌ", "アジ", "マダイ"], "summer": ["オオモンハタ", "アカハタ", "イサキ", "青物 (ネリゴ)"], "autumn": ["アオリイカ (数釣り)", "タチウオ", "ヤズ", "カワハギ"], "winter": ["メバル", "カサゴ", "アラカブ", "寒グレ"]},
    recommendedRigs: ["エギング (3.0〜3.5号)", "ハタ用ジグヘッド＋シャッドテール (20〜30g)", "アジング仕掛け (0.8〜2.0g)", "ショアジギング (30〜60g)"],
    localRules: ["海の駅マリーナ係留艇・浮桟橋・立入禁止区域への無断進入厳禁", "漁業者・プレジャーボート出入港時のキャスト禁止（船舶最優先）", "コマセ・イカスミ汚れの海水洗浄とゴミの完全持ち帰り", "ライフジャケット着用徹底"],
    parkingDetails: {
      capacity: "せとうち海の駅・周辺駐車場 完備",
      fee: "無料（一部施設有料）",
      hours: "06:30～19:00（管理事務所は8:30～19:00",
      notes: "トイレ・自販機等完備。TEL: 0997-72-4626",
    },
    tips: "マリーナ周辺は潮通しがよくベイトが集まりやすい絶好のポイント。アオリイカ (ミズイカ)やアジの実績が高く、足場が良い護岸からのサビキやエギング・ライトゲームが楽しめます。",
  },
];
