...
export const FISH_SPECIES_DATA: FishSpecies[] = [
  ...
  },
  {
    ...
    "category": "dangerous",
    "description": "堤防の夜釣りやサビキ・ブッコミ釣りで群れ（ゴンズイ玉）をなして掛かるナマズ目の海水魚。体側に2本の鮮やかな黄色い縦縞と口元に8本のヒゲが特徴。背ビレと左右の胸ビレに鋭い強毒棘を持ち、刺されると焼けるような激痛と激しい腫れ・組織壊死を引き起こす。死後も毒性が持続するため絶対に素手で触れてはならない。毒棘をハサミで完全除去し適切に下処理すれば、蒲焼き・煮付け・味噌汁（ゴンズイ汁）で白身の脂が乗った極上の美味として味わえる。",
    "habitat": "内湾の浅海・防波堤・テトラポッド周り・岩礁帯・砂泥底（夜間に群れで堤防際に接近）",
    "waterLayer": "bottom",
    "waterLayerText": "底層〜底付近（夜間は中層・表層近くまで浮上）",
    "averageSize": "10cm〜20cm (最大30cm前後)",
    "recordSize": "30cm",
    "activeMonths": [
      4,
      5,
    ...
    "bestTime": "夜間（日没後〜夜半に活発化）・夕マズメ・濁り潮時",
    "favoriteBaits": [
      "青イソメ・岩イソメ",
      "オキアミ",
      "魚の切り身（サンマ・サバ）",
    ...
    "fishingTips": "1匹釣れると周囲に群れているため連続でヒットします。釣れた際は絶対に素手で触らず、必ずフィッシュグリップやメゴチバサミでがっちり挟み、プライヤーで針を外してください。持ち帰る際は現場でキッチンバサミを使い、背ビレと両胸ビレの棘を根元から完全に切り落とします。死後も毒性が残るため、堤防上に放置すると他の釣り人が誤って踏んで大怪我をする危険があります。必ず海に戻すか持ち帰って処分してください。",
    "isDangerous": true,
    "dangerNotes": "背ビレに1本、左右の胸ビレに各1本の計3本の鋭い毒棘があります。刺されると焼けるような激痛が走り、患部が赤く腫れ上がります。死んだ個体でも毒が残るため素手厳禁。刺された場合は傷口を真水で洗い毒を絞り出し、43〜45℃前後の温水に40〜60分患部を浸す温熱療法（タンパク毒の不活化）が有効です。重症時や痛みが引かない場合は直ちに医療機関へ受診してください。",
    "dangerType": "contact_venom"
  },
  {
    "id": "kusafugu-poison",
    ...
    "category": "dangerous",
    "description": "日本全国の防波堤・砂浜・磯・河口汽水域に無数に生息する小型フグ。背面はオリーブ色（草色）に多数の白い小斑点が散らばる。初夏の大潮の夕方に波打ち際へ集団で押し寄せて産卵する生態でも有名。釣りではあらゆるエサを鋭利なクチバシ状の歯で齧り取り、針やハリスを切断する「堤防最強のエサ取り厄介者」。肝臓・卵巣・腸・皮膚など全身に致死量の猛毒テトロドトキシンを持つため絶対に食べてはならない。",
    "habitat": "日本全国の沿岸・漁港堤防・浅海砂泥底・岩礁帯・サーフ波打ち際・河口汽水域",
    "waterLayer": "all",
    "waterLayerText": "表層〜底層（底から海面近くまでエサを追って群がる）",
    "averageSize": "10cm〜15cm (最大20cm前後)",
    "recordSize": "22cm",
    "activeMonths": [
      1,
      2,
    ...
    "bestTime": "日中・全時間帯（特に明るい時間帯に視覚でエサを見つけて群がる）",
    "favoriteBaits": [
      "オキアミ・アミエビ",
      "青イソメ・ゴカイ",
      "練りエサ",
    ...
    "fishingTips": "狙って釣る魚ではなく、アジやシロギス、クロダイなどを狙っている際の外道として猛威を振るいます。1匹掛かると周囲に何十匹も群れているため、エサが一瞬で取られたりハリスを切られたりする場合は、タナを大きく変えるか少しポイントを休ませて移動するのが得策。釣れたクサフグを堤防上に放置して乾燥死させる行為は、野鳥やペットの誤食事故、悪臭の原因となるため、必ず海に優しくリリースしてください。",
    "isDangerous": true,
    "dangerNotes": "肝臓・卵巣に極めて強い致死猛毒テトロドトキシンを含み、腸や皮膚（体表）にも強毒があります。素人調理による誤食は麻痺や呼吸停止を引き起こし命に関わります。絶対に持ち帰って食べないでください。また、釣り針を外す際に鋭いクチバシで指を噛まれると深く切れて大量出血するため、メゴチバサミとプライヤーを使用して速やかにリリースしてください。",
    "dangerType": "ingestion_poison"
  },
  {
    "id": "torafugu",
    "name": "【猛毒注意】トラフグ (虎河豚)",
    ...
    "category": "tasty_table",
    "description": "「ふぐ料理の王様」と称される最高級フグ。胸ビレ後方に白く縁取られた大きな黒斑があり、背中から尾にかけて微小な棘（小棘）が密生する。近年は東京湾や外房・常磐沖などで冬〜春にかけて専門船（カットウ・テンヤ）で大型（数キロ級）が狙えることで爆発的人気。筋肉（身）や精巣（白子）は極上の美味だが、肝臓や卵巣などの内臓には致死性の猛毒テトロドトキシンを含む。専門のふぐ処理師による身欠き（有毒部位完全除去）が絶対条件。",
    "habitat": "外洋に面した沿岸〜水深20〜100mの砂泥底・岩礁混じりの海底。春の産卵期には内湾や浅海へ接岸。",
    "waterLayer": "bottom",
    "waterLayerText": "底層〜底上1〜2m（砂泥底や岩礁の上を巡回）",
    "averageSize": "35cm〜60cm (最大70cm超・重さ5kg以上)",
    "recordSize": "75cm",
    "activeMonths": [
      1,
      2,
    ...
    "fishingTips": "頑丈なクチバシ状の歯で太いハリスや針も噛み切るため、親針・掛け針周りはワイヤーやケプラー、太軸パイプで保護。底から50cm〜1mを丁寧に小突き（誘い）、わずかなテンション抜けやモタレアタリを瞬時に鋭くアワセます。遊漁船では船宿が「身欠き（内臓・皮の有毒部位完全除去）」を行ってくれる船を必ず利用してください。",
    "isDangerous": true,
    "dangerNotes": "肝臓・卵巣・腸などに致死性の猛毒テトロドトキシン（青酸カリの約1000倍の毒性）を含みます。加熱調理しても毒素は分解されません。一般人の素人調理・無資格解体は絶対に禁止です。また、強靭な歯は人間の指の肉を簡単に噛みちぎる威力があるため、釣れた際の針外しはフィッシュグリップとロングプライヤーを必ず使用してください。",
    "dangerType": "ingestion_poison"
  },
  {
    "id": "shousaifugu",
    "name": "【猛毒注意】ショウサイフグ (潮際河豚)",
    "kana": "しょうさいふぐ",
    "scientificName": "Takifugu snyderi",
    "category": "tasty_table",
    "description": "東京湾や常磐、伊勢湾などで「湾フグ」として絶大な人気を誇る中型フグ。背中は褐色に白い斑点、体側下に黄色い縦帯があり、胸ビレ後方の黒斑には白い縁取りがないことでトラフグと区別される。繊細なアタリを掛け合わせるカットウ釣りはゲーム性が極めて高く、白身の刺身（てっさ）や唐揚げ、てっちり鍋はトラフグにも劣らぬ上品な旨みがある。筋肉は無毒（一部海域を除く）だが、肝臓や卵巣に強毒テトロドトキシンを含むため素人調理は絶対厳禁。",
    "habitat": "水深10〜50m前後の沿岸砂泥底・貝殻混じりの砂地・岩礁隣接のフラット",
    "waterLayer": "bottom",
    "waterLayerText": "底層（海底すれすれの底上10〜50cm）",
    "averageSize": "20cm〜35cm (最大40cm前後)",
    "recordSize": "42cm",
    "activeMonths": [
      1,
      2,
    ...
    "bestTime": "日中（遊漁船のデイゲーム）・潮が適度に動くタイミング",
    "favoriteBaits": [
      "アオヤギ（むき身）",
      "アルゼンチンアカエビ",
      "アサリ",
    ...
    "fishingTips": "エサ盗り名人のため、エサ針のアオヤギやエビの周りにホバリングして巧みにエサだけを齧り取ります。オモリを着底させてゼロテンションを保ち、穂先の数ミリの震えやモタレを見逃さずに「空アワセ」を定期的に入れるタイム釣りや、繊細な目感度アワセが数釣りのキモ。遊漁船の「身欠きサービス」を利用して安全に持ち帰りましょう。",
    "isDangerous": true,
    "dangerNotes": "肝臓・卵巣に強いテトロドトキシン（猛毒）を含み、皮や筋肉にも海域や個体によって弱毒が検出される場合があります。一般釣り人による素人調理は食中毒（呼吸不全・死亡事故）に直結するため絶対に禁止です。釣れた魚は必ずふぐ処理師免許を持つ船宿で身欠き（可食部のみの解体）を依頼してください。また鋭い歯での噛傷にも注意。",
    "dangerType": "ingestion_poison"
  },
  {
    "id": "kitamakura-poison",
    "name": "【危険魚】キタマクラ (北枕)",
    "kana": "きたまくら",
    "scientificName": "Canthigaster rivulata",
    "category": "dangerous",
    "description": "本州中部以南の岩礁域や防波堤に生息する小型フグ。体側に2本の青い縦帯と無数の青色小斑点を持つ。食べると中毒死して遺体を北枕に寝かせることになるのが名前の由来とされる。肝臓・卵巣・腸だけでなく皮膚（粘液）や筋肉にも強毒テトロドトキシンを含むため絶対に食べてはならない。磯釣りや堤防フカセ釣りでハリスを噛み切る厄介なエサ取りとして有名。",
    "habitat": "本州中部以南の沿岸岩礁域・サンゴ礁・防波堤・テトラポッド周り",
    "waterLayer": "bottom",
    "waterLayerText": "底層〜中層（岩礁の隙間や海藻の周りを遊泳）",
    "averageSize": "10cm〜15cm",
    "activeMonths": [
      1,
      2,
    ...
    "bestTime": "日中（明るい時間帯に活発）",
    "favoriteBaits": [
      "オキアミ",
      "青イソメ",
      "練りエサ"
    ],
    "fishingTips": "強靭なくちばしでチヌ針やハリスを容易に切断します。1匹釣れると周囲に群れていることが多く、仕掛けが何個もロストするため、タナを大きく変えるか少し離れたポイントへ移動するのが賢明です。素手で触ったり堤防に放置せず、プライヤーで針を外して速やかに海へリリースしてください。",
    "isDangerous": true,
    "dangerType": "ingestion_poison",
    "dangerNotes": "肝臓・卵巣だけでなく、皮膚・筋肉・腸にも強いテトロドトキシン毒（フグ毒）を含みます。素人調理による誤食は致死的な食中毒を引き起こします。絶対に食べないでください。針を外す際も鋭いくちばしで噛まれないよう注意。"
  },
  {
    "id": "akaei-poison",
    "name": "【危険魚】アカエイ (赤鱏)",
    ...
    "category": "dangerous",
    "description": "浅い海の砂泥底や河口、干潟、サーフに生息する大型のエイ。体は菱形で背面は黄褐色、腹面は白く縁が黄色や橙色。尾の付け根背側にノコギリ状の鋭利な毒棘（1〜2本）を持ち、誤って踏んだり触れたりすると深く突き刺さって激痛と組織壊死・大量出血を引き起こす。初夏〜秋にかけて波打ち際や河口に多数接岸し、ウェーディングの釣り人にとって最も危険な生物の一つ。適切にトゲを落として下処理すればヒレ（エイヒレ）や身は煮付けや唐揚げで美味。",
    "habitat": "全国の浅海砂泥底・干潟・河口汽水域・サーフ（砂地に潜砂して擬態）",
    "waterLayer": "bottom",
    "waterLayerText": "底層（海底の砂泥の中に潜り目だけを出して潜んでいる）",
    "averageSize": "体盤幅30cm〜1m (全長1.5m以上・重さ10kg超)",
    "recordSize": "200cm",
    "activeMonths": [
      4,
      5,
    ...
    "bestTime": "朝夕マズメ・夜間・満潮前後の潮位が高い時間帯",
    "favoriteBaits": [
      "青イソメ・本虫",
      "魚の切り身（サンマ・サバ）",
      "カニ・エビ",
    ...
    "fishingTips": "サーフや干潟でのウェーディング（立ち込み釣り）時は、足を上げて歩かずすり足で歩く「エイ歩き（エイガード装着推奨）」を徹底。ヒット時は強烈な重みで海底に張り付きます。釣り上げた際は絶対に尾の周辺に近づかず、柄の長いギャフやロープで制御し、ハサミやプライヤーで尾の毒棘を折るか切り落としてから針を外してください。",
    "isDangerous": true,
    "dangerType": "contact_venom",
    "dangerNotes": "尾の付け根にあるノコギリ状の毒棘には返しがあり、深く刺さると抜けにくく外科的な大怪我になります。同時に強毒が注入され、耐え難い激痛、血圧降下、呼吸困難、患部の組織壊死を引き起こします。刺された場合は傷口を真水で洗い、棘が残っていれば慎重に抜いて、45℃前後の温水に患部を浸してタンパク毒を緩和させ、速やかに救急車または外科・救急外来を受診してください。"
  },
  {
    "id": "kyuriuo",
    "name": "キュウリウオ (胡瓜魚)",
