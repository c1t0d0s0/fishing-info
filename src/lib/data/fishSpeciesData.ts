...
export const FISH_SPECIES_DATA: FishSpecies[] = [
  ...
  {
    id: "mejina",
    name: "メジナ / グレ / 尾長グレ / 口太グレ (眼仁奈)",
    kana: "めじな / ぐれ / おながぐれ",
    scientificName: "Girella punctata / Girella leonina",
    category: "bottom_rock",
    description: "磯釣りの最高峰ターゲット。強い引きと賢さで釣り人を魅了し、60cmを超える「ロクマル尾長」は全アングラーの憧れ。冬の「寒グレ」は脂が乗り刺身・鍋が絶品。",
    habitat: "外洋に面した荒磯・地磯・沖磯・潮通しの良い堤防・テトラ帯",
    waterLayer: "middle",
    waterLayerText: "中層〜底層（コマセに反応して水面近くまで浮上することも）",
    averageSize: "25cm〜40cm (50cm超で大型、60cm超は幻のロクマル)",
    recordSize: "73cm",
    activeMonths: [1,2,3,4,5,10,11,12],
    peakMonths: [11,12,1,2,3],
    difficulty: 4,
    edibleRating: 5,
    cookingMethods: ["寒グレの刺身・焼き切り","グレしゃぶ（絶品）","煮付け","塩焼き","白子ポン酢"],
    recommendedRigs: ["ウキフカセ仕掛け (円錐ウキ0〜3B)","沈め探り釣り (00〜000号)","カゴ釣り"],
    bestTime: "朝夕マズメ・上げ潮の潮が動く時間帯・サラシの広がる時合",
    favoriteBaits: ["オキアミ生","海苔 (冬のノリグレ)","練りエサ","剥きエビ"],
    fishingTips: "サラシの切れ目や本流と引かれ潮の合流点へコマセと刺しエサを同調させて流します。尾長グレは歯が鋭いためチモトに補強を入れるか早アワセで唇に掛けます。",
    isDangerous: false
  },
  {
    id: "ishidai",
    name: "イシダイ / イシガキダイ / ガラサーミーバイ (石鯛)",
    kana: "いしだい / いしがきだい",
    scientificName: "Oplegnathus fasciatus / Oplegnathus punctatus",
    category: "bottom_rock",
    description: "「磯の王者」と呼ばれる磯底物釣りの最高峰。強靭なクチバシでウニや貝を噛み砕き、竿を海中へ突き刺す「三段引き」は強烈無比。大型の銀ワサ（オス成魚）は幻。",
    habitat: "外洋性の急深な荒磯・地磯・沖磯・深海ケーソン堤防",
    waterLayer: "bottom",
    waterLayerText: "底層（海底の海溝・ドロップオフ・沈み根周辺）",
    averageSize: "35cm〜55cm (60cm超で「銀ワサ」と呼ばれる)",
    recordSize: "82cm",
    activeMonths: [4,5,6,7,8,9,10,11],
    peakMonths: [5,6,9,10,11],
    difficulty: 5,
    edibleRating: 5,
    cookingMethods: ["薄造り・刺身（皮湯引きポン酢）","兜焼き・塩焼き","あら炊き","潮汁"],
    recommendedRigs: ["イシダイ専用ぶっこみ仕掛け (瀬ズレワイヤー + 捨てオモリ30〜40号)","南方宙釣り仕掛け"],
    bestTime: "朝夕マズメ・潮止まり前後の潮が動き始めるタイミング",
    favoriteBaits: ["ガンガゼウニ","バフンウニ","サザエ","ヤドカリ","トコブシ","赤貝"],
    fishingTips: "竿先が海中へ突き刺さる「本アタリ」まで絶対に早アワセせず待ちます。強烈な突っ込みを剛竿と大型両軸リールで力勝負で浮かせます。",
    isDangerous: false
  },
  {
    id: "kue",
    name: "クエ / アラ / モロコ (九絵)",
    kana: "くえ / あら",
    scientificName: "Hyporthodus octofasciatus / Epinephelus bruneus",
    category: "bottom_rock",
    description: "磯釣りの究極の夢「幻の巨大魚」。30kg〜40kgを超える巨体と底知れぬ怪力を誇り、超極太タックルで挑む。最高級魚として知られ、ゼラチン質に包まれた肉質は鍋の王様。",
    habitat: "外洋の超深海岩礁帯・海溝・洞窟・急深な地磯・離島堤防",
    waterLayer: "bottom",
    waterLayerText: "超底層（海底の巨大岩礁の穴や亀裂に潜む）",
    averageSize: "60cm〜100cm (大型は20kg〜40kg超)",
    recordSize: "135cm / 45kg (ショア記録)",
    activeMonths: [5,6,7,8,9,10,11],
    peakMonths: [6,7,8,9,10],
    difficulty: 5,
    edibleRating: 5,
    cookingMethods: ["クエ鍋（天下無比の美味）","刺身・薄造り","胃袋・皮ポン酢","煮付け","兜焼き"],
    recommendedRigs: ["クエ専用ショアぶっこみ仕掛け (ワイヤーハリス + クエ針30〜40号 + 板バネ竿受け)"],
    bestTime: "夜間（日没後〜深夜）・マズメ時",
    favoriteBaits: ["サバ1匹掛け","活きヤリイカ / アオリイカ","ムロアジ","メジカ"],
    fishingTips: "エサを食い込んだ瞬間に穴へ引き込もうとするため、一瞬の隙も与えずウインチのように巻き上げて海底から引き剥がすのがすべてです。",
    isDangerous: false
  },
  {
    id: "hiramasa",
    ...
    scientificName: "Seriola lalandi",
    category: "blue_pelagic",
    description: "「磯のダンプカー」「ショア青物の頂点」と呼ばれる最強のスプリンター。ブリに似るが体高が薄く黄色い縦帯が鮮やか。根に向かって疾走する破壊的な引きはアングラーを熱狂させます。",
    habitat: "外洋性の激流地磯・沖磯・潮通しの良い大防波堤・岬先端",
    waterLayer: "surface",
    waterLayerText: "表層〜中層（捕食時は水面を激しく割る）",
    averageSize: "60cm〜90cm (メーター超え・10kg以上は「オオマサ」)",
    recordSize: "155cm / 35kg (ショア記録)",
    activeMonths: [4,5,6,9,10,11,12],
    peakMonths: [5,6,10,11],
    difficulty: 5,
    edibleRating: 5,
    cookingMethods: ["刺身（極上の歯ごたえ）","ヒラマサのしゃぶしゃぶ","カマ塩焼き","照り焼き","漬け丼"],
    recommendedRigs: ["ショアプラッギング (ダイビングペンシル 160〜230mm)","ロックショアジギング (80〜150g)","泳がせ釣り"],
    bestTime: "朝マズメ・潮が激しく走るタイミング・風波の立つ時合",
    favoriteBaits: ["トビウオ","イワシ","アジ","サンマ","ダイビングプラグ"],
    fishingTips: "水面を滑らかにダイブ＆ロールさせるトップウォータープラグで誘い出し。ヒット後はドラグを締め込み、根ズレする前に強引にロッドを立てて浮かせます。",
    isDangerous: false
  },
  {
    id: "hirasuzuki",
    ...
    scientificName: "Lateolabrax latus",
    category: "bottom_rock",
    description: "荒れ狂う外洋の磯波「サラシ」の中に潜む銀色の孤高の王者。マルスズキより体高があり引きが圧倒的に強烈。透き通るような白身は極上の美味。",
    habitat: "外洋に面した荒磯・地磯のサラシ帯・ゴロタ浜・岬周辺",
    waterLayer: "surface",
    waterLayerText: "表層（白波の泡立つサラシの直下0〜1m）",
    averageSize: "50cm〜75cm (80cm超でランカー)",
    recordSize: "96cm",
    activeMonths: [3,4,5,10,11,12,1],
    peakMonths: [3,4,11,12],
    difficulty: 4,
    edibleRating: 5,
    cookingMethods: ["刺身・昆布締め（絶品）","塩焼き","ムニエル・ポワレ","潮汁","フライ"],
    recommendedRigs: ["ヒラスズキ専用ルアー (リップ付きフローティングミノー 120〜140mm / シンペン 28〜35g)"],
    bestTime: "ウネリと風で広大なサラシ（白泡）が発生している日中〜マズメ",
    favoriteBaits: ["キビナゴ","イワシ","イカ","シャッド系ミノー"],
    fishingTips: "大波が引いた瞬間に広がるサラシの奥へルアーを着水させ、泡の中を漂わせるようにスローリトリーブ。一撃でドカンとバイトが出ます。安全装備必須。",
    isDangerous: false
  },
  {
    id: "shimaaji",
    ...
    scientificName: "Pseudocaranx dentex",
    category: "blue_pelagic",
    description: "アジ類最高峰の超高級魚にして「幻のスピードスター」。金色に輝く美しい魚体と強烈無比な横走り。口が極めて柔らかいためバラしやすく、釣り人を熱くさせます。",
    habitat: "黒潮の影響を受ける暖海域・伊豆諸島・小笠原・紀伊半島・四国・九州南部の堤防・地磯",
    waterLayer: "middle",
    waterLayerText: "底層〜中層付近",
    averageSize: "30cm〜50cm (60cm超・5kg以上は「オオカミ」と呼ばれる)",
    recordSize: "88cm / 10.2kg",
    activeMonths: [4,5,6,7,8,9,10,11],
    peakMonths: [5,6,9,10,11],
    difficulty: 4,
    edibleRating: 5,
    cookingMethods: ["刺身・握り寿司（甘みと脂が最高峰）","塩焼き","なめろう","アラ炊き"],
    recommendedRigs: ["ウキフカセ太仕掛け (クッションゴム入り)","遠投カゴ釣り","ライトショアジギング"],
    bestTime: "朝夕マズメ・夜釣り（常夜灯周りや電気ウキ）",
    favoriteBaits: ["オキアミ","アミエビ","イカ短冊","練りエサ"],
    fishingTips: "アタリは電撃的で一気に突っ込みます。口切れを防ぐため、ロッド全体の弾力とドラグワークで引きをいなし、玉網へ確実に誘導します。",
    isDangerous: false
  },
  {
    id: "ishimochi",
    name: "イシモチ / シログチ / ニベ (石持 / 白口)",
    kana: "いしもち / しろぐち",
    scientificName: "Pennahia argentata",
    category: "popular_coastal",
    description: "頭の中に大きな耳石（炭酸カルシウムの石）を持つことが名の由来。砂泥底を好み、サーフや堤防の投げ釣り・ぶっこみ釣りで小気味よいアタリと強い引きが楽しめます。塩焼きや干物が絶品。",
    habitat: "外洋サーフ・内湾・砂泥底の堤防・海釣り公園・河口付近",
    waterLayer: "bottom",
    waterLayerText: "底層（海底から50cm〜1.5m）",
    averageSize: "20cm〜30cm (35cm以上で大型)",
    recordSize: "48cm",
    activeMonths: [5,6,7,8,9,10,11],
    peakMonths: [6,7,8,9,10],
    difficulty: 1,
    edibleRating: 4,
    cookingMethods: ["塩焼き（振り塩して水分を抜くのがコツ）","干物","唐揚げ","すり身・さつま揚げ","刺身（当日釣りたて限定）"],
    recommendedRigs: ["サーフ投げ釣り胴突き2〜3本針仕掛け (丸セイゴ12〜14号 + オモリ15〜25号)","チョイ投げ仕掛け","ぶっこみ釣り"],
    bestTime: "夕マズメ〜夜間・濁り潮が入った日中・満潮前後",
    favoriteBaits: ["アオイソメ (房掛け)","イワイソメ","ジャリメ"],
    fishingTips: "波打ち際〜2色（50m）付近の濁りが入ったカケアガリにアオイソメを房掛けにして投入。クククッ！と竿先を叩く明確なアタリが出ます。",
    isDangerous: false
  },
  {
    id: "oonibe",
    ...
    scientificName: "Nibea japonica",
    category: "bottom_rock",
    description: "サーフから狙える日本最大級の怪魚（体長150cm・30kg超に成長）。宮崎・遠州灘・高知などのサーフで冬に巨大な群れが接岸し、全国のアングラーが夢を追うターゲット。",
    habitat: "太平洋外洋大サーフ・急深な砂浜・大河川河口",
    waterLayer: "bottom",
    waterLayerText: "底層〜中層（コノシロやイワシの群れを追って回遊）",
    averageSize: "80cm〜120cm (メーター超え・20kg級実績多数)",
    recordSize: "160cm / 35kg (ショア記録)",
    activeMonths: [11,12,1,2,3],
    peakMonths: [12,1,2],
    difficulty: 5,
    edibleRating: 4,
    cookingMethods: ["刺身・昆布締め","ムニエル・ポワレ","フライ","鍋物","カマ塩焼き"],
    recommendedRigs: ["ヘビーサーフキャスティング (ヘビーシンペン 35〜50g / メタルジグ 40〜60g / ビッグミノー 140〜170mm)","オオニベ専用ぶっこみ仕掛け"],
    bestTime: "ベイト（コノシロ・イワシ）が接岸したマズメ〜夜間",
    favoriteBaits: ["コノシロ","マイワシ","大型シンキングペンシル"],
    fishingTips: "広大なサーフから鳥山やベイトのざわつきを見つけ出し、ヘビーシンペンを遠投してボトムすれすれをスローリトリーブ。ヒット後は数十メートルの猛ダッシュを耐え抜きます。",
    isDangerous: false
  },
  {
    id: "sakuramasu",
    name: "サクラマス / 海サクラ / 海アメマス (桜鱒)",
    kana: "さくらます / うみさくら",
    scientificName: "Oncorhynchus masou",
    category: "bottom_rock",
    description: "北日本・日本海の春の訪れを告げる美しい降海型サーモン。銀ピカの魚体とサクラ色の美しい肉質、トラウト最高峰のローリングファイトでルアーマンを魅了します。",
    habitat: "北海道・東北・北陸・山陰のサーフ・ゴロタ浜・河口周辺・磯場",
    waterLayer: "surface",
    waterLayerText: "表層〜中層（水面直下〜2m）",
    averageSize: "45cm〜60cm (60cm超で「板マス」と呼ばれる)",
    recordSize: "75cm / 5.5kg",
    activeMonths: [1,2,3,4,5,6],
    peakMonths: [3,4,5],
    difficulty: 4,
    edibleRating: 5,
    cookingMethods: ["ルイベ・刺身（冷凍処理後）","塩焼き・ムニエル","フライ","ちゃんちゃん焼き","スモークサーモン"],
    recommendedRigs: ["海サクラ専用ジグミノー (28〜40g)","メタルジグ (30〜45g)","細身ロングミノー (120〜140mm)"],
    bestTime: "夜明けの朝マズメ・上げ潮時・波立ちが適度にある時合",
    favoriteBaits: ["オオナゴ (イカナゴ)","カタクチイワシ","ジグミノー"],
    fishingTips: "沖のブレイクや離岸流へジグミノーをフルキャストし、ファストリトリーブの中に一瞬のストップ（フォール）を入れるとガツンとバイトしてきます。",
    isDangerous: false
  },
  {
    id: "isomaguro",
    ...
    scientificName: "Gymnosarda unicolor",
    category: "blue_pelagic",
    description: "鋭い牙と弾丸のような肉体を持つ南洋・小笠原・沖縄の怪力モンスター。マグロの名が付くがサバ科の独立属。ヒットした瞬間に100m以上を一気に疾走する暴力的な引きが特徴。",
    habitat: "小笠原諸島・南西諸島・トカラ列島・八丈島などの黒潮直撃急深地磯・岬先端・離島堤防",
    waterLayer: "middle",
    waterLayerText: "中層〜表層（深海ドロップオフから急浮上して捕食）",
    averageSize: "80cm〜130cm (20kg〜40kg超実績多数)",
    recordSize: "180cm / 70kg (ショア記録)",
    activeMonths: [5,6,7,8,9,10,11],
    peakMonths: [6,7,8,9],
    difficulty: 5,
    edibleRating: 3,
    cookingMethods: ["竜田揚げ・フライ","ステーキ・ソテー","漬け焼き","加熱用（鮮度管理必須）"],
    recommendedRigs: ["ヘビーショアキャスティング (大型ダイビングペンシル 180〜230mm)","ヘビーショアジギング (100〜150g)","ワイヤーハリス泳がせ仕掛け"],
    bestTime: "朝マズメ・激流の潮が走るタイミング",
    favoriteBaits: ["ムロアジ","グルクン","トビウオ","大型プラグ"],
    fishingTips: "強烈なカミソリのような歯を持つため、プラグのフックアイやリーダーの耐摩耗性に万全を期します。ファーストランを耐えたらポンピングで一気に寄せます。",
    isDangerous: false
  },
  {
    id: "korodai",
    ...
    scientificName: "Diagramma pictum",
    category: "bottom_rock",
    description: "体表の美しい斑点模様と分厚い唇が特徴の暖海性大物。夜釣りでのぶっこみ釣りやカゴ釣りのターゲットとして強烈な引きで人気。上質な白身で刺身・煮付けが絶品。",
    habitat: "紀伊半島・四国・九州・南西諸島・伊豆諸島の沿岸岩礁・サーフ隣接のゴロタ・防波堤",
    waterLayer: "bottom",
    waterLayerText: "底層（海底の砂泥と岩盤が混じるエリア）",
    averageSize: "40cm〜65cm (70cm超で特大)",
    recordSize: "85cm",
    activeMonths: [5,6,7,8,9,10,11],
    peakMonths: [7,8,9,10],
    difficulty: 3,
    edibleRating: 5,
    cookingMethods: ["刺身・カルパッチョ（程よい脂と歯ごたえ）","ポワレ・ムニエル","塩焼き","煮付け","潮汁"],
    recommendedRigs: ["夜釣りぶっこみ仕掛け (PE4〜6号 + 丸セイゴ/タマン針 + オモリ20〜30号)","遠投カゴ釣り"],
    bestTime: "夜間（日没後〜深夜）・満潮前後の潮が動くタイミング",
    favoriteBaits: ["マムシ (本虫)","アオイソメ房掛け","イカ短冊","ユムシ","オキアミ"],
    fishingTips: "夜間にエサを求めて浅場へ差してきます。ドラグを少し緩めておき、竿先が海面へ突き刺さったら大きくアワセを入れて根から離します。",
    isDangerous: false
  },
  {
    id: "datsu",
    name: "ダツ / オキザヨリ / テンジくだつ (駄津)",
    kana: "だつ / おきざより",
    scientificName: "Strongylura anastomella / Tylosurus crocodilus",
    category: "blue_pelagic",
    description: "ノコギリのような鋭い歯と硬いクチバシを持つ細長い大型肉食魚。ルアーに対する反応が極めて良く、フッキング後は水面を激しくジャンプ＆テールウォークして暴れます。",
    habitat: "本州中部以南・南西諸島・伊豆小笠原の沿岸表層・サーフ・磯・堤防",
    waterLayer: "surface",
    waterLayerText: "超表層（水面直下を群れや単独で高速遊泳）",
    averageSize: "60cm〜100cm (オキザヨリは130cm超に成長)",
    recordSize: "145cm",
    activeMonths: [5,6,7,8,9,10,11],
    peakMonths: [6,7,8,9],
    difficulty: 2,
    edibleRating: 3,
    cookingMethods: ["天ぷら・フライ（上品な白身）","塩焼き","つみれ汁","唐揚げ"],
    recommendedRigs: ["トップウォータープラグ (ポッパー/ペンシル 100〜140mm)","メタルジグ (20〜40g)","キビナゴウキ釣り仕掛け"],
    bestTime: "日中の晴天時・朝夕マズメ",
    favoriteBaits: ["キビナゴ","小魚","小型トップウォータープラグ"],
    fishingTips: "硬いクチバシは針掛かりしにくいため、細軸のトレブルフックを使用するかアシストフックを複数装着してジャークさせます。夜間のライトへの突進に注意。",
    isDangerous: true
  },
  {
    id: "tenagaebi",
    ...
    scientificName: "Macrobrachium nipponense",
    category: "popular_coastal",
    description: "初夏の風物詩として大人気の淡水・汽水エビ。オスの長いハサミが特徴で、テトラの隙間や敷石周りでウキをピクピク引き込む繊細な駆け引きがファミリーにも大人気。素揚げが極上の美味。",
    habitat: "河川下流・河口汽水域・運河・海釣り公園の人工磯・消波ブロック帯",
    waterLayer: "bottom",
    waterLayerText: "底層（テトラの隙間・敷石の陰・護岸のキワ）",
    averageSize: "10cm〜20cm (オスは腕を含めると25cm超)",
    recordSize: "28cm",
    activeMonths: [5,6,7,8,9],
    peakMonths: [5,6,7],
    difficulty: 1,
    edibleRating: 5,
    cookingMethods: ["テナガエビの素揚げ・唐揚げ（ビールに最高）","エビチリ","塩茹で","かき揚げ"],
    recommendedRigs: ["テナガエビ専用仕掛け (シモリウキ + エビ針2〜3号 + ガン玉)","極小玉ウキ仕掛け"],
    bestTime: "日中の満潮前後・夕マズメ・曇天時",
    favoriteBaits: ["赤虫 (アカムシ)","青イソメ細切れ","魚肉ソーセージ","カニカマ"],
    fishingTips: "エサを掴んでから口に運ぶまで時間がかかるため、ウキが沈んでから10〜20秒じっくり待ってから竿をそっと真上に持ち上げるのがコツです。",
    isDangerous: false
  },
  {
    id: "bora",
    ...
    scientificName: "Mugil cephalus",
    category: "popular_coastal",
    description: "「とどのつまり」の語源となった出世魚。卵巣は高級珍味「カラスミ」として名高い。外洋や冬の澄み潮で獲れる「寒ボラ」は鯛をも凌ぐ脂の乗りと絶品の旨味を誇ります。",
    habitat: "沿岸全域・港湾・堤防・河口・サーフ・汽水域",
    waterLayer: "all",
    waterLayerText: "全層（表層でジャンプし海底で泥をついばむ）",
    averageSize: "30cm〜60cm (70cm超で大型「トド」)",
    recordSize: "86cm",
    activeMonths: [1,2,3,4,5,9,10,11,12],
    peakMonths: [11,12,1,2],
    difficulty: 2,
    edibleRating: 4,
    cookingMethods: ["寒ボラのあらい・刺身（冬限定・絶品）","カラスミ（自家製）","フライ","鍋物","塩焼き"],
    recommendedRigs: ["ウキフカセ釣り","吸い込み仕掛け / ギャング仕掛け","サビキ釣り","ルアー"],
    bestTime: "日中〜夕マズメ・潮が動く時間帯",
    favoriteBaits: ["オキアミ","練りエサ","パン","青イソメ"],
    fishingTips: "冬の寒ボラは水が澄んだ外洋寄りのポイントで狙うと臭みが一切なく極上。強烈なダッシュ力で竿を満月に曲げてくれます。",
    isDangerous: false
  },
  {
    id: "umitanago",
    ...
    scientificName: "Ditrema temminckii",
    category: "popular_coastal",
    description: "卵ではなく仔魚を産む「胎生魚」として知られる春の風物詩。美しい小判型の魚体で、堤防の足元や磯場でウキをキュンと引き込むアタリが手軽に楽しめます。",
    habitat: "沿岸の港湾・堤防・テトラ帯・海藻帯・地磯",
    waterLayer: "middle",
    waterLayerText: "中層〜底層（海藻の周りに群れる）",
    averageSize: "15cm〜25cm (30cm超で大型)",
    recordSize: "34cm",
    activeMonths: [12,1,2,3,4,5,6],
    peakMonths: [2,3,4,5],
    difficulty: 1,
    edibleRating: 3,
    cookingMethods: ["塩焼き","煮付け","南蛮漬け","唐揚げ","天ぷら"],
    recommendedRigs: ["ウキ釣り仕掛け (玉ウキ/棒ウキ + ハエスレ針/袖針)","胴突き仕掛け","サビキ釣り"],
    bestTime: "日中（朝マズメ〜夕方）・潮が緩やかに動く時間帯",
    favoriteBaits: ["オキアミ小粒","青イソメ細切れ","ジャリメ","アミエビ"],
    fishingTips: "おちょぼ口でエサを取るのが上手いため、小さめの針にエサを小さく付けてウキの消し込みに素早くアワセを入れます。",
    isDangerous: false
  },
  {
    id: "akahata",
    name: "アカハタ / アカバ (赤羽 / 赤羽太)",
    kana: "あかはた / あかば",
    scientificName: "Epinephelus fasciatus",
    category: "bottom_rock",
    description: "鮮やかな真紅の魚体と黒い背びれ先端が美しい高級ハタ。外洋の岩礁帯に生息し、ワームやジグへの果敢なアタックと強烈な突っ込みが魅力。透き通る白身と旨味は絶品。",
    habitat: "本州中部以南・伊豆諸島・小笠原・紀伊・四国・九州・沖縄の地磯・ゴロタ・沖磯・深場堤防",
    waterLayer: "bottom",
    waterLayerText: "底層（岩礁の隙間・スリット・沈み根周辺）",
    averageSize: "25cm〜35cm (40cm超で大型)",
    recordSize: "48cm",
    activeMonths: [5,6,7,8,9,10,11,12],
    peakMonths: [6,7,8,9,10],
    difficulty: 2,
    edibleRating: 5,
    cookingMethods: ["刺身・薄造り（熟成で甘み凝縮）","清蒸（中華風酒蒸し）","煮付け","アクアパッツァ","味噌汁"],
    recommendedRigs: ["テキサスリグ / フリーリグ (14〜28g + クロー系ワーム 3〜4inch)","ブレードジグ (30〜40g)","ブラクリ仕掛け"],
    bestTime: "日中〜マズメ（日中の高水温期に活発に捕食）",
    favoriteBaits: ["キビナゴ","サバ切り身","ホッグ系・シャッド系ワーム"],
    fishingTips: "ボトムを着底後、リフト＆フォールでリズミカルにアピール。根に潜られないようバイトが出たら即座にロッドを煽って根から引き離します。",
    isDangerous: false
  },
  {
    id: "oomonhata",
    ...
    difficulty: 3,
    edibleRating: 5,
    cookingMethods: ["刺身・炙り","カルパッチョ","ポワレ","煮付け","潮汁"],
    recommendedRigs: ["ジグヘッドスイミングリグ (20〜40g + シャッドテールワーム 4inch)","メタルジグ (30〜45g)"],
    bestTime: "日中〜マズメ（澄み潮の晴天時に好反応）",
    favoriteBaits: ["シャッドテールワーム","カタクチイワシ","メタルジグ"],
  ...
  },
  {
    ...
    scientificName: "Epinephelus akaara",
    category: "bottom_rock",
    description: "「夏のフグ」と称される関西・瀬戸内・日本海の超高級魚。オレンジの斑点が美しく、夜釣りや夕マズメに甲殻類や小魚を捕食。上品かつ濃厚な甘みを持つ極上白身。",
    habitat: "日本海・瀬戸内海・九州・本州中部の岩礁帯・消波ブロック・石積み波止・急流水道",
    waterLayer: "bottom",
    waterLayerText: "底層（敷石やテトラの隙間・海底の岩陰）",
    averageSize: "25cm〜40cm (45cm超で大型、50cm超は幻)",
    recordSize: "55cm",
    activeMonths: [5,6,7,8,9,10,11],
    peakMonths: [6,7,8,9],
    difficulty: 3,
    edibleRating: 5,
    cookingMethods: ["アコウの薄造り・刺身","酒蒸し","煮付け（定番にして最高）","潮汁","唐揚げ"],
    recommendedRigs: ["テキサスリグ / フリーリグ (10〜28g)","直リグ (ジカリグ)","活きエビ胴突き仕掛け"],
    bestTime: "夕マズメ〜夜間・潮の緩むタイミング",
    favoriteBaits: ["活きシラサエビ","クロー系ワーム","アジ・イワシ切り身"],
    fishingTips: "敷石やスリットのキワをタイトにトレース。アタリを感じたら電撃フッキングを決め、根に潜られる前に一気に巻き上げます。",
    isDangerous: false
  },
  {
    id: "barahata",
    ...
    difficulty: 3,
    edibleRating: 3,
    cookingMethods: ["唐揚げ","バター焼き","煮付け（※熱帯・大型個体はシガテラ注意）"],
    recommendedRigs: ["ショアジギング (40〜80g)","大型シンペン","タマン仕掛け"],
    bestTime: "日中〜マズメ",
    favoriteBaits: ["メタルジグ","イカ切り身","小魚"],
  ...
  },
  {
    ...
    category: "popular_coastal",
    description: "東北・三陸・北海道の冬を代表する美味な底生魚。丸っこい愛嬌のある姿と巨大な肝が特徴。冬の夜釣りの穴釣りやぶっこみ釣りで手軽に釣れ、「ドンコ汁（肝味噌汁）」は絶品。",
    habitat: "北日本・太平洋沿岸の岩礁帯・テトラの穴・堤防足元のスリット・砂泥底",
    waterLayer: "bottom",
    waterLayerText: "完全底層（テトラの奥底・海底の岩陰に密着）",
    averageSize: "20cm〜35cm (40cm超で大型)",
    recordSize: "46cm",
    activeMonths: [10,11,12,1,2,3,4],
    peakMonths: [11,12,1,2],
    difficulty: 1,
    edibleRating: 5,
    cookingMethods: ["ドンコ汁（肝を溶いた味噌汁・最高峰の美味）","肝和え刺身（当日限定）","煮付け","唐揚げ"],
    recommendedRigs: ["ブラクリ仕掛け (3〜6号)","胴突き仕掛け","夜釣りジグヘッドワーム"],
    bestTime: "夜間（日没後〜深夜）・マズメ時",
    favoriteBaits: ["青イソメ (房掛け)","サンマの切り身","イカの短冊"],
    fishingTips: "テトラの奥深くへブラクリを落とし込み、底に着いたら小刻みにシェイク。モゾモゾとしたアタリがあったら即アワセで抜き上げます。",
    isDangerous: false
  },
  {
    id: "takenokomebaru",
    name: "タケノコメバル / ベッコウゾイ (筍目張)",
    kana: "たけのこのめばる / べっこうぞい",
    scientificName: "Sebastes oblongus",
    category: "bottom_rock",
    description: "タケノコが伸びる春に美味しくなることから名付けられた大型ロックフィッシュ。東北では「ベッコウゾイ」と呼ばれ、50cm級のモンスターは怪力無比。非常に美味な白身。",
    habitat: "全国の沿岸岩礁帯・テトラ帯・海藻帯・ゴロタ場・内湾の捨石",
    waterLayer: "bottom",
    waterLayerText: "底層（海藻ジャングルの中や岩盤スリット）",
    averageSize: "25cm〜35cm (40cm超で大型、50cm超はモンスター)",
    recordSize: "53cm",
    activeMonths: [10,11,12,1,2,3,4,5],
    peakMonths: [3,4,5,11,12],
    difficulty: 3,
    edibleRating: 5,
    cookingMethods: ["刺身・薄造り","煮付け","塩焼き","唐揚げ・アクアパッツァ"],
    recommendedRigs: ["テキサスリグ / ビフテキ (10〜21g)","ジグヘッドリグ (5〜14g)","胴突き仕掛け"],
    bestTime: "朝夕マズメ・夜間・曇天時",
    favoriteBaits: ["クロー系・ホッグ系ワーム","青イソメ","小魚"],
    fishingTips: "海藻帯（ホンダワラ等）のポケットやテトラの隙間へタイトにフォール。バイトと同時に強引にリフトして海藻に巻かれないようにします。",
    isDangerous: false
  },
  {
    id: "isaki",
    name: "イサキ / ジャンボイサキ (伊佐木)",
    kana: "いさき / じゃんぼいさき",
    scientificName: "Parapristipoma trilineatum",
    category: "bottom_rock",
    description: "初夏の「梅雨イサキ」として脂が乗る磯・堤防の超人気ターゲット。夜釣りでのウキフカセやカゴ釣りで40cm超の「ジャンボイサキ」がヒットし、皮目を炙った刺身は極上。",
    habitat: "潮通しの良い外洋地磯・沖磯・深場防波堤・岬周辺",
    waterLayer: "middle",
    waterLayerText: "中層（夜間はタナが浅くなり表層近くまで浮上）",
    averageSize: "25cm〜35cm (40cm超でジャンボイサキ)",
    recordSize: "51cm",
    activeMonths: [5,6,7,8,9,10],
    peakMonths: [6,7,8],
    difficulty: 2,
    edibleRating: 5,
    cookingMethods: ["焼き霜造り（炙り刺身・最高峰）","塩焼き","煮付け","なめろう","カルパッチョ"],
    recommendedRigs: ["夜釣り電気ウキフカセ仕掛け","遠投カゴ釣り仕掛け (ハリス3〜4号 + オキアミ)"],
    bestTime: "半夜釣り（日没後〜深夜）・朝夕マズメ",
    favoriteBaits: ["オキアミ生","アミエビ","イカ短冊"],
    fishingTips: "夜釣りでは竿一本（約5m）前後のタナを電気ウキで流します。ウキがスパッと海中へ消し込む爽快なアタリが連発します。",
    isDangerous: false
  },
  {
    id: "takabe",
    ...
    scientificName: "Labracoglossa argentiventris",
    category: "popular_coastal",
    description: "黄色い背びれと美しい青い魚体を持つ夏の最高級小魚。「磯の鮎」と称され、塩焼きにした際のしたたる脂と香ばしさは魚類屈指の美味。伊豆諸島や外洋磯で大群をなします。",
    habitat: "黒潮洗う外洋性の岩礁帯・地磯・島しょ部・潮通しの良い堤防",
    waterLayer: "surface",
    waterLayerText: "表層〜中層（群れで激しく乱舞する）",
    averageSize: "15cm〜25cm (30cm超で大型)",
    recordSize: "36cm",
    activeMonths: [6,7,8,9,10],
    peakMonths: [6,7,8,9],
    difficulty: 2,
    edibleRating: 5,
    cookingMethods: ["塩焼き（したたる脂と甘み・絶品）","刺身（新鮮な大型個体）","唐揚げ","南蛮漬け"],
    recommendedRigs: ["ウキフカセ細仕掛け (ハリス1〜1.5号 + 小針)","トリックサビキ","カゴ釣り"],
    bestTime: "日中〜夕マズメ・潮が激しく流れる時間帯",
    favoriteBaits: ["アミエビ","オキアミ小粒","アオイソメ細切れ"],
    fishingTips: "コマセに激しく群がるため、エサ取りをかわしつつ仕掛けを素早く同調させます。口が小さいため針は小さめのグレ針やアジ針が最適です。",
    isDangerous: false
  },
  {
    id: "kawahagi",
    name: "カワハギ / ウマヅラハギ (皮剥)",
    kana: "かわはぎ / うまづらはぎ",
    scientificName: "Stephanolepis cirrhifer / Thamnaconus modestus",
    category: "popular_coastal",
    description: "「エサ取り名人」と呼ばれるテクニカルな人気魚。秋〜冬の「肝パン」と呼ばれる濃厚な肝は海のフォアグラ。アタリを感知して掛けるゲーム性の高さと極上の食味を両立。",
    habitat: "沿岸の岩礁帯・砂礫底・堤防・海釣り公園・イカダ",
    waterLayer: "bottom",
    waterLayerText: "底層〜中層（底から1〜3m付近でホバリング）",
    averageSize: "18cm〜25cm (30cm超で「尺ハギ」と呼ばれる)",
    recordSize: "36cm",
    activeMonths: [8,9,10,11,12,1,2],
    peakMonths: [9,10,11,12],
    difficulty: 3,
    edibleRating: 5,
    cookingMethods: ["肝和え刺身・薄造り（天下の絶品）","煮付け","ちり鍋","塩焼き","唐揚げ"],
    recommendedRigs: ["胴突き3本針ハゲ仕掛け (集魚板/中オモリ + ハゲ針3〜5号)","チョイ投げ仕掛け"],
    bestTime: "日中（朝マズメ〜日中の潮が緩やかに動く時間帯）",
    favoriteBaits: ["アサリの剥き身 (塩締め)","青イソメ細切れ","オキアミ"],
    fishingTips: "中オモリを揺すって仕掛けを弛ませ（ハワセ）、ゆっくり聞き上げながらアタリを感じ取って鋭くアワセを入れます。",
    isDangerous: false
  },
  {
    id: "hedai",
    name: "ヘダイ / キビレ (平鯛 / 黄鰭)",
    kana: "へだい / きびれ",
    scientificName: "Rhabdosargus sarba / Acanthopagrus latus",
    category: "bottom_rock",
    description: "マダイとクロダイの長所を併せ持つ銀白の美魚。クロダイ以上の強烈な突進力と、マダイに匹敵するクセのない上品な甘い白身を持つ隠れた最高級ターゲット。",
    habitat: "本州中部以南・四国・九州の内湾・サーフ・河口・地磯・堤防",
    waterLayer: "bottom",
    waterLayerText: "底層〜中層（砂泥底や岩礁周り）",
    averageSize: "25cm〜40cm (50cm超で大型)",
    recordSize: "55cm",
    activeMonths: [4,5,6,7,8,9,10,11,12],
    peakMonths: [6,7,8,9,10,11],
    difficulty: 2,
    edibleRating: 5,
    cookingMethods: ["刺身・カルパッチョ（マダイ以上の甘み）","塩焼き","煮付け","ポワレ","鯛飯"],
    recommendedRigs: ["ウキフカセ仕掛け","渚釣り仕掛け","チニング (フリーリグ/トップウォーター)","投げ釣り"],
    bestTime: "朝夕マズメ・夜間・満潮前後の潮の動き出し",
    favoriteBaits: ["オキアミ","コーン","カニ","マムシ","クロー系ワーム"],
    fishingTips: "フカセ釣りでは底付近を這わせるように流すとヒット。チニングでは砂底をズル引きして小気味よい連続バイトを掛け合わせます。",
    isDangerous: false
  },
  {
    id: "shirodai",
    ...
    difficulty: 4,
    edibleRating: 5,
    cookingMethods: ["刺身・薄造り（脂が乗り極上の美味）","兜煮・あら炊き","塩焼き","マース煮"],
    recommendedRigs: ["打ち込み仕掛け (PE6〜8号 + タマン針22〜24号 + イカ1匹掛け/ムロアジ)"],
    bestTime: "夜間（日没後〜深夜）",
    favoriteBaits: ["イカ丸ごと","ムロアジ切り身","タコ脚"],
  ...
  },
  {
    ...
    difficulty: 3,
    edibleRating: 5,
    cookingMethods: ["刺身（濃厚な脂と強い旨味）","塩焼き","なめろう","照り焼き"],
    recommendedRigs: ["ショアジギング (40〜80g)","カゴ釣り","ウキフカセ釣り"],
    bestTime: "朝夕マズメ・上げ潮時",
    favoriteBaits: ["メタルジグ","オキアミ","小魚"],
  ...
  },
  {
    ...
    difficulty: 1,
    edibleRating: 4,
    cookingMethods: ["くさや","刺身（釣りたて限定）","なめろう","塩焼き","フライ"],
    recommendedRigs: ["サビキ仕掛け (ハゲ皮 6〜8号)","カゴ釣り","ライトジグ"],
    bestTime: "朝夕マズメ・日中",
    favoriteBaits: ["アミエビ","オキアミ","小型メタルジグ"],
  ...
  },
  {
    ...
    difficulty: 3,
    edibleRating: 3,
    cookingMethods: ["刺身（冬の新鮮個体・血抜き必須）","味噌煮","唐揚げ","フライ"],
    recommendedRigs: ["ウキフカセ仕掛け (ハリス太め2.5〜4号)"],
    bestTime: "日中〜マズメ",
    favoriteBaits: ["オキアミ","海苔","練りエサ"],
  ...
  },
  {
    ...
    difficulty: 4,
    edibleRating: 5,
    cookingMethods: ["刺身・炙り（全身大トロ・超絶美味）","兜焼き","煮付け","潮汁"],
    recommendedRigs: ["夜釣りシブダイ専用ぶっこみ仕掛け (PE6〜8号 + タマン針20〜22号 + キビナゴ/イワシ)","ウキフカセ夜太仕掛け"],
    bestTime: "完全な夜間（日没後〜深夜）",
    favoriteBaits: ["キビナゴ (房掛け)","イワシ1匹掛け","オキアミボイル","イカ短冊"],
  ...
  },
  {
    ...
    scientificName: "Coryphaena hippurus",
    category: "blue_pelagic",
    description: "「万力」と呼ばれる夏の海の熱狂的スーパースター。オスは額が角ばる独特の顔つきで、エメラルドグリーンと金色に輝く魚体。大ジャンプを連発するファイトとフライ・ムニエルが人気。",
    habitat: "本州中部以南・黒潮海域・伊豆諸島・南西諸島の外洋表層・沖堤防・潮目・漂流物周り",
    waterLayer: "surface",
    waterLayerText: "超表層（水面を群れでジャンプしながら疾走）",
    averageSize: "50cm〜100cm (メーター超え・130cm以上は「メーターオーバー」)",
    recordSize: "185cm / 38kg",
    activeMonths: [6,7,8,9,10],
    peakMonths: [7,8,9],
    difficulty: 3,
    edibleRating: 4,
    cookingMethods: ["マヒマヒフライ（ハワイ名物・最高）","ムニエル・ポワレ","竜田揚げ","刺身（新鮮個体）","西京焼き"],
    recommendedRigs: ["トップウォータープラグ (ポッパー/ペンシル 120〜160mm)","ライトショアジギング (30〜60g)"],
    bestTime: "日中の快晴時・潮目が接岸する時間帯",
    favoriteBaits: ["トビウオ","イワシ","トップウォータープラグ"],
    fishingTips: "漂流物（流れ藻やブイ）のキワへポッパーをキャストして激しくスプラッシュ。水面を割って群れでチェイスしてきます。",
    isDangerous: false
  },
  {
    id: "soudagatsuo",
    name: "ソウダガツオ / ヒラソウダ / マルソウダ (宗太鰹)",
    kana: "そうだがつお / ひらそうだ",
    scientificName: "Auxis rochei / Auxis thazard",
    category: "blue_pelagic",
    description: "夏の堤防に大群で押し寄せるスピード狂。カツオ節の原料として重宝される。特に「ヒラソウダ」は脂が乗ってモチモチの刺身が絶品（※鮮度低下が早いため血抜き必須）。",
    habitat: "沿岸全域・潮通しの良い堤防・海釣り公園・沖磯・サーフ",
    waterLayer: "surface",
    waterLayerText: "表層〜中層（ナブラを立てて高速回遊）",
    averageSize: "30cm〜40cm (45cm超で大型)",
    recordSize: "52cm",
    activeMonths: [7,8,9,10,11],
    peakMonths: [8,9,10],
    difficulty: 1,
    edibleRating: 4,
    cookingMethods: ["ヒラソウダの刺身・タタキ（当日釣りたて限定・絶品）","竜田揚げ","生姜煮","自家製ソウダ節"],
    recommendedRigs: ["ライトショアジギング (20〜40g)","弓角・サーフトローリング","カゴ釣り"],
    bestTime: "朝夕マズメ・日中の潮が走るタイミング",
    favoriteBaits: ["シラス","キビナゴ","小型メタルジグ","弓角"],
    fishingTips: "ナブラを見つけたら進行方向へメタルジグや弓角をキャストして超高速リトリーブ。釣れたら即座にエラを切って氷水で急冷します。",
    isDangerous: false
  },
  {
    id: "katsuo",
    ...
    difficulty: 3,
    edibleRating: 5,
    cookingMethods: ["カツオのタタキ（藁焼き）","ハガツオの刺身（絶品モチモチ食感）","漬け丼","竜田揚げ","塩焼き"],
    recommendedRigs: ["ショアジギング (40〜80g)","ヘビーシンキングミノー (35〜50g)","弓角仕掛け"],
    bestTime: "朝マズメ・黒潮分流が接岸した時合",
    favoriteBaits: ["カタクチイワシ","キビナゴ","メタルジグ"],
  ...
  },
  {
    ...
    difficulty: 5,
    edibleRating: 5,
    cookingMethods: ["キハダの刺身・中落ち","漬け丼","カマ焼き","レアカツ","カルパッチョ"],
    recommendedRigs: ["ヘビーショアキャスティング (ダイビングペンシル 160〜200mm)","ヘビーショアジギング (80〜150g)","泳がせ釣り"],
    bestTime: "朝夕マズメ・上げ潮時・トビウオ接岸時",
    favoriteBaits: ["トビウオ","ムロアジ","マイワシ","大型ダイビングペンシル"],
    fishingTips: "ボイル撃ちが基本。ダイビングペンシルを滑らかに引いてアピールし、ヒット後は数十メートルの疾走を耐えてからリフトします。",
    isDangerous: false
  },
  {
    id: "kensakiika",
    name: "ケンサキイカ / アカイカ / 白イカ / マイカ (剣先烏賊)",
    kana: "けんさきいか / あかいか / しろいか / まいか",
    scientificName: "Uroteuthis edulis",
    category: "popular_coastal",
    description: "「イカの女王」と称される最高級ツツイカ。山陰・九州では「白イカ」、関東・東海では「アカイカ」と呼ばれる。濃厚な甘みと柔らかい食感はイカ類随一。",
    habitat: "日本海・東シナ海・太平洋沿岸の潮通しの良い堤防・港湾・地磯",
    waterLayer: "middle",
    waterLayerText: "中層〜底層（夜間は常夜灯の明かりに浮いてくる）",
    averageSize: "20cm〜40cm (胴長)",
    recordSize: "52cm (胴長)",
    activeMonths: [5,6,7,8,9,10],
    peakMonths: [6,7,8,9],
    difficulty: 2,
    edibleRating: 5,
    cookingMethods: ["白イカの刺身（極上の甘み）","イカソーメン","握り寿司","天ぷら","一夜干し"],
    recommendedRigs: ["エギング (2.5〜3.0号)","イカメタル / オモリグ (ショア)","テーラー電気ウキ仕掛け"],
    bestTime: "夜間（日没後〜深夜・常夜灯の明暗部）",
    favoriteBaits: ["キビナゴ (テーラー用)","小型エギ","ドロッパー・スッテ"],
    fishingTips: "フォール中の繊細なアタリを取るのがコツ。シャクリ後にテンションフォールさせ、ラインがフッと止まるアタリにアワセを入れます。",
    isDangerous: false
  },
  {
    id: "kouika",
    ...
    difficulty: 2,
    edibleRating: 5,
    cookingMethods: ["握り寿司・刺身（パキッとした食感と甘み）","天ぷら（絶品）","墨煮・イカスミパスタ","煮付け"],
    recommendedRigs: ["エギング (底ズル引き専用スナップ/ナス型オモリ付き)","胴突きスッテ仕掛け","エギ (3.0〜3.5号)"],
    bestTime: "朝夕マズメ・日中・満潮前後",
    favoriteBaits: ["エギ (ピンク/オレンジ/ゴールド系)","エギ用オモリ","キビナゴ"],
  ...
  },
  {
    ...
    scientificName: "Amphioctopus fangsiao",
    category: "popular_coastal",
    description: "胴の中に米粒のような卵（飯・イイ）が詰まる冬〜春の風物詩。瀬戸内海や東京湾の砂泥底に多く、ラッキョウ仕掛けやタコエギで手軽に数釣りが楽しめます。",
    habitat: "内湾の砂泥底・干潟・港湾・堤防・サーフ",
    waterLayer: "bottom",
    waterLayerText: "底層（砂泥底を這って貝やカニを捕食）",
    averageSize: "10cm〜20cm",
    recordSize: "28cm",
    activeMonths: [9,10,11,12,1,2,3],
    peakMonths: [10,11,12,1],
    difficulty: 1,
    edibleRating: 5,
    cookingMethods: ["イイダコの甘辛煮付け（子持ちは絶品）","おでん","天ぷら・唐揚げ","たこ飯","塩茹で"],
    recommendedRigs: ["イイダコ専用スッテ仕掛け","ラッキョウテンヤ仕掛け","小型タコエギ (1.5〜2.5号)"],
    bestTime: "日中（日中の干潮〜満潮にかけての潮が動く時間帯）",
    favoriteBaits: ["ラッキョウ（白いエサ）","カニ","パールホワイト系スッテ"],
    fishingTips: "底をトントンと小刻みにシェイクしながらゆっくり引いてきます。ムニュッとした重みを感じたら竿を大きく立てて巻き上げます。",
    isDangerous: false
  },
  {
    id: "hiika",
    ...
    difficulty: 1,
    edibleRating: 5,
    cookingMethods: ["丸ごと甘辛煮付け","丸ごとボイルポン酢","イカ飯","アヒージョ","天ぷら"],
    recommendedRigs: ["ナオリー / 小型エギ (1.5〜1.8号)","胴突きスッテ仕掛け","電気ウキモエビ仕掛け"],
    bestTime: "夜間（常夜灯の明暗部周辺）",
    favoriteBaits: ["モエビ (活きエビ)","小型エギ (1.5号)","スッテ"],
  ...
  },
  {
    ...
    difficulty: 3,
    edibleRating: 5,
    cookingMethods: ["刺身・握り（肉厚で濃厚な甘み）","イカスミ汁","天ぷら","チャンプルー"],
    recommendedRigs: ["エギング (3.5〜4.0号 + シンカー追加)","夜釣り泳がせ仕掛け"],
    bestTime: "夕マズメ〜夜間・朝マズメ",
    favoriteBaits: ["大型エギ (ディープタイプ)","活きグルクン","魚の切り身"],
  ...
  },
  {
    ...
    difficulty: 1,
    edibleRating: 5,
    cookingMethods: ["釜揚げ・ボイル酢味噌（春の至福）","沖漬け","天ぷら","佃煮・串焼き"],
    recommendedRigs: ["タモ網（ウェーディング掬い）","ホタルイカパターンルアー (ズィークイッド/フラッター等)"],
    bestTime: "新月の深夜23時〜未明4時（南風・波静かな夜）",
    favoriteBaits: ["青色発光ルアー","集魚灯"],
  ...
  },
  {
    ...
    difficulty: 1,
    edibleRating: 5,
    cookingMethods: ["煮穴子・穴子丼（ふわふわ極上）","天ぷら","白焼き（わさび醤油）","八幡巻き"],
    recommendedRigs: ["夜釣りぶっこみ2〜3本針仕掛け (うなぎ・アナゴ針10〜12号 + ケミホタル + オモリ10〜20号)","チョイ投げ仕掛け"],
    bestTime: "日没後の夜間（夕マズメ〜深夜）",
    favoriteBaits: ["青イソメ (房掛け)","サンマの切り身","サバの切り身","イカ短冊"],
  ...
  },
  {
    ...
    scientificName: "Lates japonicus",
    category: "bottom_rock",
    description: "日本の固有種にして高知・宮崎の汽水域にのみ生息する「生きた化石・日本三大怪魚」。光を反射してルビー色に光る眼と、130cm・30kgを超える規格外の巨体がアングラーを魅了する伝説の怪魚。",
    habitat: "高知県（浦戸湾・四万十川等）・宮崎県の河口汽水域・港湾・サーフ",
    waterLayer: "all",
    waterLayerText: "底層〜中層（夜間に橋脚明暗やカケアガリに潜みボラやコノシロを急襲）",
    averageSize: "70cm〜110cm (メーター超え・30kg以上実績多数)",
    recordSize: "138cm / 39kg",
    activeMonths: [5,6,7,8,9,10],
    peakMonths: [6,7,8,9],
    difficulty: 5,
    edibleRating: 2,
    cookingMethods: ["キャッチ＆リリース推奨（希少種保護）"],
    recommendedRigs: ["アカメ専用ヘビータックル (PE4〜6号 + リーダー80〜100lb + 大型ビッグベイト 150〜200mm / ヘビーシンペン 40〜60g)","泳がせ仕掛け (活きボラ)"],
    bestTime: "夜間（大潮・中潮の下げ潮時）",
    favoriteBaits: ["活きボラ (イナッコ)","コノシロ","大型ビッグベイト"],
    fishingTips: "橋脚のヨレや明暗の境目へビッグベイトをデッドスローにドリフト。バイトの衝撃はハンマーで殴られたよう。ファイト後は速やかに蘇生・リリース。",
    isDangerous: false
  },
  {
    id: "sake",
    ...
    difficulty: 3,
    edibleRating: 5,
    cookingMethods: ["自家製イクラの醤油漬け（至高）","鮭のちゃんちゃん焼き","石狩鍋","ルイベ","ハラス焼き"],
    recommendedRigs: ["アキアジ専用ウキルアー仕掛け (フロートウキ + アキアジスプーン 35〜50g + タコベイト + サンマ切り身)","フカセ仕掛け","ぶっこみ仕掛け"],
    bestTime: "早朝の夜明け前〜朝マズメ・夕マズメ",
    favoriteBaits: ["サンマ切り身 (ニンニク・塩締め・紅染め)","イカ短冊","エビ"],
    fishingTips: "タナを1〜1.5mに合わせ、ウキが波に揺れる速度でスローリトリーブ。ウキがグーッと引き込まれて完全に海中へ消えたら豪快に合わせます（※河口規制厳守）。",
    isDangerous: false
  },
  {
    id: "kyuriuo",
    name: "キュウリウオ / コマイ / オオマイ (胡瓜魚 / 氷下魚)",
    kana: "きゅうりうお / こまい",
    scientificName: "Osmerus dentex / Eleginus gracilis",
    category: "popular_coastal",
    description: "キュウリのような独特の爽やかな香気を持つキュウリウオと、冬の氷下や堤防で釣れる美味なタラ科のコマイ。北海道・東北の冬〜春の風物詩で、干物や天ぷらが絶品。",
    habitat: "北海道・北東北の港湾・堤防・サーフ・河口・汽水域",
    waterLayer: "bottom",
    waterLayerText: "底層〜中層（群れで海底付近を回遊）",
    averageSize: "20cm〜35cm (30cm超は「オオマイ」と呼ばれる)",
    recordSize: "42cm",
    activeMonths: [10,11,12,1,2,3,4],
    peakMonths: [11,12,1,2],
    difficulty: 1,
    edibleRating: 5,
    cookingMethods: ["コマイの生干し・炙りマヨネーズ一味（酒の肴最高峰）","天ぷら・フライ","塩焼き","三平汁"],
    recommendedRigs: ["胴突き2〜3本針投げ釣り仕掛け (丸セイゴ12〜14号 + 赤ビーズ + オモリ15〜25号)","サビキ仕掛け"],
    bestTime: "夕マズメ〜夜間（集魚灯や常夜灯周辺）",
    favoriteBaits: ["青イソメ","サンマの切り身","エビ"],
    fishingTips: "夜間に投げて鈴を付けてアタリを待ちます。赤いビーズや蛍光パイプに好反応。大型のオオマイは強烈に竿先を叩きます。",
    isDangerous: false
  },
  {
    id: "hatahata",
    ...
    scientificName: "Arctoscopus japonicus",
    category: "popular_coastal",
    description: "秋田・山形・鳥取・北海道の冬の雷鳴（鰰）とともに大群で沿岸へ押し寄せる名物魚。プチプチとした卵塊「ブリコ」とクセのない上品な脂が絶品。サビキで鈴なりの数釣りが楽しめます。",
    habitat: "日本海・北日本の沿岸・港湾・堤防・藻場（初冬の産卵接岸期）",
    waterLayer: "bottom",
    waterLayerText: "底層（ホンダワラなどの海藻帯周辺）",
    averageSize: "15cm〜22cm",
    recordSize: "28cm",
    ...
    difficulty: 1,
    edibleRating: 5,
    cookingMethods: ["ハタハタの塩焼き（ブリコが絶品）","しょっつる鍋（秋田伝統）","田楽","煮付け","一夜干し"],
    recommendedRigs: ["ハタハタ専用サビキ仕掛け (カラ針/ハゲ皮 4〜6号 + オモリ5〜10号)"],
    bestTime: "日中〜夜間（群れが港内へ接岸している時合）",
    favoriteBaits: ["エサ不要（サビキの空針や小粒オキアミ）"],
    fishingTips: "群れが接岸すると海底が真っ黒になるほど密集。サビキを底まで落として軽くリフト＆フォールするだけで何匹も連なって掛かります。",
    isDangerous: false
  },
  {
    id: "ishigarei",
    ...
    scientificName: "Kareius bicoloratus",
    category: "popular_coastal",
    description: "ウロコがなく体側に硬い石状の骨質板を持つ大型カレイ。マコガレイと並ぶ投げ釣りの花形で、50cmを超える「座布団カレイ」に成長。初夏〜秋の引きと冬の食味が人気。",
    habitat: "全国のサーフ・河口・汽水域・砂泥底の港湾・堤防",
    waterLayer: "bottom",
    waterLayerText: "完全底層（砂泥の中に身を潜める）",
    averageSize: "25cm〜45cm (50cm超で座布団級)",
    recordSize: "63cm",
    activeMonths: [3,4,5,6,10,11,12],
    peakMonths: [4,5,11,12],
    difficulty: 2,
    edibleRating: 5,
    cookingMethods: ["刺身・薄造り（初夏〜秋の活け締め・縁側絶品）","煮付け","唐揚げ","ムニエル"],
    recommendedRigs: ["カレイ専用2本針投げ釣り仕掛け (カレイ針12〜14号 + 装飾パイプ + 遊動天秤20〜30号)"],
    bestTime: "日中（朝マズメ〜日中の潮が大きく動くタイミング）",
    favoriteBaits: ["青イソメ (房掛け)","イワイソメ (マムシ)","アオコガネ"],
    fishingTips: "イワイソメとアオイソメのミックス掛けで匂いと動きを両立。潮が動くタイミングでゆっくりサビいて砂煙を立てると好奇心で寄ってきます。",
    isDangerous: false
  },
  {
    id: "surumeika",
    ...
    difficulty: 2,
    edibleRating: 5,
    cookingMethods: ["イカそうめん・刺身（肝醤油）", "自家製イカの塩辛（絶品）", "イカの一夜干し・焼きイカ", "イカ飯", "天ぷら"],
    recommendedRigs: ["エギング (2.5〜3.5号)", "イカメタル / オモリグ", "テーラー電気ウキ仕掛け (キビナゴ/鳥ササミ)"],
    bestTime: "夜間（日没後〜深夜・常夜灯の明暗部）",
    favoriteBaits: ["キビナゴ", "鳥ササミ塩締め", "夜光エギ・スッテ"],
