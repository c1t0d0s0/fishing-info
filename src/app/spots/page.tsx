  ...
  return (
    <div className="space-y-6 animate-in fade-in-50 duration-200">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 sm:p-6 shadow-sm space-y-4">
        ...
        <div className="relative w-full">
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 p-1 rounded-lg hover:bg-slate-200/60 dark:hover:bg-slate-700/60 transition-colors"
              title="検索クリア"
            >
        ...
        {/* Region Tabs - Dedicated row with smooth horizontal scroll */}
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-none text-xs">
          <span className="text-[11px] font-bold text-slate-400 dark:text-slate-500 mr-1 shrink-0 flex items-center gap-1">
            <Compass className="w-3.5 h-3.5 text-ocean-500" /> エリア:
          </span>
          <button
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1 scrollbar-none text-xs border-t border-slate-100 dark:border-slate-800/80 pt-3">
          <span className="text-[11px] font-bold text-slate-400 dark:text-slate-500 mr-1 shrink-0 flex items-center gap-1">
            <Filter className="w-3.5 h-3.5 text-ocean-500" /> タイプ:
          </span>
          {[
            { id: "all", name: "全タイプ" },
          ...
          {(searchQuery || selectedRegion !== "all" || selectedCategory !== "all") && (
            <button
              ...
              className="text-[11px] text-ocean-600 dark:text-ocean-400 hover:underline shrink-0 ml-1 font-semibold"
            >
              リセット
            </button>
          )}
